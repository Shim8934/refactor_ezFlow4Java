...
public class EzWebFolderServiceimpl_m implements EzWebFolderService_m {
	...
	@Override
	public List<ShareVO> getSharingList(String folderId, String subSearchFlag, String userId, String primary, String offset, int startPoint, int pageSize, SearchVO searchInfo, int tenantId) throws Exception {
		...
		if (folderId.equals("")) {
			list = ezWebFolderDAO_m.getSharingList(map);
	...
	@Override
	public Map<String, Long> getSharingCount(String folderId, String subSearchFlag, String userId, String primary, String offset, int pageSize, SearchVO searchInfo, int tenantId) throws Exception {
		String searchStartDate = searchInfo.getSearchStartDate();
		String searchEndDate = searchInfo.getSearchEndDate();
		...
		if (folderId.equals("")) {
			list = ezWebFolderDAO_m.getSharingCount(map);
		} else {
