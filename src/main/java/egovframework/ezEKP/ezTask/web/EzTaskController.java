...
public class EzTaskController extends EgovFileMngUtil {
	 ...
	 * 업무상세화면 조회
	 */
	@RequestMapping(value = "/ezTask/taskRead2.do")
	public String taskRead2(@CookieValue("loginCookie") String loginCookie, HttpServletRequest request, Model model) throws Exception {
		logger.debug("taskRead started.");
		...
		return "/ezTask/taskRead2";
	}
	
	/**
	 * 업무상세화면 조회
	 */
	@RequestMapping(value = "/ezTask/taskRead3.do")
	public String taskRead3(@CookieValue("loginCookie") String loginCookie, HttpServletRequest request, Model model) throws Exception {
		logger.debug("taskRead started.");
