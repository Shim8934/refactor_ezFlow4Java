...
public interface EzOrganAdminService {
	...
	public List<OrganUserVO> getUserList(int tenantID, int startPage, int endPage, int maxItemPerPage, String keycode,String keyword,String companyId) throws Exception;
