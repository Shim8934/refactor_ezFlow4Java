...
@Controller
public class EzStatisticsMailDeptController {
	
	private static final Logger logger = LoggerFactory.getLogger(EzStatisticsMailDeptController.class);
	...
	public String statisticsMailDept() throws Exception{		
	...
	@RequestMapping(value="/ezStatistics/getMailDept.do",method=RequestMethod.POST,
			produces="text/xml; charset=utf-8")
	@ResponseBody
	public String getMailDept(@CookieValue("loginCookie") String loginCookie, @RequestBody String bodyData, Locale locale, Model model) throws Exception {
		...
		logger.debug("getMailDept ended");
