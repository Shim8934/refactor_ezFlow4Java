...
public class ThemeAuthVO {

	private int themeId; // 메뉴 아이디
	...
	public String toString() {
		return "ThemeAuthVO [themeId=" + themeId + ", userId=" + userId + ", userName=" + userName + ", userDeptName="
				+ userDeptName + ", userType=" + userType + ", accessYN=" + accessYN + "]";
	}
