...
public class QstCompleteVO {
	...
	public void setStrBrdID(int strBrdID) {
		this.strBrdID = strBrdID;
	}
	...
	public String getGubunFg() {
		return gubunFg;
	}
	public void setGubunFg(String gubunFg) {
		this.gubunFg = gubunFg;
	}
	...
	public String getAnswerAnswerContent() {
		return answerAnswerContent;
	}
	public void setAnswerAnswerContent(String answerAnswerContent) {
		this.answerAnswerContent = answerAnswerContent;
	}
