...
public class CabinetGeneralVO {
	...
	public CabinetGeneralVO() {}
	
	public CabinetGeneralVO(String userId, String companyId, String mode, int listCnt, int contWperct, int contHperct, int prevWperct, int prevHperct, int tenantId) {
		this.userId          = userId;
