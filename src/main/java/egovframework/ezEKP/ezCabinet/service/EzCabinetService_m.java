...
public interface EzCabinetService_m {
	//save Item 
	JSONObject saveApprovalItem(String realPath, int cabinetId, String approvalContent, String mode, String doctitle, String summary, String lstAttachLink, String otherAttachLk, Locale locale, LoginVO userInfo) throws Exception;
