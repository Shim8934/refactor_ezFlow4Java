...
public class ApprFormInfoVO {
	...
	public String getFormConnXML() {
		return formConnXML;
	}
	public void setFormConnXML(String formConnXML) {
		this.formConnXML = formConnXML;
	}
