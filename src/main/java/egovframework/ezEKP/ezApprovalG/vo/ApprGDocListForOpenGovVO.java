...
public class ApprGDocListForOpenGovVO {
	/** 문서 아이디*/
	...
	public String getListOpenFlag() {
		return listOpenFlag;
	}
	public void setListOpenFlag(String listOpenFlag) {
		this.listOpenFlag = listOpenFlag;
	}
	public String getOpenLimitDate() {
		return openLimitDate;
	}
