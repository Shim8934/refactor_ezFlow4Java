...
public class ApprGAutoRuleVO {
	/** */
	private String formID;
	/** */
	private String autoRuleSN;
	/** */
	private String autoRuleGUID;
	/** */
	private String checkField;
	/** */
	private String operatorType;
	/** */
	private String checkFieldType;
	/** */
	...
	/** */
	private String condValueDeptID;
	/** */
	...
	public String getAutoRuleSN() {
		return autoRuleSN;
	}
	public void setAutoRuleSN(String autoRuleSN) {
		this.autoRuleSN = autoRuleSN;
	}
	public String getAutoRuleGUID() {
		return autoRuleGUID;
	}
	public void setAutoRuleGUID(String autoRuleGUID) {
		this.autoRuleGUID = autoRuleGUID;
	}
	public String getCheckFieldType() {
		return checkFieldType;
	}
	public void setCheckFieldType(String checkFieldType) {
	...
	public String getCondValueDeptID() {
		return condValueDeptID;
	}
	public void setCondValueDeptID(String condValueDeptID) {
		this.condValueDeptID = condValueDeptID;
	}
