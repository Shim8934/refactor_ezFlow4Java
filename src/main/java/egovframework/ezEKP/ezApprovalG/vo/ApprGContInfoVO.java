...
public class ApprGContInfoVO {
	...
	/** 개인문서함아이디*/
	private String userContID;
	/** 개인문서함이름*/
	private String userContName;
	/** 설명*/
	private String description;
	/** 상위문서함아이디*/
	private String parentContID;
	/** 유저아이디*/
	private String userID;
	/** 부서문서함이름*/
	private String deptContName;
	/** 부서문서함아이디*/
	...
	public void setContainerOwnDepID(String containerOwnDepID) {
		ContainerOwnDepID = containerOwnDepID;
	}
	public String getUserContID() {
		return userContID;
	}
	public void setUserContID(String userContID) {
		this.userContID = userContID;
	}
	public String getUserContName() {
		return userContName;
	}
	public void setUserContName(String userContName) {
		this.userContName = userContName;
	}
	...
	public String getParentContID() {
		return parentContID;
	}
	public void setParentContID(String parentContID) {
		this.parentContID = parentContID;
	}
	...
	public String getDeptContName() {
		return deptContName;
	}
	public void setDeptContName(String deptContName) {
		this.deptContName = deptContName;
	}
	public String getDeptContID() {
		return deptContID;
	}
	public void setDeptContID(String deptContID) {
		this.deptContID = deptContID;
	}
	public String getSn() {
		return sn;
	}
