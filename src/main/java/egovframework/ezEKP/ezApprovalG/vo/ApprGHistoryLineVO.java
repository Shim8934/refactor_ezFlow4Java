...
public class ApprGHistoryLineVO {
	/** 문서아이디*/
	...
	/** 수정자이름(다국어)*/
	private String modifyUserName2;
	/** 수정자직위*/
	private String modifyUserJobTitle;
	/** 수정자직위(다국어)*/
	private String modifyUserJobTitle2;
	/** 수정자부서아이디*/
	private String modifyUserDeptID;
	/** 수정자부서명*/
	private String modifyUserDeptName;
	/** 수정자부서명(다국어)*/
	private String modifyUserDeptName2;
	/** 사용안함*/
	...
	public String getModifyUserName2() {
		return modifyUserName2;
	}
	public void setModifyUserName2(String modifyUserName2) {
		this.modifyUserName2 = modifyUserName2;
	}
	public String getModifyUserJobTitle() {
		return modifyUserJobTitle;
	}
	public void setModifyUserJobTitle(String modifyUserJobTitle) {
		this.modifyUserJobTitle = modifyUserJobTitle;
	}
	public String getModifyUserJobTitle2() {
		return modifyUserJobTitle2;
	}
	public void setModifyUserJobTitle2(String modifyUserJobTitle2) {
		this.modifyUserJobTitle2 = modifyUserJobTitle2;
	}
	public String getModifyUserDeptID() {
		return modifyUserDeptID;
	}
	...
	public String getModifyUserDeptName2() {
		return modifyUserDeptName2;
	}
	public void setModifyUserDeptName2(String modifyUserDeptName2) {
		this.modifyUserDeptName2 = modifyUserDeptName2;
	}
