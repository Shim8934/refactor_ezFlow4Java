...
public class ApprGHistoryAttachVO {
	/** 문서아이디*/
	...
	/** 첨부파일보이는이름*/
	private String attachFileDisplayName;
	/** 첨부파일경로*/
	private String attachFileHref; 
	/** 첨부파일크기*/
	...
	public String getAttachFileDisplayName() {
		return attachFileDisplayName;
	}
	public void setAttachFileDisplayName(String attachFileDisplayName) {
		this.attachFileDisplayName = attachFileDisplayName;
	}
	public String getAttachFileHref() {
		return attachFileHref;
	}
	public void setAttachFileHref(String attachFileHref) {
		this.attachFileHref = attachFileHref;
	}
