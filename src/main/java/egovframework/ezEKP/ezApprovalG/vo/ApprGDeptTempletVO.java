...
public class ApprGDeptTempletVO {
	/** 유저아이디*/
	private String userID;
	/** 양식아이디*/
	private String formID;
	/** 수신처저장 시리얼넘버*/
	private String aprDeptSN;
	/** 수신처저장이름 */
	/** */
	private String aprDeptTempletName;
	/** */
	private String aprDeptMemberSN;
	/** */
	...
	public String getAprDeptSN() {
		return aprDeptSN;
	}
	public void setAprDeptSN(String aprDeptSN) {
		this.aprDeptSN = aprDeptSN;
	}
	public String getAprDeptTempletName() {
		return aprDeptTempletName;
	}
	public void setAprDeptTempletName(String aprDeptTempletName) {
		this.aprDeptTempletName = aprDeptTempletName;
	}
	public String getAprDeptMemberSN() {
		return aprDeptMemberSN;
	}
	public void setAprDeptMemberSN(String aprDeptMemberSN) {
		this.aprDeptMemberSN = aprDeptMemberSN;
	}
	...
	public String getExtReceptEmail() {
		return extReceptEmail;
	}
	public void setExtReceptEmail(String extReceptEmail) {
		this.extReceptEmail = extReceptEmail;
	}
