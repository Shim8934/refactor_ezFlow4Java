...
public class ApprGAprDocInfoVO {
	/** */
	...
	public String getHasOptionYN() {
		return hasOptionYN;
	}
	public void setHasOptionYN(String hasOptionYN) {
		this.hasOptionYN = hasOptionYN;
	}
