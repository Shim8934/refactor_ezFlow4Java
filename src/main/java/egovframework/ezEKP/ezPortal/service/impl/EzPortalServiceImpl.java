			...
			if (pMode.equals("edit")) {
				...
				if (userInfo.getTableViewOption().equals("D")) {
					if (i == 0) {
						...
						sb.append("<li id='organ' onclick='javascript:openQuickMenu(this.id)'><span class='icon'><img src='/images/kr/main/quick04.png'></span><span class='txt'>"+egovMessageSource.getMessage("ezAddress.t351", userInfo.getLocale())+"</span></li>");
						sb.append("<li id='exchangewrite' onclick='btnWrite_onclick(this)'><span class='icon'><img src='/images/kr/main/quick03.png'></span><span class='txt'>"+egovMessageSource.getMessage("ezPortal.pjg11", userInfo.getLocale())+"</span></li></ul></div>");
