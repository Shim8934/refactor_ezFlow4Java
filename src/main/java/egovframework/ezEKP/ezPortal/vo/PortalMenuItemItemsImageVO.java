...
public class PortalMenuItemItemsImageVO {
	...
	public String getOverImagePath() {
		return overImagePath;
	}
	public void setOverImagePath(String overImagePath) {
		this.overImagePath = overImagePath;
	}
