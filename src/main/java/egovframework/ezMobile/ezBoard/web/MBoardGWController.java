	...
	public Object sendBoardAlertNotiAdmin(@PathVariable String boardId, HttpServletRequest request) throws Exception {
		...
		try {
	        ...
	        if (boardInfo.getGuBun().equals("2")) {
	        	...
	        	if (primary.equals("1")) {
	        		bodyContent.append("<br><br>&nbsp;&nbsp;&nbsp;-&nbsp;" + egovMessageSource.getMessage("ezBoard.t253", locale) + info.getUserName() + "(" + (info.getTitle() == null || "null".equals(info.getTitle()) || info.getTitle().isEmpty() ? "" : info.getTitle() + ", " ) + info.getDeptName() + ", " + info.getCompanyName() + ")");
	        	} else {
	        		bodyContent.append("<br><br>&nbsp;&nbsp;&nbsp;-&nbsp;" + egovMessageSource.getMessage("ezBoard.t253", locale) + info.getUserName2() + "(" + (info.getTitle2() == null || "null".equals(info.getTitle2()) || info.getTitle().isEmpty() ? "" : info.getTitle2() + ", " ) + info.getDeptName2() + ", " + info.getCompanyName2() + ")");
	        	}
	        }
		...
		try {
			...
			if (mode.equals("new")) { // 게시판 게시알림 (아래 게시판에 새 게시글이 게시되었습니다.)
		        ...
		        if (primary.equals("1")) {
		        	...
		        	bodyContent.append("<br><br>&nbsp;&nbsp;&nbsp;-&nbsp;" + egovMessageSource.getMessage("ezBoard.t253", locale) + info.getUserName2() + "(" + (info.getTitle2() == null || "null".equals(info.getTitle2()) || info.getTitle2().isEmpty() ? "" : info.getTitle2() + ", " ) + info.getDeptName2() + ", " + info.getCompanyName2() + ")");
		        }
