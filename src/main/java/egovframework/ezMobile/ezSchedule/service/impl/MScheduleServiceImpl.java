...
/*			if(attendantId.getLength() > 0) {				
			...
			map.put("v_OWNERID", jsonParam.get("creatorId").toString());
			map.put("v_OWNERNAME", jsonParam.get("creatorName").toString());
			map.put("v_OWNERNAME2", jsonParam.get("creatorName2").toString());
