...
<!-- 	<div style="position:relative; top:-66px; overflow:hidden;"> -->
<!-- 	<div> -->
	    ...
	    <div class="box_shadow info_right" style="margin:0px; margin-left:7px">
	        <dl class="info">
	        	<dt class="infoImg"><img src="/images/kr/theme02/my_pic.png"></dt>
	            <dd class="infoName">${userName }</dd>
	            <dd class="infoTeam">${deptName }</dd>
	            <dd class="infoMail">${userEmail }</dd>
	            <dd class="infoTime"><spring:message code="main.t00016" />&nbsp;&nbsp;${lastLogin }</dd>
	            <dd class="infoSet" onclick="infoSetClick()"><img src="/images/kr/theme02/infoSet_btn.png"></dd>
	            <dd class="infoLogout" onclick="infoLogoutClick()"><img src="/images/kr/theme02/infoLogout_btn.png"></dd>
	        </dl>
	        <div class="time_check">
	            ...
	            <div class="main_time">
	            	<dl class="timeCheckIn out" id="ptlInAttiBtn" type="A01" datetype="2" onclick="ptlCheckHoliday(this)">
	                	<dt><img src="/images/kr/theme02/main_time_icon.png"></dt>
	                	<dd>출근입력</dd>
	                </dl>
