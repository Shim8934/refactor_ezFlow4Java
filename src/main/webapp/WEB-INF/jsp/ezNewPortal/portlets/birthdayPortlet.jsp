...
<div class="layDIV">
	...
	<dl class="portlet_title photo_board sortablePortlet">
		<dt class="portletText"><span id="curMonth"><c:out value="${nowMonth }"/></span> <spring:message code='main.t1002' /></dt>
<!-- 		<dd class="portletPlus"><img src="/images/ezNewPortal/portlet_Plus.png"></dd> -->
		<dd id="birthNext" class="nextBtn"><img src="/images/ezNewPortal/photo_next.png"></dd>
		<dd id="birthPrev" class="preBtn"><img src="/images/ezNewPortal/photo_pre.png"></dd>
	</dl>
	<div id="birthcount" style="display: none;">
		<ul class="birthList" id="birthdayList"></ul>
	</div>
	<div id="nodata_NewBirthday" style="">
	<dl class="nodata">
