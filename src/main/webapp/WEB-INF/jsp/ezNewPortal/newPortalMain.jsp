...
<html>
	...
	<body style="margin:0px 0px 0px 0px;padding: 0px 0px 0px 0px;overflow:hidden;">
		...
		<iframe src="/ezNewPortal/newPortalPortalPage.do" name="main" id="mainFrame"  style="margin:0px 0px 0px 0px; padding:0px 0px 0px 0px;border:none;width:100%;height:100%;overflow:auto;" frameborder="0"></iframe>
