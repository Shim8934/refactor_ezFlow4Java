		...
		<script type="text/javascript">
			...
			function StartOn() {
				...
				if(nvista==0) {
					...
					// 일반 OS의 경우
					i_icd.OpenProgress();
					i_icd.xmlURL = "http://" + document.location.hostname + ":" + location.port + "/ezNewPortal/componentListTransfer.do";
					i_icd.CheckVersion();
					...
					i_icd.xmlURLVista = "http://" + document.location.hostname + ":" + location.port + "/ezNewPortal/componentListTransfer.do";
					//체크버전비스타에서 제대로 동작 X
