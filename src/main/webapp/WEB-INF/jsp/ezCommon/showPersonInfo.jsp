...
<html>
	<head>
		<title><spring:message code='ezHome.t70' /></title>
		<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		<link rel="stylesheet" href="<spring:message code='ezHome.e15' />" type="text/css">
	...
	<body class = "popup" id = "mainbody">
		<form method = "POST">
			<div id="normalScreen">
			    <div id="menu">
					<ul>
			        	<li><span onClick="window.print()"><spring:message code='ezHome.t73' /></span></li>
					</ul>
			    </div>
			    <div id="close">
			    	<ul>
			        	<li><span onClick="window.close()"><spring:message code='ezHome.t3' /></span></li>
			        </ul>
			    </div>
			    <script type="text/javascript">
					...
					<tr>
						...
						<td valign="top" style="padding-left:5px" >
							...
							<table class="content" width="100%" >
								<tr>
									<th nowrap style="height:26px"><spring:message code='ezHome.t74' /></th>
									<td>${LiteralCompany }</td>
								</tr>
								<tr>
									<th nowrap style="height:26px"><spring:message code='ezHome.t75' /></th>
							  		<td>${LiteralDept }</td>
								</tr>
								<tr>
									<th nowrap style="height:26px"><spring:message code='ezHome.t76' /></th>
									<td id="username">${LiteralDisplayName }</td>
								</tr>
								<tr>
									<th nowrap style="height:26px"><spring:message code='ezHome.t77' /></th>
							  		<td>${LiteralTitle }</td>
								</tr>
								<tr>
									<th nowrap style="height:27px" ><spring:message code='ezHome.t78' /></th>
				...
				<table class="content" style="margin-top:10px" >
					<tr>
						<th><spring:message code='ezHome.t79' /></th>
						<td colspan="2" width="100%">${LiteralPhone }</td>
					</tr>
					<tr>
						<th><spring:message code='ezHome.t80' /></th>
						<td style="border-right:medium none">${LiteralMobile }</td>
						<td width="80" style="border-left:medium none">
							<!--a  class="imgbtn"><span onClick="btnSMS_onClick()">SMS<spring:message code='ezHome.t81' /></span></a-->
						</td>
					</tr>
					<tr>
						<th><spring:message code='ezHome.t82' /></th>
						<td colspan="2">${LiteralHomePhone }</td>
					</tr>
					<tr>
					  	<th><spring:message code='ezHome.t83' /></th>
					  	<td colspan="2">${LiteralFax }</td>
					</tr>
					<tr style="display:none">
						<th rowspan="2" ><spring:message code='ezHome.t84' /></th>
					...
					<tr>
					  	<th><spring:message code='ezHome.t85' /></th>
						<td colspan="2">
			...
			<div id="printScreen" style="DISPLAY: none">
				<table>
					<tr>
				    	<td><spring:message code='ezHome.t86' /></td>
				  		<td id="printPhoto"></td>
					</tr>
					<tr>
						<td><spring:message code='ezHome.t87' /></td>
						<td id="printCompany"></td>
					</tr>
					<tr>
					  	<td><spring:message code='ezHome.t88' /></td>
					  	<td id="printDept"></td>
					</tr>
					<tr>
					  	<td><spring:message code='ezHome.t89' /></td>
					  	<td id="printName"></td>
					</tr>
					<tr>
					  	<td><spring:message code='ezHome.t90' /></td>
					  	<td id="printTitle"></td>
					</tr>
					<tr>
						<td><spring:message code='ezHome.t91' /></td>
						<td id="printEmail"></td>
					</tr>
					<tr>
					 	<td><spring:message code='ezHome.t92' /></td>
					  	<td id="printPhone"></td>
					</tr>
					<tr>
					  	<td><spring:message code='ezHome.t93' /></td>
					  	<td id="printMobile"></td>
					</tr>
					<tr>
					  	<td><spring:message code='ezHome.t94' /></td>
					  	<td id="printHomePhone"></td>
					</tr>
					<tr>
					  	<td><spring:message code='ezHome.t95' /></td>
					  	<td id="printFax"></td>
					</tr>
					<tr>
					  	<td><spring:message code='ezHome.t96' /></td>
					  	<td id="printAddr"></td>
					</tr>
					<tr>
					  	<td><spring:message code='ezHome.t97' /></td>
					    <td id="printMemo"></td>
					</tr>
				</table>
			</div>
