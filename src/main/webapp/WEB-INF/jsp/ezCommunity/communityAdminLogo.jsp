	        ...
	        <table class="content" style="margin-top:5px">
	            <tr>
	                ...
	                <td>
	                    ...
	                    <span><img class="prev" id="logoprev" src="" style="width:321.84px;"><img class="del"  id="delLogo" src="/images/comment_del.gif" style="left:328px; display:none;" onclick="attachDelLogo()"></span>
	                </td>
	            </tr>
	            <tr>
	                ...
	                <td>
	                    ...
	                    <span><img class="prev" id="thumbprev" src="" style="width:50.4px;"><img class="del"  id="delThumb" src="/images/comment_del.gif" style="left:57px; display:none;" onclick="attachDelThumb()"></span>
	                </td>
	            </tr>
	        </table>
	        <br/><br/>
