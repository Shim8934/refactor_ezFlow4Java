...
<html>
	<head>
		...
		<title><spring:message code='ezCommunity.lyj74'/></title>
		<script>
			var RetValue;
		    var ReturnFunction;
		    ...
		    function change_onClick() {
		        ...
		        if (selectedItemCount == 0) {
		            alert("<spring:message code='ezCommunity.lyj75' />");
				    return;
				}
				else if (selectedItemCount > 1) {
				    alert("<spring:message code='ezCommunity.lyj76' />");
					    return;
					}
	...
	<body class="popup"> 
	    <xml id="listviewheader" style="display: none"> 
	        <LISTVIEWDATA> 
	            <HEADERS> 
	                <HEADER> 
	                    <TYPE>NONE</TYPE> 
	                    <NAME><spring:message code='ezCommunity.lyj79' /></NAME>
	                    <WIDTH>100</WIDTH> 
	                ...
	                <HEADER> 
	                    <NAME><spring:message code='ezCommunity.t241' /></NAME>
	                    <WIDTH>90</WIDTH>
	                </HEADER> 
	                <HEADER> 
	                    <NAME><spring:message code='ezCommunity.lyj80' /></NAME>
	                    <WIDTH>50</WIDTH>
	                </HEADER> 
	                <HEADER> 
	                    <NAME><spring:message code='ezCommunity.t10' /></NAME>
	                    <WIDTH>60</WIDTH>
	                </HEADER> 
	                <HEADER> 
	                    <NAME>EMAIL</NAME> 
		...
		<h1><spring:message code='ezCommunity.lyj74' /></h1>
		<div id="close">
            <ul>
                <li><span onclick="cancel_onClick()"></span></li>
            </ul>
        </div>
		<h2><spring:message code='ezCommunity.lyj77' /></h2>
		<div class="listview" style="overflow:auto;">
			<div id="ListViewid" STYLE="Height:195px; border:0px;overflow:auto"></div>
		</div>
		<div class="btnposition btnpositionNew">
		    <a class="imgbtn" name="button2" onClick="change_onClick()" ><span><spring:message code='ezCommunity.lyj78' /></span></a>
		</div>
	</body>
</html>