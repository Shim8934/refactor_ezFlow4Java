	...
	<body class="mainbody" style="min-width:1040px; margin:0; padding:0 10px 10px;">
		...
		<form name="frmOutbox" method="post">
			<table class="mainlist" style="width:100%;margin-top:10px">
				<tr>
					<th style="width:20px;padding:0px" align="center"><div class="custom_checkbox"><input type='checkbox' id ="checkbox" name="checkbox" onclick='checkBox_checkAll()'></div></th>
				     <c:choose>
