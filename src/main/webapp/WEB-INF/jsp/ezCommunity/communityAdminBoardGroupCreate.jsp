	...
	<head>
		...
		<script type="text/javascript">
	        ...
	        function Save() {
	            ...
	            xmlhttp.open("POST", "/ezCommunity/createBoardGroup.do?boardGroupID=" + encodeURIComponent("{" + GetGUID().toUpperCase() + "}") + "&boardGroupName=" + encodeURIComponent(txtNewGroupName.value) + "&boardGroupName2=" + encodeURIComponent(txtNewGroupName2.value) + "&code=" + encodeURIComponent(code), false);
	            xmlhttp.send();
	        ...
	        function OpenRightMenu(pIndex) {
	            ...
	            switch (pIndex) {
	                ...
	                case 2:
	                    ...
	                    break;
	                case 3:
	                    window.location.href = "/ezCommunityboardACL.do?boardID=" + encodeURIComponent(BoardID) + "&parentBoardID=" + encodeURIComponent(ParentBoardID) + "&boardGroupID=" + encodeURIComponent(BoardGroupID) + "&code=" + code;
	                    break;
	                case 4:
