		...
		<form action=/ezCommunity/pollEditOk.do	method=post name=poll_edit id="polledit">
			...
			<table class="content" style="margin-top:12px">
	    		...
	    		<tr>
					...
					<td><input class="inputText" type="text" id="Sdatepicker" style="width:80px;text-align:center" readonly> ~ <input class="inputText" type="text" id="Edatepicker" style="width:80px;text-align:center" readonly></td>
				</tr>
			</table>
