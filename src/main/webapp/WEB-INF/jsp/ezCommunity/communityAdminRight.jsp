...
<html>
	<head>		
		...
		<style type="text/css">
			.warningbox{margin:180px auto 0px auto; padding:40px 20px 0px 20px; width:610px; height:184px; border:1px solid #d6d6d6; box-sizing:border-box; }
...
<!-- 		<div style="text-align: center"> -->
			<div id="EmptyMsg">
				<div class="warningbox">
					...
					<dl class="warningDL">
						<dt>Administrator</dt>
						<dd><spring:message code="ezCommunity.lyj82" /><br />
							<spring:message code="ezCommunity.lyj83" /></dd>
					</dl>
				</div>
			</div>
<!-- 		</div> -->
