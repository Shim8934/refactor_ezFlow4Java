...
<html>
    ...
    function searchuser() {
        ...
        $.ajax({
        	...
        	url : "/ezOrgan/getSearchList.do",
        	async : true,
        	data : {search : "displayname::" + keyword.value, cell : "displayName;description", prop : "", type : "user", adminOrgan : adminOrganVal},
        	success : function(result){	
        		var xmlDom = loadXMLString(result);
    ...
    <table style="width: 1150px;height:640px ;border:1px solid #ddd"> 
        <tr>
            <td style="vertical-align:top">
                <div style="width: 310px; height: 310px; overflow-x: hidden; overflow-y: auto; border-right: 1px solid #ddd;" id="TreeView"></div>
