        ...
        function event_getpersonalstatistics() {
            if (xmlHttp != null && xmlHttp.readyState == 4) {
                ...
                for (var i = 0; i < rowcnt; i++) {
                    ...
                    _TD.innerHTML = getnodetext(SelectSingleNode(SelectNodes(resultxml, "DATA/ROW")[i], "CONNECTBROWSER")).trim();
                    _TD2.innerHTML = getnodetext(SelectSingleNode(SelectNodes(resultxml, "DATA/ROW")[i], "CONNECTCNT")).trim();
                    _TD3.innerHTML = parseFloat(parseInt(getnodetext(SelectSingleNode(SelectNodes(resultxml, "DATA/ROW")[i], "CONNECTCNT")).trim()) / parseInt(getnodetext(SelectSingleNode(SelectNodes(resultxml, "DATA/ROW")[i], "TOTAL")).trim()) * 100).toFixed(2) + "%";
...
<body class="mainbody" style="text-align:left">
    ...
    <div id="viewdata" style="width:800px">
        <div id="statisticschart" style="width: 800px; height: 370px; float: left; font-size: 16px">
        </div>
        <br />
    </div>
