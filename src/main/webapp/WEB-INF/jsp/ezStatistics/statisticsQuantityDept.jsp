...
<html>
    <head>
    <title><spring:message code='ezStatistics.t1023' /></title>
    ...
    function getmailstatistics() {
        ...
        xmlHttp.open("POST", "/ezStatistics/getQuantityDept.do", true);
    ...
    function drawingchart(type) {
        ...
        var ticks = "<spring:message code='ezStatistics.t218' />".split(";");
        plot2 = $.jqplot('statisticschart', [data[0]], {
            animate: false,
            seriesDefaults: {
    ...
    function searchdept() {
        ...
        $.ajax({
        	...
        	async : false,
        	data : {search : "displayname::" + deptkeyword.value, cell : "extensionAttribute3;displayName;extensionAttribute9", prop : "", type : "group", adminOrgan : adminOrganVal},
...
<h1><spring:message code='ezStatistics.t1023' /></h1>
        ...
        <td style="padding-left:20px;padding-right:20px;width: 100%; text-align: center">
            <div id="viewdata">
                ...
                <div id="chartdiv" style="width: 100%; text-align: center; display: none;">
                    <div id="statisticschart" style="width: 830px; height: 500px; float: left; font-size: 16px;">
                    </div>
                </div>
