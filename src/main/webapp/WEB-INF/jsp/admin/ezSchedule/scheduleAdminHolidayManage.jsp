	...
	<head>
	    ...
	    <script type="text/javascript">		    
		    ...
		    function event_click(obj) {
		        ...
		        _RowObject = obj;
		        obj.childNodes.item(0).style.backgroundColor = "rgb(225, 238, 252)";
		        obj.childNodes.item(1).style.backgroundColor = "rgb(225, 238, 252)";
		        obj.childNodes.item(2).style.backgroundColor = "rgb(225, 238, 252)";
		        obj.childNodes.item(3).style.backgroundColor = "rgb(225, 238, 252)";
		        obj.childNodes.item(4).style.backgroundColor = "rgb(225, 238, 252)";
		        obj.childNodes.item(5).style.backgroundColor = "rgb(225, 238, 252)";
		        obj.childNodes.item(6).style.backgroundColor = "rgb(225, 238, 252)";
		    }
