	...
	<head>		
	    ...
	    <script type="text/javascript">
			...
			function ModifySecretary() {
				...
				var OpenWin = window.open("/ezSchedule/scheduleSelectAttendant.do?gubun=config&cn=" + userid + "&title=" + encodeURI("비서 목록"), "schedule_group_write", GetOpenWindowfeature(980, 670));
				try { OpenWin.focus(); } catch (e) { }
			}
