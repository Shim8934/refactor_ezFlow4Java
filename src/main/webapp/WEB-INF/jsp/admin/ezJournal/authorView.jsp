	    ...
	    <table class="content">
	        <tr>
	            ...
	            <td>
	                ...
	                <a class="imgbtn imgbck"><span onclick="select_person()"><spring:message code='ezJournal.t223' /></span></a>                
	            </td>
	        </tr>
	        <tr>
	            ...
	            <td>
	                ...
	                <a class="imgbtn imgbck" style="margin-top:15px;"><span onclick="selectDept()"><spring:message code='ezJournal.t223' /></span></a>                
	            </td>
	        </tr>
	    </table>
