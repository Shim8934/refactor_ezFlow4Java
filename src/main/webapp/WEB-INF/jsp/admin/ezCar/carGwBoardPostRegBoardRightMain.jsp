...
<html>
	<head>
		...
		<script type="text/javascript" src="${util.addVer('/js/ezCar/admin/gwBoard_Post_RegBoardRightMain.js')}" ></script>
			...
			<table class="box" style="width:100%">
				...
				<tr>
					...
					<td style="border-bottom: 1px solid #d2d2d2;border-top: 1px solid #d2d2d2;">
        				 ...
        				 <tr>
          					 <td style="border:0px;">
          						<input type="radio" id="dept_copy1" name="dept_copy" value="1" style="display: none; vertical-align: middle; margin-bottom:5px;" onClick="optDeptCopy_Click(this);" disabled checked> <%-- <spring:message code='ezBoard.t95' /> --%>
            					<input type="radio" id="dept_copy2" name="dept_copy" value="2" style="display: none; vertical-align: middle; margin-bottom:5px;" onClick="optDeptCopy_Click(this);" disabled> <%-- <spring:message code='ezBoard.t96' /> --%>
            				</td> 
        				</tr> 
      					</table>
       				</td> 
