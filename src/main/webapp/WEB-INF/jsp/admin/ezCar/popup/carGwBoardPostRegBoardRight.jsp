...
<html>
	<head>
		<title><spring:message code="ezCar.smb13" /></title>
	...
	<body class="popup" style="overflow: hidden">	
    	...
    	<h1 id="h1Title"><spring:message code="ezCar.smb13" /></h1>
    	<div id="close">
            <ul>
    	...
    	<table style="width: 100%">
    		...
    		<table class="kk_table" width="200" height="20" style="word-break: break-all; overflow-wrap: break-word; border-collapse: collapse; border: 1px none rgb(0, 0, 0); font-size: 13px; width: 200px; height: 10px; background-image: none;">
	<tbody>
		<tr>
			<td style="vertical-align: middle; width: 15px; border-width: 0px; border-style: solid; border-color: rgb(0, 0, 0);" ><input type="checkbox" value="x" id="Check_Everyone" name="Check_Everyone" ></td>
			<td style="vertical-align: left; width: 160px; border-width: 0px; border-style: solid; border-color: rgb(0, 0, 0);"  rowspan="1" colspan=""><span><spring:message code="ezResource.t372" /></span>   	</td>
		</tr>
	</tbody>
</table>
