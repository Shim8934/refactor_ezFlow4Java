			...
			function cmdDel_onclick() {
					...
					var checkId = $("input[name=chk]:checked");
					 ...
					 $.ajax({
					    	...
					    	url : "/admin/ezCar/deleteClass.do",
					    	success: function(text){
					    	alert(count + "<spring:message code='ezCar.shb80' />");
						    window.location.reload(false);
					    	},
					    	error: function(err){
					    		alert("<spring:message code='ezCar.shb81' />");
					    	}
					  });
				...
				if( rv == true ) {
					...
					xmlHttp.open("Post", "/admin/ezCar/callBrdDel.do", false);
