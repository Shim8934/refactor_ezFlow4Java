					...
					<td colspan="8" style="width:10%; text-align:center;">
						<div class='custom_checkbox'>
                            ...
                            <%-- 2022-01-07 홍승비 - 전자결재G 웹한글 일괄기안 기능 표준모듈 반영 --%>
                             <span style="<c:if test="${useDraftAll != 'YES'}">display:none;</c:if>"><input type="checkbox" id="setDraftAllFlag" onclick="changeDraftAllFlag()" /><label for="setDraftAllFlag"><spring:message code='ezApprovalG.groupdocK01'/></label></span>
                            <span style="<c:if test="${usePassAprLine != 'YES'}">display:none;</c:if>"><input type="checkbox" id="setPassAprLineFlag" onclick="changePassAprLineFlag()"/><label for="setPassAprLineFlag"><spring:message code='ezApprovalG.garm09'/></label></span>
                            ...
                            <span style="<c:if test="${useMobileDraft != 'YES' || approvalFlag != 'S' || useEditor == 'WebHWP' || useEditor == 'HWP'}">display:none;</c:if>">
                                <input type="checkbox" id="setMobileDraftFlag" onclick="changeMobileDraftFlag()"/><label for="setMobileDraftFlag"><spring:message code='ezApproval.mobileDraft.kyj01'/></label>
                            </span>
                        </div>
					</td>
				</tr>
