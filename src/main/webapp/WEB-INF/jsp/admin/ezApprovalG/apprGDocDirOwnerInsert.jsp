...
<html>
	...
	<body class="popup" style="overflow:hidden">
	        		...
	        		<table id="TreeViewTD">
	                	<tr>
	                                        ...
	                                        <tr>
	                                            ...
	                                            <td>
	                                                <div style="float: right; margin-right: 5px;">
														<a class="imgbtn"><span onclick="insertShareList('D')"><spring:message code='ezSchedule.t00004' /></span></a>
	                        ...
	                        <td style="width: 30px; text-align: center;">                            
	                            <img src="/images/kr/cm/arr_right.gif" alt="" width="16" height="16" vspace="2" border="0" style="cursor: pointer;" onclick="insertShareList('U');"><br>
		...
		<script type="text/javascript">
			...
			function selectShareList(elem){
				$("#shareList tr").removeClass("active");
			...
			function insertShareList(flag){
				...
				$("#shareList tr").each(function (){
					var shareListElemId = $(this).attr("shareId");
					if(shareListElemId == shareId){
						isExist = true;
					}
				});
				...
				$("#shareList").append('<tr class="shareRow" shareId="' + shareId + '" shareType="' + flag + '"><td style="text-align: center;">' + shareName + '</td><td style="text-align: center;">' + flagName + '</td></tr>');
			}
			
			function selectOwner() {
				var url = "/admin/ezApprovalG/selectDocDirOwner.do";
				
		    	window.open(url, "", "toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=1,height=660,width=685,top=" + pTop + ",left=" + pLeft, "");
			}
			...
			function insertDocDirList(){
			    ...
			    var shareListStr = JSON.stringify(param);
			    
				$.ajax({
		    		type : "POST",
		    		url : "/admin/ezApprovalG/insertDocDirList.do",
		    		data : {"ownerId"  : ownerId, 
		    				"ownerType"  : ownerType,
