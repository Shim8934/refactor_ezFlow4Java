	...
	<body class="mainbody" onLoad="javascript:window_onload()">
		...
		<table style="margin-top:20px">
			<tr>
		    	<td>
		      		<div class="listview">
		      	  		<div id="lvSDoc" style="BORDER:0; WIDTH: 367px; HEIGHT: 297px ; overflow-x:scroll;overflow-y:hidden"></div>
		      		</div>
		    	...
		    	<td style="width:30px;text-align:center"><img src="/images/arr_right.gif" style="cursor:pointer" width="16" height="16"  onClick="return btnIns_onclick()" /><br/>
		      		...
		      		<br/><br/><br/>
		      		<img src="/images/arr_rright.gif" style="cursor:pointer" width="16" height="16"  onClick="return btnTotalIns_onclick()"/><br/>
		      	</td>
		    	<td>
			  		<div class="listview">
		      			<div id="lvTDoc" style="BORDER:0; WIDTH: 367px;HEIGHT: 297px;overflow-x:hidden;overflow-y:auto" ></div>
		      		</div>
		      		<div style="margin-top:5px;text-align:center;height:20px" align="center">
