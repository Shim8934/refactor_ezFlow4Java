...
<html>
	...
	<body class="popup">
	    ...
	    <div id="TreeView" style="border: 1px solid #B6B6B6; height: 370px; width: 270px; overflow-x: hidden; overflow-y: auto; background-color: #FFFFFF;" onnodedblclick="TreeView.toggle(TreeView.selectedIndex)"></div>
