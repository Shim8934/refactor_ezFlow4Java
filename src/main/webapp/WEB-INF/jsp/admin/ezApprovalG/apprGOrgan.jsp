...
<html>
	...
	<body class="popup">
	    ...
	    <div id="TreeView" style="border: 1px solid #ddd; height: 370px; width: 270px; overflow-x: hidden; overflow-y: auto; background-color: #FFFFFF;" onnodedblclick="TreeView.toggle(TreeView.selectedIndex)"></div>
