...
<html>
	<head>
		...
		<script type="text/javascript" src="/js/ezApprovalG/Req_TaskClass_Cross.js"></script>
		...
		<script type="text/javascript">
		    ...
		    function InitTaskInfo() {
		        ...
		        if (getNodeText(GetChildNodes(TaskXml)[0]) == "FALSE") {
		            ...
		            document.getElementById("tdCreateDate").innerHTML = SelectSingleNodeValueNew(TaskXml, "ROW/CREATEDATE");
