...
<body
	style="background: url(/images/kr/cm/popup_bg.gif) #ffffff repeat-x left top">
	<div id="leTop">
		...
		<div class="leLetter">
				...
				<table>
					...
					<tr>
						...
						<td><input type="text" id="displayname" name="displayname"
							maxlength="40" placeholder="편지지명을 입력해주세요"></td>
					</tr>
					<tr>
						<th>편지지명(영문)</th>
						<td><input type="text" id="displayname2" name="displayname2"
							maxlength="40" placeholder="편지지명(영문)을 입력해주세요"></td>
					</tr>
				</table>
			</div>
			<!-- leLetterInfo End -->
			...
			<div class="leLetterEditer">
				<iframe id="tbContentElement" class="viewbox" src="" name="message"
					style="padding: 0; height: 100%; width: 100%; overflow: auto;"></iframe>
				<textarea id="plainTextArea"
					style="height: 100%; width: 100%; overflow-y: scroll; font-size: 13px; box-sizing: border-box; display: none;"></textarea>
			</div>
			<!-- 에디터에서 사용 -->
			<div
				style="width: 100%; height: 100%; position: absolute; top: 0; left: 0; z-index: 1000; background: none rgba(0, 0, 0, 0); display: none;"
				id="mailPanel">&nbsp;</div>
			<div class="layerpopup"
				style="top: 10px; z-index: 2000; position: absolute; display: none;"
				id="iFramePanel">
				<iframe src="<spring:message code='main.kms4' />"
					style="border: 1px solid #b6b6b6;" id="iFrameLayer"></iframe>
			</div>
			<!-- btns -->
	...
	<script>
		...
		window.onload = function() {
			...
			$("#tbContentElement").attr("src",
					"/ezEditor/selectEditor.do?type=MAILLETTER"); // 에디터
		}
