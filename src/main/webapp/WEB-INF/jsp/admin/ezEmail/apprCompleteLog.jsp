...
<html>
<head>
	<title><spring:message code='email.appr.menu.normal.log' /></title>
...
<body>
	<div>
   		<!-- 안내 -->
		<span class="txt">▒ <spring:message code='email.appr.menu.normal.log.info1' /></span><br>
		<span class="txt">▒ <spring:message code='email.appr.menu.normal.log.info2' /></span>
   		<br/><br/>
	...
	<form id="saveExcelForm" name="saveExcelForm" target="saveExcel" method="POST" action="/admin/ezEmail/appr/getCompleteLogListDownload.do">
		...
		function getLogList() {
		    ...
		    return new Promise((resolve, reject) => {
		    	$.ajax({
					...
					url: "/admin/ezEmail/appr/getCompleteLogList.do",
					dataType: "json",
