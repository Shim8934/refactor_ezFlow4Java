...
<body>
		...
		<div class="lmleft">
			...
			<div class="lmBtns">
				<div class="boxNo" data-boxNo="">
					<!-- boxNo -->
					<button onClick="letterEditPopUp(this, 'add')" class="searchDis">편지지
						추가</button>
		...
		<div class="lmright">
			<div class="lmPreview">
				<div class="lmPreViewTxt"
					style='text-align: center; position: relative; top: 50%; tansform: translateY(-50%);'>미리보기</div>
				<iframe src="" class="lmPreViewIframe lmPre" id="lmPreViewIframe"
					name="lmPreViewIframe"
	...
	<script type="text/javascript">
		...
		//편지지 삭제 버튼 클릭
		$(document).on("click", ".lmLetterListUl .lmLetterDeleteBtn",
				function() {
		...
		$(document).on("mouseover", ".lmPreview > .lmPreViewIframe",
						function() {
