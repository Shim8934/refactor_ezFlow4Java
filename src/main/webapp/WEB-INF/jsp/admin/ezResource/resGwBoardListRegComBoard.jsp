	...
	<body class="mainbody">	
		...
		<table class="content">
  			...
  			<tr>
    			...
    			<td ><textarea id="Brd_Explain" style="resize:none; font-size:9pt ; width:98.5%; height:300px; margin-top: 2px; overflow: auto;"><c:out value="${getBrdInfo.brdExplain}" /></textarea></td>
  			</tr>
