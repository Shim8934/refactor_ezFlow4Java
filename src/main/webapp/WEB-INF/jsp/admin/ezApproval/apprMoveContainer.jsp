...
<html>
	<head>
	    ...
	    <script type="text/javascript" src="/js/ezApproval/admin/MoveContainer_Cross.js"></script>
	   ...
	   <span><b><spring:message code='ezApproval.t378'/></b>
	            ...
	            <td>
	                <table class="content" style="width: 368px">
	                    ...
	                    <tr>
	                        ...
	                        <td>
	                            <select name="selSContName" style="WIDTH: 150px" onchange="return bt_selSContName_onclick()">
	                            </select>
	                    ...
	                    <tr>
	                        ...
	                        <td>
	                            <input type="checkbox" id="MoveALL" name="MoveALL" /></td>
	                    </tr>
	                </table>
	            </td>
	            ...
	            <td style="vertical-align: bottom">
	                <table class="content" style="width: 368px">
	                    ...
	                    <tr>
	                        ...
	                        <td>
	                            <select name="selTContName" style="WIDTH: 150px" onclick="return bt_selTContName_onclick()">
	                            </select></td>
	                    </tr>
	                </table>
	            </td>
	    ...
	    <table>
	        <tr>
	            <td>
	                <div class="listview">
	                    <div id="lvSDoc" style="BORDER: 0; HEIGHT: 270px; WIDTH: 360px; overflow-x: scroll; overflow-y: hidden" onclick="lvSDoc_onclick()" onrowdblclick="lvSDoc_onSel_DBclick()" onseldblclick="lvSDoc_onSel_DBclick()" onselclick="lvSDoc_onSel_Click()" onrowclick="lvSDoc_onSel_Click()" onselchanged="lvSDoc_onSel_Changed()"></div>
	                </div>
	            </td>
	            <td style="text-align: center; width: 30px">
	                ...
	                <br>
	                <br>
	                <img height="16" id="arrow_all" onclick="return btnTotalIns_onclick()" src="/images/arr_rright.gif" style="cursor: pointer" width="16"></td>
	            <td>
	                <div class="listview">
	                    <div id="lvTDoc" style="BORDER: 0; HEIGHT: 270px; WIDTH: 360px; overflow-x: hidden; overflow-y: auto"></div>
	                </div>
	            </td>
	        </tr>
	    </table>
