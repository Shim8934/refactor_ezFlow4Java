...
<html>
	<head>
		...
		<script type="text/javascript" src="/js/ezApproval/admin/ezForm_Cross.js"></script>
                        ...
                        <td style="height:770px; vertical-align:top">
                        	<c:choose>
                        		<c:when test="${editorType == 'HWP'}">
	                                <iframe id="message" class="viewbox" src="/admin/ezApproval/hwpEditor.do?type=ADMIN" name="message" frameborder="0" style="padding: 0; height: 100%; width: 1030px; overflow: auto; border:none"></iframe>
                        		</c:when>
                        		<c:otherwise>
