	    ...
	    <table class="content">
	        <tr style="display: none">
	            ...
	            <td>
	                ...
	                <a class="imgbtn" style="vertical-align: middle"><span onclick="return btnItemCode_onclick()"><spring:message code='ezApproval.t335'/></span></a></td>
	        </tr>
	        <tr id="FormN">
	            <th><spring:message code='ezApproval.t433'/></th>
	            <td>
	                <input type="text" id="FormName" name="FormName" style="width: 200px" disabled>
	                <a class="imgbtn" style="vertical-align: middle"><span onclick="return btn_FormSelect_onclick()"><spring:message code='ezApproval.t433'/></span></a></td>
	        </tr>
	        <tr id="DOCNUM">
	            <th><spring:message code='ezApproval.t434'/></th>
	            <td>
	                <input type="text" id="DocNumber" name="DocNumber" style="width: 99%" maxlength="50"></td>
	        </tr>
	        <tr>
