...
<html>
	<head>
		...
		<script type="text/javascript" ID="clientEventHandlersJS">
		    ...
		    var formURL = "/ezCommon/downloadAttach.do?filePath=" + escape("${formURL}");
		    var pReformURL = "";    //2015.1.20 FormBuilder
		    var beforeHTML = "";
		    ...
		    function button() {
		        ...
		        if (g_toggleFlag != true) {
		            property.childNodes(0).innerText = "<spring:message code='ezApproval.t641'/>";
		            }
		            else {
		                property.childNodes(0).innerText = "<spring:message code='ezApproval.t642'/>";
		            }
		        }
		
		    function btn_OpinionAdd_onclick() {
		        var url = "/myoffice/ezApproval/ezViewHWP/FormConnInfo.aspx?companyID=" + escape(companyID);
		    ...
		    function btn_ViewProcUI_onclick() {
		        ...
		        if (!field) {
		            alert("<spring:message code='ezApproval.hyj5'/>");
		            return false;
		        }
		    ...
		    function FormBuilder_onclick()
		    {
		        if (document.getElementById("setFormBuilder").checked) {
    ...
    <body class="popup">
        ...
        <div class="portlet_tabpart01">
	        <div class="portlet_tabpart01_top" id="tab1">
                ...
                <p id = "ApvForm_sub7" style="display:none;"><span divname="ApvForm_div7" id="1tab7"><spring:message code='ezApproval.hyj6'/></span></p>
                <p id = "ApvForm_sub8" style="display:none;"><span divname="ApvForm_div8" id="1tab8"><spring:message code='ezApproval.hyj7'/></span></p>
	        </div>
        </div>
        <div id="ApvForm_content1" style="width:100%;height:90%; padding-top:10px; display:none">
             ...
             <table class="content" style="width:100%;">                
                ...
                <tr>
                    <td colspan="8">
                        <span><input type="checkbox" id="setFormBuilder" name="setFormBuilder" onclick="FormBuilder_onclick()"/><spring:message code='ezApproval.hyj8'/></span>
                ...
                <tr id="tr_setAutoItemCode" style="display:none">
                    ...
                    <td style="width:400px;">
                        <input type="text" name="tbItemCode" style="WIDTH: 50px" readonly>
                        <input type="text" name="tbItemName" style="WIDTH: 80px" readonly>
                        <input type="hidden" name="tbItemName2">
        ...
        <div id="ApvForm_content2" style="width:100%;display:none; padding-top:10px;">
            ...
            <span style="min-width: 45px;" id="Span1"><spring:message code='ezApproval.t00007'/></span>
             ...
             <div id="editor_content" style="padding-top:5px;">
                <div id="mainmenu">
                <ul>
                <li id="idPropertyBtn"><span onclick="return idPropertyBtn_onclick()"><spring:message code='ezApproval.t528'/></span></li>
            ...
            <table class="content">
                <tr>
                    <td>&lt;xml id=conn&gt;<br>
                        ...
                        &lt;/xml&gt; </td>
                    <th>
                        <a class="imgbtn" id="btn_OpinionAdd"><span onclick="btn_OpinionAdd_onclick()"><spring:message code='ezApproval.t193'/></span></a><br>      
                        <a class="imgbtn" id="btn_OpinionSave"><span onclick="btn_OpinionSave_onclick()"><spring:message code='ezApproval.t66'/></span></a><br>              
                    </th>
                </tr>
            </table>              
        </div>        
        ...
        <div id="ApvForm_content6" style="width:100%;height:100%;display:none; padding-top:10px;">         
            ...
            <table class="content">
				<tr>
					...
					<td>
						<select name="selDocType"  id="selDocType" onChange="return OnChange_DocType()">
							${docTypeOption}
						</select>
					</td>
				</tr>
			...
			<tr>
                ...
                <td style="text-align:right;vertical-align:bottom;height: 10px;"> 
                    <img src="/images/arr_up.gif" width="16" height="16" vspace="2" style="cursor: pointer;" onclick="MoveUp_List_AutoRule_onclick()">
                    <img src="/images/arr_down.gif" width="16" height="16" vspace="2" style="cursor: pointer" onclick="MoveDown_List_AutoRule_onclick()">
                </td>
            </tr>
            <tr> 
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <select id="DDL_NUMBER_EQUAL" style="width:80px;display:none">
                                    <option value="NUM_GE"><![CDATA[>=]]> <spring:message code='ezApproval.t990029'/></option>
                                    <option value="NUM_LE"><![CDATA[<=]]> <spring:message code='ezApproval.t990030'/></option>                        
                                    <option value="NUM_GT"><![CDATA[>]]> <spring:message code='ezApproval.t990031'/></option>
                                    <option value="NUM_LT"><![CDATA[<]]> <spring:message code='ezApproval.t990032'/></option>
                                    <option value="NUM_EQ"><![CDATA[=]]> <spring:message code='ezApproval.t990026'/></option>
                                </select>
                            ...
                            <td valign="top">
                                <h2 style ="vertical-align:top;" >                            
                                    <div style="text-align:right;vertical-align: top; height: 20px;"> 
                                        ...
                                        <a class="imgbtn" onclick="AprlineNullAdd_onclick('dept')"><spring:message code='ezApproval.t1101'/></span></a>
        ...
        <div id="ApvForm_content8" style="width:100%;height:90%;display:none; padding-top:10px;">   
            ...
            <table class="content">
                <tr>
                    <td>
                        <textarea class="textarea" ID="txt_reformFunction" style="FONT-SIZE:9pt; WIDTH:820px; HEIGHT:790px">${strJSInfo}</textarea>
                    </td>
                </tr>
            </table>              
        </div>  
        <table id="TForm" style="height:0px;">
            <tr>
                <td style="vertical-align:top">
                    <script language='JavaScript'>FormProc_ActiveX2("pzFormProc", "2", "790px", "757px");</script>
                </td>
                <td id="rootTD"></td>
            </tr>
        </table> 
