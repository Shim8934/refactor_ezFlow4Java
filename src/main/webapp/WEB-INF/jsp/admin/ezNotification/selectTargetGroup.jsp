	        ...
	        function DisplayUserImageList() {
	            ...
	            if (dataCnt == 0) {
					...
					if (pListType == "IMG") {
		            	...
		            	M_TR_TD.setAttribute('colspan', '5');
						M_TR.appendChild(M_TR_TD);
	            ...
	            for (var i = 0; i < dataCnt; i++) {
	            	var dataRow = SelectNodes(xmlRtn, "LISTVIEWDATA/ROWS/ROW")[i];
	                if (pListType == "IMG") {
	                    var MainTable = document.createElement("TABLE");
	                    MainTable.setAttribute("class", pListType == "IMG" ? "organwrap" : "organwrap_list");
	                    MainTable.setAttribute("cellspacing", "0");
	                    MainTable.setAttribute("cellpadding", "0");
	                    MainTable.style.width = "540px";
	                    if (pListType == "IMG") {
	                    ...
	                    pDisplayName += titleRoleContent == "" ? "" : "[" + titleRoleContent + "]";
	                    ...
	                    if (pSeach) {
	                        ...
	                        var addJobFlag = M_TR.getAttribute("_DATA13");
	                        var title = M_TR.getAttribute("_DATA6") == "" ? "" : M_TR.getAttribute("_DATA6");
	                        M_TR_TD3.textContent = addJobFlag == 'addJob' ? '<spring:message code="ezOrgan.psb03"/>' + " " + title : title;
	                        ...
	                        M_TR_TD4.style.width = "80px";
	                        M_TR_TD4.textContent = dataRow.childNodes.item(5).childNodes.item(0).textContent// 직책
	                        M_TR_TD4.style.width = "80px";
	                        M_TR_TD4.style.overflow = "hidden";
	                        M_TR_TD4.style.textOverflow = "ellipsis";
	                        M_TR_TD4.style.whiteSpace = "nowrap";
	                        
	                        var M_TR_TD5 = document.createElement("TD");
	                        M_TR_TD5.textContent = M_TR.getAttribute("_DATA8") == "" ? "" : M_TR.getAttribute("_DATA8");
	
	                        M_TR.appendChild(M_TR_TD1);
	                        M_TR.appendChild(M_TR_TD2);
	                        M_TR.appendChild(M_TR_TD3);
	                        M_TR.appendChild(M_TR_TD4);
	                        M_TR.appendChild(M_TR_TD5);
	                        document.getElementById("Search_txtlist_table").getElementsByTagName("TBODY").item(0).appendChild(M_TR);
	                    } else {
	                        var M_TR_TD1 = document.createElement("TD");
	                        M_TR_TD1.style.overflow = "hidden";
	                        ...
	                        var addJobFlag = M_TR.getAttribute("_DATA13");
	                        var title = M_TR.getAttribute("_DATA6") == "" ? "" : M_TR.getAttribute("_DATA6");
	                        M_TR_TD2.textContent = addJobFlag == 'addJob' ? '<spring:message code="ezOrgan.psb03"/>' + " " + title : title;
	                        M_TR_TD2.style.overflow = "hidden";
	                        M_TR_TD2.style.textOverflow = "ellipsis";
	                        M_TR_TD2.style.whiteSpace = "nowrap";
	                        ...
	                        var M_TR_TD3 = document.createElement("TD");
	                        M_TR_TD3.style.width = "80px";
	                        M_TR_TD3.textContent = dataRow.childNodes.item(5).childNodes.item(0).textContent// 직책
	                        M_TR_TD3.style.overflow = "hidden";
	                        M_TR_TD3.style.textOverflow = "ellipsis";
	                        M_TR_TD3.style.whiteSpace = "nowrap";
	                        
	                        var M_TR_TD4 = document.createElement("TD");
	                        M_TR_TD4.textContent = M_TR.getAttribute("_DATA8") == "" ? "" : M_TR.getAttribute("_DATA8");
		            ...
		            if (p_ListOrderObject == null || p_ListOrderObject == "") {
		                ...
		                if (listContentArry != "") {
		                    for (var i = 0; i < listContentArry.length; i++) {
		                        ...
		                        var getlistview = new ListView();
		                        getlistview.LoadFromID(listid);
		                        var bFlag = getlistview.ExistRow("data8", strId + strDeptID.trim() + strJobID.trim() + strRoleID.trim());
		                        ...
		                        if (bFlag) {
		                            ...
		                            pparsingXML = pparsingXML + "<DATA5><![CDATA[" + strDeptID.trim() + "]]></DATA5>";
...
/* 		            for (var i = 0; i < arrRows.length; i++) {
			...
			function confirm_onClick() {
				...
				if (listviewSelected.length == 0) {
					alert("<spring:message code='ezSystem.config.hth23' />");
					return;
				}
				
				for (var i = 0; i < listviewSelected.length; i++) {
					var dataObj = {};
					var cn = listviewSelected[i].getAttribute("data1");
					var name = listviewSelected[i].getAttribute("data2");
					var name2 = listviewSelected[i].getAttribute("data3");
					var type = listviewSelected[i].getAttribute("data4");
					...
					dataObj.displayName2 = name2;
					dataObj.userType = type;
	                        ...
	                        <td>
	                            ...
	                            <table style="margin-top: 3px;">
	                                <tr>
	                                    ...
	                                    <td></td>
	                                    <td class="listview" style="width: 550px" id="orglistView">
	                                        ...
	                                        <div style="vertical-align: top; height: 426px; overflow: auto; width: 550px;" id="txtlist_Layer">
	                                            <table style="width: 100%; border: 1px solid #ddd; display: none;" id="txtlist_table" class="mainlist">
	                                                <tr>
	                                                    ...
	                                                    <td style="width: 100px; font-weight: bold;" class="td_gray"><spring:message code='ezEmail.t281' /></td>
	                                            ...
	                                            <table style="width: 100%; border: 1px solid #ddd; display: none;" id="Search_txtlist_table" class="mainlist">
	                                                <tr>
	                                                    ...
	                                                    <td style="width: 90px; font-weight: bold;" class="td_gray"><spring:message code='ezEmail.t281' /></td>
	                                                    <td class="td_gray" style="font-weight: bold;"><spring:message code='ezEmail.t99000045' /></td>
	                                                </tr>
	                                            </table>
	                                        </div>
	                                        <div style="vertical-align: top; text-align: center; height: 426px; overflow: auto; display: none; width: 550px;" id="DeptUserImgList"></div>
	                ...
	                <table id="ListViewGroupTD" style="display: none">
	                    <tr>
	                        <td>
	                            ...
	                            <div style="width: 772px; height: 465px; overflow: auto; background-color: #ffffff; margin-top: 3px;" id="ListViewGroup" class="border_gray">
	                            </div>
	                        </td>
	                    </tr>
                	</table>
					...
					<table id="ListViewJikwiTD" style="display: none">
	                    <tr>
	                        <td>
	                            ...
	                            <div style="width: 772px; height: 489px; overflow: auto; background-color: #ffffff; margin-top: 3px;" id="ListViewJikwi" class="border_gray">
	                            </div>
	                        </td>
	                    </tr>
                	</table>
                	<table id="ListViewJikchekTD" style="display: none">
	                    <tr>
	                        <td>
	                            ...
	                            <div style="width: 772px; height: 489px; overflow: auto; background-color: #ffffff; margin-top: 3px;" id="ListViewJikchek" class="border_gray">
	                            </div>
	                        </td>
	                    </tr>
                	</table>
