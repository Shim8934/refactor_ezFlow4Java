...
<html>
	<head>
		...
		function Save() {
			if (specialChk(document.getElementById("txtDisplayName").value) || specialChk(document.getElementById("txtDisplayName2").value) || specialChk(document.getElementById("txtNormalImage").value) || specialChk(document.getElementById("txtLinkLocation").value) || specialChk(document.getElementById("txtWindowOption").value)) {
