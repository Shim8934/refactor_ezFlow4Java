	...
	<head>
		...
		<script type="text/javascript">
	        ...
	        function SaveTheme_onClick() {
	            ...
	            //createNodeAndInsertText(xmlpara, objNode, "IMAGEPATH", normalImgPath);
                		...
                		<table style="width:100%">
                    		<tr class="primary">
                        		...
                        		<td style="border-bottom:1px solid #ddd;">
                        			<c:choose>
                        				...
                        				<c:otherwise>
                        					<input name="Input" id="Title1" style="WIDTH: 100%;-moz-box-sizing:border-box;box-sizing:border-box;" value="${themeNm1}" maxLength="255"/>
                        				</c:otherwise>
                        			</c:choose>
                            	</td>
                    		</tr>
                    		<tr class="secondary">
                        		...
                        		<td>
                        			<c:choose>
                        				...
                        				<c:otherwise>
                        					<input type="text" id="Title2" style="WIDTH: 100%;-moz-box-sizing:border-box;box-sizing:border-box;" value="${themeNm2}" maxLength="255"/>
                        				</c:otherwise>
                        			</c:choose>
                            	</td>
                    		</tr>
                    		<tr class="secondary" style='display:none'">
                        		...
                        		<td style="border-bottom:1px solid #ddd;">
                        			<c:choose>
                        				...
                        				<c:otherwise>
                        					<input type="text" id="Title3" style="WIDTH: 100%;-moz-box-sizing:border-box;box-sizing:border-box;" value="${themeNm3}" maxLength="255"/>
                        				</c:otherwise>
                        			</c:choose>
                            	</td>
                    		</tr>
                    		<tr class="secondary" style='display:none'>
                        		...
                        		<td>
                        			<c:choose>
                        				<c:when test="${mode == 'new'}">
                        					<input type="text" id="Title4" style="WIDTH: 100%;-moz-box-sizing:border-box;box-sizing:border-box;" value="" maxLength="255"/>
                        				</c:when>
                        				<c:otherwise>
                        					<input type="text" id="Title4" style="WIDTH: 100%;-moz-box-sizing:border-box;box-sizing:border-box;" value="${themeNm4}" maxLength="255"/>
                        				</c:otherwise>
                        			</c:choose>
                            	</td>
                    		</tr>
	    	                ...
	    	                <tr class="secondary">
	            	            ...
	            	            <td style="border-bottom:1px solid #ddd;">
	            	            		<c:choose>
	                        				...
	                        				<c:otherwise>
	                        					<input type="text" id="TopURL" style="WIDTH: 100%;-moz-box-sizing:border-box;box-sizing:border-box;" value="${themeTopURL}" maxLength="500"/>
	                        				</c:otherwise>
	                        			</c:choose>
	                    	    </td>
	                    	</tr>
		                ...
		                <table style="width: 100%">
	    	                <tr class="secondary">
	            	            ...
	            	            <td>
	            	            	<c:choose>
	                        			<c:when test="${mode == 'new'}">
	                        				<input type="text" id="MainURL" style="WIDTH: 100%;-moz-box-sizing:border-box;box-sizing:border-box;" value="" maxLength="500"/>
	                        			</c:when>
	                        			<c:otherwise>
	                        				<input type="text" id="MainURL" style="WIDTH: 100%;-moz-box-sizing:border-box;box-sizing:border-box;" value="${themeMainURL}" maxLength="500"/>
	                        			</c:otherwise>
	                        		</c:choose>
	                    	    </td>
	                    	</tr>
	    	                ...
	    	                <table style="width:100%;">
	        	                <tr>
								    <td id="tdNormalImage" style="width:100%;height:250px;vertical-align:middle;text-align:center;">
								    	<c:choose>
	                        				<c:when test="${mode == 'new'}">
	                        					<img id="txtNormalImage" src="" style="display:none;vertical-align:middle;text-align:center;">
	                        				</c:when>
	                        				<c:otherwise>
	                        					<img id="txtNormalImage" src="${themeImage}"  style="display:none;vertical-align:middle;text-align:center;">
	                        				</c:otherwise>
	                        			</c:choose>
	                    	            <p></p>
