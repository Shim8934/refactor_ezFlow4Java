...
<html style="height:100%">
	...
	<body class="leftbody" style="overflow-y: auto; overflow-x: hidden">
	    <div id="left">
	        ...
	        <div id="TopBoard"></div>	
	        <h3 style="border-top:1px solid #e6e6e6"><span style="width: 100%; display: inline-block; width: 100%;" onclick="OpenRightMenu(1)"><spring:message code="ezBoard.t122" /></span></h3>
