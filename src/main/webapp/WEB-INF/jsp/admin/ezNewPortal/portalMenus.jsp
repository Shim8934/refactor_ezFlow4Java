			...
			<form id="Form1" method="post">
				...
				<table class="content" style="width: 450px; margin-top:10px;">
				    <tbody><tr>
				        ...
				        <td>
							<div class='custom_radio'><input style="margin-top: 0px;" type="radio" id="topDisplayMode" name="topMenuDisplayMode" value="0"><label for="topDisplayMode" style="cursor: pointer; vertical-align: middle"><spring:message code="ezNewPortal.kwc01"/></label></div>
							<div class='custom_radio'><input style="margin-top: 0px;" type="radio" id="leftDisplayMode" name="topMenuDisplayMode" value="1"><label for="leftDisplayMode" style="cursor: pointer; vertical-align: middle"><spring:message code="ezPortal.t72"/></label></div>
				        </td>
				    </tr>
				</tbody></table>
