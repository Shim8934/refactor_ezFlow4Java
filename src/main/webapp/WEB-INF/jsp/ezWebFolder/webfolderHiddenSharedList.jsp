					...
					<table class="mainlist" style="width:100%"  id="tblFileList1">
						<thead id ="BoardList_THEAD">
							<tr>
								...
								<th class="wfFileShareDate		headListClick" headers="UPDATE_DATE" id="updateDateHeader" style="display:none;">갱신일</th><!-- 갱신일 -->
								<th class="wfFileShareMember	headListClick" headers="SHARER_NAME" id="sharerHeader" style="">공유자</th><!-- 공유자 -->
								<th class="wfFileShareDate		headListClick" headers="SHARE_DATE" id="shareDateHeader" style="">공유받은날짜</th><!-- 공유받은날짜 -->
								<th class="wfFilePath			" headers="FOLDER_PATH" style=""><spring:message code='ezWebFolder.t199'/></th><!-- 위치 -->
								<th class="wfFileShare			headListClick" headers="SHARE_STATUS" style="margin:0px 0px 0px !important; text-align: center;">공유</th><!-- 공유 -->
							</tr>
						</thead>
					</table>
