...
<body scroll="no" class="popup" onload="javascript:window_onload()">
	...
	<div style="margin: 0px 10px; border: none; height: 30px; position: relative;">
		<div style="position: absolute; top: 0px; right: 0px;">
			...
			<input name="treeType" id="radio4" type="radio" value="S"         style="margin:0px;padding:0px;width:13px;height:13px;" onclick="radioOnclick('S');"> <span><spring:message code='ezWebFolder.t235'/></span>
		</div>
	</div>
