...
// 					$('#shareDateHeader').css('display','');
				...
				for (var i = 0; i < len; i++) {
					...
					sharerColumn.setAttribute("title", resultJson["sharerName"]);
...
// 				$('#updateDateHeader').css('display','');
	...
	<body class="mainbody">
		...
		<div id="pageArea">
			...
			<div id="mainmenu">
				<ul>
					<li class="important" onclick="buttons.fileDownload()"><span><spring:message code='ezWebFolder.t161'/></span></li>
					<li class="important" id="uploadBtn" style="display:none;" onclick="buttons.fileUpload()"><span><spring:message code='ezWebFolder.t160'/></span></li>
					...
					<table class="mainlist" style="width:100%"  id="tblFileList1">
						<thead id ="BoardList_THEAD">
							<tr>
								...
								<th class="wfFilePath			" headers="FOLDER_PATH" ><spring:message code='ezWebFolder.t199'/></th><!-- 위치 -->
