...
<html>
	<head>
	    <title><spring:message code="${type eq 'master' ? 'ezWebFolder.ksa10' : 'ezWebFolder.ksa11' }"/></title>
	...
	<body class="popup" onkeydown="event_listOnkeyDown(event);" onkeyup="event_listOnkeyUp(event);" style="overflow:hidden">
		...
		<xml id="listviewheader1" style="display: none;">
		  <LISTVIEWDATA>
			...
			<h1><spring:message code="${type eq 'master' ? 'ezWebFolder.ksa10' : 'ezWebFolder.ksa11' }"/></h1>
	        <div id="close">
	            <ul>
		            ...
		            <td style="vertical-align: top;">
		            	<div class="portlet_tabpart01" style="margin:0px;">
		            		<div class="portlet_tabpart01_top" id="tab1" style="margin-bottom:3px;">
		            			...
		            			<p id="orgTabButton2" style="${folderManager eq 1? 'display: none;' : 'display: none;'}">
		            			...
		            			<p id="orgTabButton3" style="${folderManager eq 1? 'display: none;' : 'display: none;'}">
		            			...
		            			<p id="orgTabButton4" style="${folderManager eq 1? 'display: none;' : 'display: none;'}">
		                    ...
		                    <tr id="ListMsgTo">
		                        ...
		                        <td style="vertical-align: top;">
		                            ...
		                            <div class="receiver_borderbox" style="border-bottom:none;">
		                                <div id="ListViewMsgTo" ondragover ="onDragEnter(event, this)" ondrop ="onDrop(event, this)" style="width: 250px; Height: 492px; border-bottom: 1px solid #ddd; border-top:1px solid #ddd; overflow: auto;" ondblclick="DeleteReceiver(ListViewMsgTo)"></div>
		                            </div>
		                        </td>
		                    </tr>
		                </table>
	...
	<script>
        ...
        var primary = "<c:out value='${lang}'/>";
     	// 2020-12-01 김은실 - (카이스트)회사 폴더별 관리자 지원 기능 
        var authListParent = [];
     	var type = "${type}";
	        
        window.onload = function () {
        	var appMembers = window.opener.getAppliMembers(type);
        	authList = appMembers;
        ...
        var setAuthListToXML = function() {
        	...
        	for (var i = 0; i < authListLength; i++) {
                ...
                var deptName = authList[i].deptName;
                var strName = "";
                ...
                pparsingXML = pparsingXML + "<DATA_DEPTNAME><![CDATA[" + deptName + "]]></DATA_DEPTNAME>";
        ...
        function ReplaceText(orgStr, findStr, replaceStr) {
	        ...
	        function recevieListview(pID, pListView) { // s
	            var listview = new ListView();
	            listview.SetID(pID);
	            listview.SetSelectFlag(false);
...
// 	                    headerData = loadXMLString(listviewheader.innerHTML.toUpperCase());
	        ...
	        function OK_Click() {
	            ...
	            for (var i = 0; i < memberListLength;i++) {
	            	...
	            	var deptName = memberList[i].getAttribute("data_deptname");
	            	...
	            	popupUserList.push({"userId" : memberId, "userName" : memberName, "userType" : memberType, "sn" : i, "deptName" : deptName });
	            }
	            
	            window.opener.setAppliMembers(type, popupUserList);
	            window.close();
	        }
	        ...
	        function InsertReceiver(pListView) {
	            ...
	            if (m_selectedTree == orglistView) {
		            if ((p_ListOrderObject == null || p_ListOrderObject == "") && type!="master") {
		                ...
		                if (listContentArry != "") {
		                    for (var i = 0; i < listContentArry.length; i++) {
		                        ...
		                        var strDeptName = document.getElementById(listContentArry[i]).getAttribute("_data5");
		                        ...
		                        var bFlag = getlistview.ExistRow("data1", strId);
		                     	...
		                     	// 중복체크 추가
		                        if (bFlag) {
									alert(strName + "(" + strDeptName + ")" + ": <spring:message code='ezBoard.t20' />");
								} else {
		                            pparsingXML2 = "";
		                            pparsingXML = "";
		                            pparsingXML2 = "<LISTVIEWDATA2><ROWS>";
		                            ...
		                            pparsingXML = pparsingXML + "<DATA5>N</DATA5>";
		                            pparsingXML = pparsingXML + "<DATA_DEPTNAME>" + MakeXMLString(strDeptName) + "</DATA_DEPTNAME>";
		                            pparsingXML = pparsingXML + "<VALUE>" + MakeXMLString(strName) + "(" + MakeXMLString(strDeptName) + ")</VALUE></CELL></ROW>";
		                            pparsingXML2 = pparsingXML2 + pparsingXML + "</ROWS></LISTVIEWDATA2>";
		                            Resultxml = loadXMLString(pparsingXML2);
