...
<html style="height:0%;">
   <head>
      <title><spring:message code="ezCar.shb06"/></title>
      ...
      <script type="text/javascript">
         ...
         function imgAttach() {
            ...
            if(attach1 != "") {
               document.getElementById("preview1").src = "/ezCar/getCarThumbnailInfo.do?fileName=" + encodeURIComponent(attach1);
            }
         ...
         function btnSave_Click() {
            ...
            xmlHttp.open("Post", "/ezCar/callModClsItem.do", false);
         ...
         function btnTakeOwner_Click(val) {
            ...
            var OpenWin = window.open("/ezCar/selectPerson.do", "selectPerson", GetOpenWindowfeature(1000, 550));
            try { 
               OpenWin.focus(); 
            } catch (e) {
                  ...
                  <table class="content">
                    ...
                    <tr>
                         ...
                         <td colspan="3" style="white-space:nowrap">
                            ...
                            <input type="text" name="OwnerCall" id="OwnerCall" onKeyup="this.value=this.value.replace(/[^-0-9-,]/g,'');" value="${ownerCall}" style="width: 100%" >
                         </td>
                    ...
                    <tr>
                         ...
                         <td colspan="3"><input type="text" name="car_NM" id="car_NM" idval="${car_nm}" value="<c:out value='${car_nm}' />" style="width: 100%" maxlength="30"></td>
                    </tr>
                    <%-- <tr>
