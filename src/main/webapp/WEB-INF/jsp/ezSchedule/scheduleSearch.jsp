			...
			<h1><spring:message code='ezSchedule.t347'/></h1> 
		 	...
		 	<h2 class="h2_dot">
		  	...
		  	<table class="mainlist" style="table-layout:fixed;width:100%">
		    	...
		    	<tr style="cursor:pointer;padding:0" ondblClick="open_schedule('${item.scheduleId}','${item.repeatCount}','${item.startDate}','${item.scheduleType}','${item.dateType}','')" bgcolor=#ffffff>
