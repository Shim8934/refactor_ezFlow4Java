	                                    	...
	                                    	<div style="margin-top:3px;height:auto;">
												<div class="custom_checkbox">
													...
													<label for="fileSelect${status.index}">
														...
														<img src="${imagePath}" style="vertical-align: middle"/>&nbsp;<a href="/ezSchedule/downloadAttach.do?fileName=${item.fileEncodeName}&filePath=${item.filePath}" id="regData_${status.count}"><c:out value="${item.fileName}"/> (${item.fileTranSize})</a>
													</label>
	                                    		</div>
											</div>
	                                    </c:forEach>
