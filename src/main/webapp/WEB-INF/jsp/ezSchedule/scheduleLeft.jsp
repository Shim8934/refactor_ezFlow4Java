	...
	<body class="leftbody">
	    ...
	    <div id="left">
		    ...
		    <ul>		
	            ...
	            <li style="border-top:1px solid #e6e6e6" evt="0"><span id='Schedule_Group' onClick="Function_Flag(5)" style="width:100%;display:inline-block;">&nbsp;<spring:message code='ezSchedule.t252'/></span></li>
