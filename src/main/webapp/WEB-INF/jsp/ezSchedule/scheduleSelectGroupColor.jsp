...
<html>
	<head>
		...
		<script>			
		    var groupColor = "<c:out value='${groupColor}' />";
	        var DefaultColor = "";
            ...
            function ok_onclick() {
		        if (document.all("sel_color").value == "") {
         	    ...
         	    select_groupcolor_complete(window.returnValue);
	...
	<body class="popup_color">
		<div class="popup_color_header" style="width: 100%; height: 80px; float: left;">
			<div id="close" style="width: 28px; height: 28px; float: right; margin: auto;">
				<ul>
               		<li><span onclick="btn_close()"></span></li>
           		</ul>
			</div>
			<div class="popup_color_title" style="width: 150px; height: 30px; margin: auto; margin-top: 40px; text-align: center;">
				<span style="font-size: 20px;"><b><spring:message code='ezSchedule.csj02'/></b></span>
			</div>
		</div>
		<div class="popup_color_body" style="width: 100%; height: 200px; float: left;">
				...
				<table class="popup_color_content" style="width: 100%; height: 100%; border: 1px solid #d2d2d2;">
                    <tr>
                        ...
                        <td>
                        	...
                        	<div id="selected_color_text" style="width: 190px; height: 25px; float: left; margin-top: 1px; margin-left: 8px;">
                        		<input type="text" id="sel_color" style="width: 100%;" readonly>
                        	</div>
                         </td>
                    </tr>
                </table>
		...
		<div class="popup_color_footer" style="width: 100%; height: 90px; float: left;">
