	                    ...
	                    if (!confirm("<spring:message code='ezBoard.t10055'/>"))
	                        ...
	                        if (CrossYN() || pNoneActiveX == "YES") {
	                            ...
	                            if (pUse_IE11Browser == "CK") {
	                                ...
	                                if(pUse_Editor == "")
	                                    document.location.href = "NewBoardItem.aspx?BoardID=" + ret[0] + "&Mode=new&BTYPE=SELECT";
	                                else
	                                    document.location.href = "NewBoardItem_IE.aspx?BoardID=" + ret[0] + "&Mode=new&BTYPE=SELECT";
	                            }
	                        }
	                    }
	                }
