...
function AddAttachFileInfoXmlParsing(pfilename, pSaveFileName, pfilesize, pfilelocation, pAttachAddFileSize, pAttatchFilePath) {
    try {
        ...
        //if (pUrl != "") {
        //    var pfilenamepath = pfilename;
        //    pfilenamepath = replace(pfilenamepath, "+", "%2b");
        //    pfilenamepath = replace(pfilenamepath, ";", "%3b");
        //    //alert(pAttatchFilePath);
        //    // var fullPath = document.location.protocol + "//" + document.location.hostname + "/myoffice/Common/DownloadAttach.aspx?filepath=" + escape(DocHref) + "&filename=" + escape(strLang116 + fileext) + "&regData=" + regData;
