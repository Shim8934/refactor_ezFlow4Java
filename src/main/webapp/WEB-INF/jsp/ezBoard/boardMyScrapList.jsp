...
<html>
	<head>
		...
		<style>
		    ...
		    <script type="text/javascript">
		        ...
		        function ItemRead_onclick(obj) {
			        ...
			        if (obj.getAttribute("DATA10") == "4" || obj.getAttribute("DATA10") == "3") {
						...
						isOpenWindow = window.open("/ezBoard/boardItemViewMovie.do?showAdjacent=" + ShowAdjacent + "&itemID=" + encodeURIComponent(obj.getAttribute("DATA2")) + "&boardID=" + encodeURIComponent(obj.getAttribute("DATA1")), "",  "&location=GENERAL", "", "toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=1,height=679,width=890,top=" + pTop + ",left=" + pLeft, "");
		            } else {
		        ...
		        function DeleteItem() {
		            var xmlhttp = createXMLHttpRequest();
		            xmlhttp.open("POST", "/ezBoard/deleteScrapItem.do?itemList=" + encodeURIComponent(strListInfo) + "&mode=" + pMode, false);
		            xmlhttp.send();
		        ...
		        function refresh_onclick() {
		            window.location.href = "/ezBoard/boardMyScrapList.do?page=" + CurPage.toString();
		        }
		    ...
		    function DeleteItem_onclick() {
		        if (strListInfo == "") {
		            alert("<spring:message code='ezBoard.kmh19'/>");
		            return;
		        }
		    ...
		    function MailReadOpen_scrap() {
		        ...
		        if (previewType == "PHOTO" || (selobj.getAttribute("DATA10") == "3" || selobj.getAttribute("DATA10") == "4")) {
		    		...
		    		pTop = (pheight - 789) / 2;
		    		pLeft = (pwidth - 790) / 2;
		    		window.open("/ezBoard/boardItemViewPhoto.do?showAdjacent=" + ShowAdjacent + "&itemID=" + encodeURIComponent(selobj.getAttribute("DATA2")) + "&boardID=" + encodeURIComponent(selobj.getAttribute("DATA1")), "", "toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=1,height=" + height +",width=890,top=" + pTop + ",left=" + pLeft, "");
		        } else if (previewType == "MOVIE" || selobj.getAttribute("DATA10") == "7" ) {
		        	 pTop = (pheight - 679) / 2;
		             window.open("/ezBoard/boardItemViewMovie.do?showAdjacent=" + ShowAdjacent + "&itemID=" + encodeURIComponent(selobj.getAttribute("DATA2")) + "&boardID=" + encodeURIComponent(selobj.getAttribute("DATA1")), "", "toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=1,height=679,width=890,top=" + pTop + ",left=" + pLeft, "");
		        } else {
		            window.open("/ezBoard/boardItemView.do?showAdjacent=" + ShowAdjacent + "&itemID=" + encodeURIComponent(selobj.getAttribute("DATA2")) + "&boardID=" + encodeURIComponent(selobj.getAttribute("DATA1")), "", "toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=1,height=720,width=890,top=" + pTop + ",left=" + pLeft, "");
		        }
		    }
	...
	<body class="mainbody" style="overflow:hidden;" onmousemove="MailPreviewResize(event);" onmouseup="MailPreviewEnd(event);">
	    <h1><spring:message code='ezBoard.kmh12'/><span id="mailBoxInfo"></span>
		            ...
		            <div class="previewmail">
		                <div class="previewmail_info">
		                	<dl class="previewmailDL" id="Preview_HeaderH" style="display:none;">
								...
								<dd class="pretext">
									<ul class="pretextUL">
										<li class="preSubject"><span class="popup_open" onclick="MailReadOpen_scrap();"><img src="/images/kr/cm/btn_newpopup.svg" title="<spring:message code='ezEmail.t99000001' />" alt="<spring:message code="ezEmail.t99000001" />"></span><span class="subjectText" id="PreH_subject"><span class="subjectText" id="PreH_sub_subject"></span></span></li>
