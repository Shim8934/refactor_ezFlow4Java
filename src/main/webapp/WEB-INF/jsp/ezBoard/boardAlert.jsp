	...
	<head>
		...
		<script ID="clientEventHandlersJS" type="text/javascript">
		    ...
		    window.onload = function () {
		        try {
		            RetValue = parent.ezboardalert_cross_dialogArguments[0];
		            ReturnFunction = parent.ezboardalert_cross_dialogArguments[1];
		            winFlag = parent.ezboardalert_cross_dialogArguments[2];
		        } catch (e) {
		            try {
		                RetValue = opener.ezboardalert_cross_dialogArguments[0];
		                ReturnFunction = opener.ezboardalert_cross_dialogArguments[1];
			            winFlag = opener.ezboardalert_cross_dialogArguments[2];
		            } catch (e) {
	...
	<body style="overflow:hidden;">
	    ...
	    <div class="popup_noti_btnarea"> 
	   	    <div class="btnposition"> 
	               <input type="submit"  value="<spring:message code='ezBoard.kmh43'/>" id="Submit1" name="btn_OpinionOK" onClick="return btn_OpinionOK_onclick()" >
		    </div>
