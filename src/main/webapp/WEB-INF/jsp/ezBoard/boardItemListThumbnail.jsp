	...
	<head>
		...
		<script type="text/javascript">
		    ...
		    function NewItem_onclick() {
		        ...
		        window.open("/ezBoard/newBoardItemPhoto.do?boardID=" + encodeURIComponent(pBoardID) + "&gubun=4" + "&mode=new", "", "toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=0,resizable=1,height=700,width=765,top=" + pTop + ",left=" + pLeft, "");
		    }
		 ...
		 /*    var moveboarditem_cross_dialogArguments = new Array();
		    ...
		    function SetBoardAcl() {
		        ...
		        if (xmlhttp.status == 200) {
					...
					location.href = "/admin/ezBoard/boardConfig.do?boardID=" + encodeURIComponent(pBoardID) + "& =" + encodeURIComponent(getNodeText(xmlhttp.responseText))
	            ...
	            <div class="previewmail">
	                <div class="previewmail_info">
	                	<dl class="previewmailDL" id="Preview_HeaderH" style="display:none;">
							...
							<dd class="pretext">
								<ul class="pretextUL">
									<li class="preSubject"><span class="popup_open" onclick="MailReadOpen();"><img src="/images/kr/cm/btn_newpopup.svg" title="<spring:message code='ezEmail.t99000001' />" alt="<spring:message code="ezEmail.t99000001" />"></span><span class="subjectText" id="PreH_subject" style="max-width:570px;"><span class="subjectText" id="PreH_sub_subject"></span></span></li>
