...
// 		        }
			...
			function ladderFunc() {
				window.parent.frames["right"].location.href = "/ezLadder/ladderMain.do?mode=all&currPage=1&searchSelect=&searchInput=&sort=writeDate&sortFlag=desc";
			}
	...
	<%-- 	            <span style="background:url('/images/i_group.gif') no-repeat 8px; border-bottom:1px solid #aeabab; display: inline-block; width: 100%;"><spring:message code="ezBoard.t360"/></span> --%>
	        ...
	        <div class="ladder" onclick="ladderFunc()">
