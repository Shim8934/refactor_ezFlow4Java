...
alert(listdom);            
        ...
        function event_statuschange(obj) {
            checkHttp = null;
            checkHttp = createXMLHttpRequest();
            var xmlpara = createXmlDom();
            var objNode;
            createNodeInsert(xmlpara, objNode, "DATA");
            createNodeAndInsertText(xmlpara, objNode, "BOARDID", obj.getAttribute("BoardID"));

            if (obj.checked)
                createNodeAndInsertText(xmlpara, objNode, "TABUSED", "Y");
            else
                createNodeAndInsertText(xmlpara, objNode, "TABUSED", "N");

            checkHttp = createXMLHttpRequest();
            checkHttp.open("POST", "/myoffice/ezBoardSTD/aspx/Set_TabUse.aspx", false);
        ...
        function Save() {
            ...
            createNodeAndInsertText(xmlpara, objNode, "ORDERBOARDID", boardID);
            createNodeAndInsertText(xmlpara, objNode, "DELBOARDID", delBoardID);
            xmlhttp.open("POST", "/myoffice/ezBoardSTD/aspx/SaveListOrder.aspx", false);
