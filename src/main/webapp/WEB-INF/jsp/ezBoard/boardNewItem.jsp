             ...
             <!-- 추가 항목이 있을 경우 -->
	          ...
	          <!-- 추가 항목이 있을 경우 끝-->
	                    <tr>
	                        ...
	                        <td colspan="3">
	                            <input type="text" id="txtTitle" style="WIDTH: 100%; word-wrap: break-word; word-break: break-all;" value="" maxlength="100" autocomplete="Off" onkeydown="Title_onkeyDown(event)" ></td>
	                    </tr>
	                    <c:if test="${boardInfo.guBun == '2'}">
		                    <tr>
		                        <th><spring:message code='ezBoard.t438' /></th>
		                        <td colspan="3">
		                            <input type="password" id="txtPassWord" style="WIDTH: 150px" maxlength="15" autocomplete="Off">&nbsp;&nbsp;(<spring:message code='ezBoard.t439' /></td>
		                    </tr>
	                    </c:if>
	                </table>
	                ...
	                <table class="content">
	                    ...
	                    <tr>
	                        ...
	                        <td style="vertical-align: middle" colspan="2">
	                            <input type="text" id="txtTitle" style="WIDTH: 95%; word-wrap: break-word; word-break: break-all;" value="" autocomplete="Off" maxlength="100" onkeydown="Title_onkeyDown(event)"></td>
	                    </tr>
	                    <tr>
	                    ...
	                    <c:if test="${boardInfo.guBun == '2'}">
		                    ...
		                    <tr style="display: none">
		                        <th><spring:message code='ezBoard.t438' /></th>
		                        <td style="vertical-align: middle" colspan="2">
		                            <input type="password" id="txtPassWord" style="WIDTH: 100px" maxlength="15" autocomplete="Off">
