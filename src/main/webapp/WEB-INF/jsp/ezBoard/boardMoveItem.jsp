...
// 		            alert("<spring:message code='ezBoard.t354'/>");
				...
				if (parentGroup == "Y") {
					var pUrl = "/ezBoard/boardAlertDialog.do?CAPTION=" + encodeURIComponent("<spring:message code='ezBoard.lyj07'/>") + "&MESSAGE=" + encodeURIComponent("<spring:message code='ezBoard.lyj07'/>") + "&BUTTONNAMES=" + encodeURIComponent("<spring:message code='ezBoard.t14' />");
					DivPopUpShow(330, 205, pUrl);
					return;
				}
...
// 		            alert("<spring:message code='ezBoard.t181'/>" + xmlhttp.responseText);
	...
	<body class="popup"> 
		...
		<div class="box" style="height:485px;overflow:auto;overflow-x:hidden"  id=TopBoardsList></div>
