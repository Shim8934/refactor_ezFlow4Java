		...
		<script  type="text/javascript">
		    ...
		    window.onload = function () {
		        try {
					...
					var cssHeading = "<style type='text/css'>.contentDiv h1, .contentDiv h2, .contentDiv h3, .contentDiv h4, .contentDiv h5, .contentDiv h6 {font-size:revert; margin:revert; line-height:revert; color:revert;}</style>";
