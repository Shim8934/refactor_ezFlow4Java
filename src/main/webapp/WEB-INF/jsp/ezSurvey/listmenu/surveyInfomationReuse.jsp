						...
						<div>
							<div class='custom_radio'>
                                ...
                                <span class="inf-spanTxt" title="<spring:message code='ezSurvey.yjh18'/>">(&nbsp;<spring:message code="ezSurvey.yjh17"/>&nbsp;:&nbsp;
                                    <input id="userExposedSpan1" type="radio" name="userExposedSpan" value="1" ${survey.userExposedFlag == 1 ? 'checked' : ''}><label for="userExposedSpan1"><spring:message code="ezSurvey.t42"/></label>
                                    <input id="userExposedSpan2" type="radio" name="userExposedSpan" value="0" ${survey.userExposedFlag == 0 ? 'checked' : ''}><label for="userExposedSpan2"><spring:message code="ezSurvey.t43"/></label>
								&nbsp;)
							</span>
							</div>
						</div>
...
<div class="survey-otherinf" id="closingWrap">
	...
	<textarea id="closingText">${survey.closingText}</textarea>
</div>
