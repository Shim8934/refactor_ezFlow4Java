				...
				<div id="download_div02">
					...
					<div class="sum_img_div_wrap">
						<div class="sum_img_div_loc"> 
							<div><img src="<c:url value='/'/>images/sample/img_download.gif" /></div>							
						</div> 
...
감사합니다.				
				...
				<div class="buttons" style="clear:both;float:right;padding-top:10px;padding-bottom:10px;"><a href="EgovDownload.jsp">목록 </a></div> 
