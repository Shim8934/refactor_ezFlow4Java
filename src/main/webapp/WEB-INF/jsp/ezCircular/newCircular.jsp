	...
	<body class="mainbody" style="overflow:hidden;" onmousemove="MailPreviewResize(event);" onmouseup="MailPreviewEnd(event);">
	    ...
	    <div id="mainmenu">
	        <ul>
				...
				<li style="background:none;cursor:default;"><span style="display:inline-block; width:14px; height:14px; background:url(/images/ImgIcon/msg-rd.gif); overflow:hidden; margin:7px 0px 0px 0px; padding:0; vertical-align:middle;"></span>&nbsp;<spring:message code='ezCircular.t197'/></li>
	            <li style="background:none;cursor:default;"><span style="display:inline-block; width:14px; height:14px; background:url(/images/ImgIcon/msg-unrd.gif); overflow:hidden; margin:7px 0px 0px 0px; padding:0; vertical-align:middle;"></span>&nbsp;<spring:message code='ezCircular.t143'/></li>
	            <li style="background:none;cursor:default;"><span style="display:inline-block; width:14px; height:14px; background:url(/images/ImgIcon/circular_share2.gif); overflow:hidden; margin:7px 0px 0px 0px; padding:0; vertical-align:middle;"></span>&nbsp;<spring:message code='ezCircular.t188'/></li>
	            <li id="right">
