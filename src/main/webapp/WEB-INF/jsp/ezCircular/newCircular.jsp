	...
	<body class="mainbody" style="overflow:hidden;" onmousemove="MailPreviewResize(event);" onmouseup="MailPreviewEnd(event);">
	    <h1><spring:message code='ezCircular.t2'/><span id="lstCnt"></span><span id="mailBoxInfo"></span>
	        <span class="searchForm">
	        	<!-- 2018-07-12 김민성 - 회람판 검색 select box로 수정 -->
	       		<select id="searchType" class="text" style="width: 65px; height: 27px; border: 1px solid #cbcbcb;">
	    ...
	    <div id="mainmenu" style="margin-bottom:8px">
	        <ul>
				...
				<li style="background:none;cursor:default;border:0px;color:#393939"><span style="display:inline-block; border:0px; width:16px; height:16px; background:url(/images/ImgIcon/msg-rd.png); overflow:hidden; margin:7px 0px 0px 15px; padding:0; vertical-align:middle;box-shadow:none"></span>&nbsp;<span><spring:message code='ezCircular.t197'/></span></li>
	            <li style="background:none;cursor:default;border:0px;color:#393939"><span style="display:inline-block; border:0px; width:16px; height:16px; background:url(/images/ImgIcon/msg-unrd.png); overflow:hidden; margin:7px 0px 0px 0px; padding:0; vertical-align:middle;box-shadow:none"></span>&nbsp;<span><spring:message code='ezCircular.t143'/></span></li>
	            <li style="background:none;cursor:default;border:0px;color:#393939"><span style="display:inline-block; border:0px; width:16px; height:16px; background:url(/images/ImgIcon/circular_share2.png); overflow:hidden; margin:7px 0px 0px 0px; padding:0; vertical-align:middle;box-shadow:none"></span>&nbsp;<span><spring:message code='ezCircular.t188'/></span></li>
	            <!-- <li id="right">
