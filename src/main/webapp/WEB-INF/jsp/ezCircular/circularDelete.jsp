...
// 	            BoardSearchOptionHidden();
	...
	<body class="mainbody" style="overflow:hidden;" onmousemove="MailPreviewResize(event);" onmouseup="MailPreviewEnd(event);">
	    <h1><spring:message code='ezCircular.t6'/><span id="mailBoxInfo"></span>
	    ...
	    <div id="mainmenu">
	        <ul>
	            ...
	            <li id="right"><spring:message code='ezCircular.t88'/><img src="/images/kr/cm/btn_arrow_down.gif" alt="" mode="off" id="maillistoptiondiv" onclick="MailOptionView(this);" /></li>
	        </ul>
	    </div>
	    <script type="text/javascript">
