			...
			<h1><spring:message code='ezCircular.t8' /></h1> 
		  	<table style="width:100%" class="content">  
		    	...
		    	<tr> 
		      		...
		      		<td>
						<div class="custom_checkbox"><input type="checkbox" value="1" id="usepostdate" onclick="DateSearch_Click()"><label for="usepostdate"><spring:message code='ezCircular.t138'/></label></div>
