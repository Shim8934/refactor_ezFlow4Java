	...
	<body style="overflow:auto" id="theBody" class="mainbody"> 
		...
		<table class="content"> 
			...
			<tr>
				...
				<td>
					<input type="checkbox" value="1" id="usepostdate" style="display:none;"><a class="imgbtn"><span onclick="DateSearch_Click();"><spring:message code="ezEmail.t654" /></span></a>
