...
// 	                document.getElementById("btnAddUser").style.display = "";
	                if (CrossYN())
	                    document.getElementById("ToTitleStr").textContent = "<spring:message code='ezTask.t137'/>";
	                else
	                    document.getElementById("ToTitleStr").innerText = "<spring:message code='ezTask.t137'/>";
	            }
...
// 		                    }
		    ...
		    function search_click(type) {
		        ...
		        $.ajax({
					...
					error : function(jqXHR, textStatus, errorThrown) {
						alert("부서 구성원을 가져오는 중 오류가 발생했습니다." + textStatus);
					}
				});
...
// 	        }
	...
	<body class="popup" style="overflow:hidden">
		<h1 id="h1Title"><spring:message code='ezTask.t157' /></h1>
...
<!-- 						    </div> -->
	                                            ...
	                                            <td>
	                                                <div style="margin-left: 5px;">
	                                                    <select id="search_type">
	                                                        <option selected value="displayname" usedefault="1">이름</option>
	                                                        <option value="description" usedefault="1">부서</option>
	                                                        <option value="title" usedefault="1">직위</option>
	                                                        <option value="telephonenumber" usedefault="1">사내전화</option>
	                                                        <option value="mobile" usedefault="0">이동전화</option>
	                                                        <option value="HomePhone" usedefault="0">집전화</option>
	                                                        <option value="facsimileTelephoneNumber" usedefault="0">팩스</option>
	                                                        <option value="mail" usedefault="0">이메일</option>
	                                                        <option value="streetAddress" usedefault="0">주소</option>
	                                                    </select>
	                                                    <input id="keyword" value="" onkeyup="search_press(event)" onmousedown="keyword_Clear();" style="width: 130px; margin: 0px;">
	                                                    <a class="imgbtn"><span onclick="search_click('search')">검색</span></a>
	                                                </div>
	                                            </td>
	                                            <td>
	                                                <div style="float: right; margin-right: 5px;">
	                                                    <a href="#" class="imgbtn"><span onclick="infoview_click()">사원정보보기</span></a>
	                                                </div>
	                                            </td>
	                                        </tr>
	                                    </table>
	                                    ...
	                                    <td class="listview" style="width: 426px" id="orglistView">
	                                        ...
	                                        <div style="vertical-align: top; height: 440px; overflow: auto; width: 440px;" id="txtlist_Layer">
	                                            <table style="width: 100%; border: 1px solid #B6B6B6; display: none;" id="txtlist_table" class="mainlist">
	                                                <tr>
	                                                    <td style="width: 170px; font-weight: bold;" class="td_gray">이름</td>
	                                                    <td style="width: 150px; font-weight: bold;" class="td_gray">직위</td>
	                                                    <td class="td_gray" style="font-weight: bold;">사내전화</td>
	                                                </tr>
	                                            </table>
	                                            <table style="width: 100%; border: 1px solid #B6B6B6; display: none;" id="Search_txtlist_table" class="mainlist">
	                                                <tr>
	                                                    <td style="width: 130px; font-weight: bold;" class="td_gray">부서</td>
	                                                    <td style="width: 90px; font-weight: bold;" class="td_gray">이름</td>
	                                                    <td style="width: 90px; font-weight: bold;" class="td_gray">직위</td>
	                                                    <td class="td_gray" style="font-weight: bold;">사내전화</td>
	                                                </tr>
	                                            </table>
	                                        </div>
	                        ...
	                        <td style="vertical-align: top;">
	                            <h2 id="ToTitle" class="receiver_tltype01">
	                                <span style="min-width: 45px;" id="ToTitleStr">검색기간</span>
	                            </h2>
		...
		<div class="btnposition">
	    	<a class="imgbtn" onClick="btnok_onclick()" ><span><spring:message code='ezTask.t19' /></span></a>
