...
<html>
	<head>
	    <title><spring:message code='ezMemo.t0030'/></title>
	...
	<body class="popup" onload="javascript:window_onload()">
	    <h1><spring:message code='ezMemo.t0030' /></h1>
	    <div id="close">
            <ul>
	    ...
	    <div class="btnposition btnpositionNew">
	        <a id="btn_ok" class="imgbtn" onclick="btn_ok_onclick()"><span><spring:message code='ezMemo.t0032' /></span></a>
	    </div>
	</body>
</html>