                        ...
                        <div class="chatTalk">
                            <div id= "chatContent" class="ai_cont">
                                ...
                                <div name="chatText" class="ai_text_question">
                                    <span id="simpleSummary" onclick="simplePrompt(this, 'mail')" class="ai_text_list" data-simpletype="1" data-comment="내용을 요약해 주세요.">
                                        <a style="cursor: pointer;"><spring:message code="ai.chat.simple.request.sum" /></a>
                                    </span>
                                    <span id="simpleReply" onclick="simplePrompt(this, 'mail')" class="ai_text_list" data-simpletype="2" data-comment="회신 내용을 작성해 주세요.">
                                        <a style="cursor: pointer;"><spring:message code="ai.chat.simple.request.reply" /></a>
                                    </span>
                                    <span id="simpleTranslate" onclick="simplePrompt(this, 'mail')" class="ai_text_list" data-simpletype="3" data-comment="영어로 번역해 주세요.">
                    ...
                    <div class="textarea_value_position">
                        ...
                        <div class="textarea_value" id="dropZone">
                            ...
                            <div class="refDocuments">
                                ...
                                <button id="sendChatModelBtn" type="button" class="btn_value_send" onclick="userInput('mail')"></button>
                            </div>
                        </div>
                    </div>
                    <%-- //입력box --%>
