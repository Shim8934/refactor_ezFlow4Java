...
<html>
	<head>
		...
		<script type="text/javascript" src="${util.addVer('ezAI.e1', 'msg')}"></script>
        ...
        <script type="text/javascript" src="${util.addVer('/js/ezAI/ezEmail/ezAIEmailCommon.js')}"></script>
    ...
    <body> 
        <div class="ds_lay_viewOpenAI" id="simpleAi" style="" data-type="${moduleType}" data-subtype="${moduleSubType}" data-data="" data-call="false">
                        ...
                        <div class="chatTalk">
                            <div id= "chatContent" class="ai_cont">
                                ...
                                <div name="chatText" class="ai_text_question">
                                    <span id="simpleSummary" onclick="simplePrompt(this)" class="ai_text_list" data-functionType="summarize">
                                        <a style="cursor: pointer;"><spring:message code="ai.chat.simple.request.sum" /></a>
                                    </span>
                                    <span id="simpleTranslate" onclick="simplePrompt(this)" class="ai_text_list" data-functionType="translate">
                                        <a style="cursor: pointer;"><spring:message code="ai.chat.simple.request.Translate" /></a>
                                    </span>
                                    <c:if test="${moduleType eq 'mail'}">
                                        <span id="simpleReply" onclick="simplePrompt(this)" class="ai_text_list" data-functionType="draft">
