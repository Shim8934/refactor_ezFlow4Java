...
// 		                XmlBodyATT = GetElementsByTagName(tempXML, 'BODYATTS')[0];
		    ...
		    function GetTagList(strTagName) {
		        ...
		        try {
		            ...
		            for (i = 0; i < count; i++) {
		                if (div_Content.getElementsByTagName("*")[i].tagName == strTagName) {
		                    TagsList[TagCount] = div_Content.getElementsByTagName("*")[i];
		                    TagCount++;
		                }
		            }
		            return TagsList;
		    ...
		    function GetFieldValue(fieldname) {
		        try {
		            return document.getElementById(fieldname).innerText;
		        } catch (e)
		        { return ""; }
		    }
