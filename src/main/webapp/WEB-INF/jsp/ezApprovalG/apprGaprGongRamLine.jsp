...
<html>
	<head>
	    ...
	    <script type="text/javascript" src="${util.addVer('/js/ezApprovalG/AprGongRamLine_Cross.js')}"></script>
	    ...
	    <script type="text/javascript">
		    ...
		    function SaveAprline_onclick() {
		        ...
		        if (approvalFlag == "G") {
			        ...
			        if (ret == -1) {
			            pAlertContent = "<spring:message code='ezApprovalG.hyj13'/>";
			            OpenAlertUI(pAlertContent);
			            return;
			        }
			        else if (ret == 0) {
			            pAlertContent = "<spring:message code='ezApprovalG.hyj14'/><br> <spring:message code='ezApprovalG.hyj15'/>";
			            OpenAlertUI(pAlertContent);
			            return;
			        }
			        else if (ret == 1) {
			            pAlertContent = "<spring:message code='ezApprovalG.hyj16'/><br>";
			        }
			
			        pAlertContent += "<spring:message code='ezApprovalG.hyj17'/>";
		        }
		    ...
		    function AprlineAdd_onclick() {
		        try {
		            ...
		            if (pSelectedRow.length != "0") {
		            	...
		            	if (approvalFlag == "G") {
		            		pAlertContent = "<spring:message code='ezApprovalG.t1688'/>";
		            	} else {
		            		pAlertContent = "<spring:message code='ezApprovalG.hyj19'/>";
		            	}
	        ...
	        <div class="portlet_tabpart02_top" id="tab1">
	            <p id="showAprLine">
	            	<span divname="Lineinfo" id="1tab1" class="tabover">
				    	...
				    	<c:if test="${approvalFlag == 'S'}">
					    	<spring:message code='ezApprovalG.hyj06'/>
				    	</c:if>
	            	</span>
	            </p>
	        </div>
	                ...
	                <div style="text-align: right; padding:4px 0px 0px 0px">
	                	<a class="imgbtn imgbck">
	                    	<span id="Span5" onclick="return btn_AprDeptTempletSave_onclick('NEW')">
						    	...
						    	<c:if test="${approvalFlag == 'S'}">
							    	<spring:message code='ezApprovalG.hyj07'/>
						    	</c:if>
	                    	</span>
	                    </a>
	                </div>
