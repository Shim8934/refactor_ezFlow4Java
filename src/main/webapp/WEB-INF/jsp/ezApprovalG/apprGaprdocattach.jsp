    ...
    <table>
        <tr>
            <td style="padding-bottom: 5px; width: 250px;">
                <h2><spring:message code='ezApprovalG.t366'/>
                    <select id="selSContName" name="selSContName" onchange="return bt_selSContName_onclick()">
                    </select>
                    <a class="imgbtn"><span id="SearchCondi" onclick="return SearchCondi_onclick()" style="font-weight: normal"><spring:message code='ezApprovalG.t111'/></span></a></h2>
            </td>
        ...
        <tr>
            <td colspan="2" style="vertical-align: top;">
                <div class="listview">
                    <div id="lvSDoc" style="BORDER: 0; WIDTH: 520px; HEIGHT: 490px; overflow: auto"></div>
                </div>
            </td>
            ...
            <td style="width: 175px; vertical-align: top;">
                <div class="listview" style="WIDTH: 280px; HEIGHT: 490px">
                    <div id="lvTDoc" style="BORDER: 0; WIDTH: 280px; HEIGHT: 490px; overflow: auto"></div>
                </div>
            </td>
        </tr>
    </table>
