...
<html>
	<head>
		...
		<script type="text/javascript" src="${util.addVer('/js/composeappt.js')}"></script>
		...
		<script type="text/javascript" ID="clientEventHandlersJS">
		    ...
		    function AddRow(selRow) {
		        ...
		        addXml += "<ROW>";
		        addXml += "<CELL>";
		        addXml += "<VALUE><![CDATA[" + selRow.cells[0].innerText + "]]></VALUE>";
		        addXml += "<DATA1><![CDATA[" + selRow.getAttribute("DATA1") + "]]></DATA1>";
		        addXml += "<DATA2><![CDATA[" + selRow.getAttribute("DATA2") + "]]></DATA2>";
		        addXml += "<DATA3><![CDATA[" + selRow.getAttribute("DATA3") + "]]></DATA3>";
		        addXml += "<DATA4><![CDATA[" + selRow.getAttribute("DATA4") + "]]></DATA4>";
		        addXml += "<DATA5><![CDATA[" + selRow.getAttribute("DATA5") + "]]></DATA5>";
		        addXml += "</CELL>";
		        addXml += "</ROW>";
		        addXml += "</LISTVIEWDATA>";
