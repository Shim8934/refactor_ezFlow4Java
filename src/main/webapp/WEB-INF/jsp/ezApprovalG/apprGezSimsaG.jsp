		    ...
		    function NewItem_onclick_Complete(ret) {
		        if (typeof (ret) != "undefined") {
		            ...
		            if (ret[2] == "2" || ret[2] == "3" || ret[2] == "4") {
		                ...
		                window.open("/ezBoard/boardNewItem.do?boardID=" + pBoardID + "&mode=New&pbrdGbn=SiteNewBoard&pFromScreen=Mail&docID=" + pDocID + "&url=" + pDocHref, '', "top=" + pTop.toString() + ", left=" + pLeft.toString() + ',height=870,width=765,resizable=yes,scrollbars=no');
		            }
		        }
		    }
