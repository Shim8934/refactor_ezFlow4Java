	                ...
	                <table style="width: 100%">
	                    ...
	                    <tr>
	                        <td style="width: 190px">
	                            <div class="listview">
	                                <div id="TaskList" style="HEIGHT: 300px; WIDTH: 200px; overflow: auto;"></div>
	                            </div>
	                        </td>
	                    </tr>
	                </table>
	                ...
	                <table style="width: 200px;">
	                    ...
	                    <tr>
	                        <td>
	                            <div class="listview">
	                            <c:if test="${initFlag == '1'}">
	                                <div id="CabinetList" style="border: 0; HEIGHT: 300px; WIDTH: 257px; overflow: auto;"></div>
	                            </c:if>
	                            <c:if test="${initFlag != '1'}">
	                            	<div id="CabinetList" style="border: 0; HEIGHT: 330px; WIDTH: 257px; overflow: auto;"></div>
	                            </c:if>
	                            </div>
	                        </td>
	                    </tr>
