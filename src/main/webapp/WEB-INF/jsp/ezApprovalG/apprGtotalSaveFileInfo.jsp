	...
	<head>
	    ...
	    <script type="text/javascript">	
	        ...
	        function CheckBoxClick(obj)
	        {
	            ...
	            if (obj.checked) {
	                obj.parentElement.parentElement.style.backgroundColor = "#e4e8ec";
	        ...
	        function HeaderCheckBoxClick(obj) {
	            ...
	            if (obj.checked) {
	                for (var i = 0; i < count ; i++) {
	                    ...
	                    if (CrossYN())
	                        GetChildNodes(document.getElementById('table_filelist'))[i].style.backgroundColor = "#e4e8ec";
	                    else {
	                        GetChildNodes(GetChildNodes(document.getElementById('table_filelist'))[i + 1])[0].style.backgroundColor = "#e4e8ec";
	                        GetChildNodes(GetChildNodes(document.getElementById('table_filelist'))[i + 1])[1].style.backgroundColor = "#e4e8ec";
	                    }
