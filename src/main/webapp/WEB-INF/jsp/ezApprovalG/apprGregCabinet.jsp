				...
				<td valign="top" style="padding:3px;width: 274px;"><h2 class="h2_dot" style="font-weight: normal;"><spring:message code='ezApprovalG.t1018'/></h2>
					<table class="content">
						...
						<tr>
							...
							<td>
								<Select id="selRecTypeCode" style="width:100%"></Select>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<Select id="selKeepPeriod" style="width:100"></Select>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<input type="text" name="txtOwner" id="txtOwner" disabled style="Width:100%; ">
							</td>
						</tr>
						<tr>
