...
//          document.getElementByNames("txtKeyword").style.disabled = true;
    ...
    function AddRow(selRow) {
        ...
        addXml += "<ROW>";
        addXml += "<CELL>";
        addXml += "<VALUE><![CDATA[" + selRow.childNodes[0].innerText + "]]></VALUE>";
        addXml += "<DATA1><![CDATA[" + selRow.getAttribute("DATA1") + "]]></DATA1>";
        addXml += "<DATA2><![CDATA[" + selRow.getAttribute("DATA2") + "]]></DATA2>";
        addXml += "<DATA3><![CDATA[" + selRow.getAttribute("DATA9") + "]]></DATA3>";
        addXml += "<DATA4><![CDATA[" + selRow.getAttribute("DATA10") + "]]></DATA4>";
        addXml += "<DATA5><![CDATA[" + selRow.getAttribute("DATA11") + "]]></DATA5>";
        addXml += "<DATA6><![CDATA[" + selRow.getAttribute("DATA12") + "]]></DATA6>";
        addXml += "<DATA7><![CDATA[" + selRow.getAttribute("DATA7") + "]]></DATA7>";
        addXml += "<DATA8><![CDATA[" + selRow.getAttribute("DATA8") + "]]></DATA8>";
        addXml += "</CELL>";
        addXml += "<CELL>";
        addXml += "<VALUE><![CDATA[" + selRow.childNodes[2].innerText + "]]></VALUE>";
        addXml += "</CELL>";
        addXml += "<CELL>";
        addXml += "<VALUE><![CDATA[" + selRow.childNodes[1].innerText + "]]></VALUE>";
        addXml += "</CELL>";
        addXml += "</ROW>";
        addXml += "</LISTVIEWDATA>";
...
<table class="content">
	...
	<th><spring:message code='ezApprovalG.t1163'/></th>
		<td><div class='custom_radio'><Input Type="radio" name="rdoRecRole" id="rdoRecRole1" value="0" style="margin:3px 0px 5px 3px" onClick="return SwapRoleList()"><label for="rdoRecRole1"><spring:message code='ezApprovalG.t1164'/><span id="roleCheck1"></span></label><br />
			<Input Type="radio" name="rdoRecRole" id="rdoRecRole2" value="1" style="margin:3px 0px 5px 3px" onClick="return SwapRoleList()" checked><label for="rdoRecRole2"><spring:message code='ezApprovalG.t1165'/><span id="roleCheck2"></span></label>
			</div>
		</td>
	</tr>
</table>
