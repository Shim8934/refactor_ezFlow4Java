...
<head>
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
   	<link rel="stylesheet" href="/css/ezEKP/common/email_tree.css" type="text/css">
    <link rel="stylesheet" href="/css/ezEKP/common/default_kr.css" type="text/css">
    <script type="text/javascript" src="/js/ezEKP/common/TreeView.js"></script>
    <script type="text/javascript" src="/js/ezEKP/common/mouseeffect.js"></script>
    <script type="text/javascript" src="/js/ezEKP/common/XmlHttpRequest.js"></script>
<title></title>
<script type="text/javascript" language="javascript">
    ...
    function favoriteList() {
        window.parent.frames["right"].location.href = "/kaoni/test/web/boardItemList_Favorite.do?MODE=USE";
    }
