		...
		<script type="text/javascript">
		    ...
		    window.onload = function () {
		        try {
		            ...
		            try {
		                ReturnFunction = opener.share_cross_dialogArguments[1];
		            } catch (e) { }
		        }
...
<!-- 		      </HEADER> -->
		...
		<table>
			<tr style="height:33px; background-color: #f8f8fa; margin-bottom : 3px; padding: 0px; border: 1px solid #eaeaea;">
		  	...
		  	<tr>
			    <td style="padding-right:4px"><div class="box" style="overflow-x: hidden; overflow-y: auto; WIDTH:235px; HEIGHT:380px; margin-bottom:-1px;" id="TreeView" ></div></td>
			    <td class="listview">
			        <div id="OrganListView" style="border:0;OVERFLOW: auto; WIDTH: 450px; HEIGHT: 380px; BACKGROUND-COLOR: white"></div>
				</td>
		  	</tr>
		</table>
