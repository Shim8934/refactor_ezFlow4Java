...
<html>
	<head>
		<title><spring:message code='ezSystem.ls07'/></title>
		...
		<script type="text/javascript">
			...
			window.onload = function(){
				document.getElementById("searchKeycodeForRoll").value = 'All';
				companyID = document.getElementById("ListCompany").value;
				getTime();
				getAccessHist(1, searchStartTime, searchEndTime);
				makePageSelPage();
			}
			...
			function goToPage(page) {
				getAccessHist(page, searchStartTime, searchEndTime);
			}

			function getAccessHist(pageNum, searchStartTime, searchEndTime) {
				...
				if (pageNum == "-1") {
					...
					var pURL = "/admin/ezSystem/systemAdminAccessHistList.do";
							...
							success : function(res) {
								...
								if (res.itemCnt < 1) {
									...
									if (res.lang == "primary") {
										...
										res.adminAccessHist.forEach(function(i, v) {
											if (i.admintype.indexOf("c=1") > -1 && i.admintype.indexOf("k=1") > -1) {
												var type = '<spring:message code="ezSystem.ls10"/>';
											} else if (i.admintype.indexOf("c=1") > -1) {
												var type = '<spring:message code="ezOrgan.t291"/>';
											} else {
												var type = '<spring:message code="ezOrgan.t293"/>'; 
											}
											html += "<tr>";
											html += "   <td>"	+ j 									+ "</td>";
											...
											html += "	<td>"	+ i.accessip + " ( " + i.countryName	+ " ) " + "</td>";
											html += "	<td>"	+ i.accesstime							+ "</td>";
											html += "	<td>"	+ i.accessbrowser						+ "</td>";
											html += "	<td>"	+ i.accessos							+ "</td>";
											html += "	<td>"	+ type 									+ "</td>";
											html += "</tr>";
											j++;
										});
								...
								$('#accessHistListBody').empty().append(html);
			...
			function excelExport() {
				var pageNum = "-1";
				getAccessHist(pageNum, searchStartTime, searchEndTime);
			}
				...
				<td width="93%" style="margin-bottom: 10px; padding: 5px 5px;">
					...
					<span id="topmenu" style="display:block; margin-top:3px; padding-left:4px;">
						...
						<select id="searchKeycodeForRoll"> 
							...
							<option value="c=1"><spring:message code="ezOrgan.t291"></spring:message></option>
							<option value="k=1"><spring:message code="ezOrgan.t293"></spring:message></option>
						</select>	&nbsp;
			...
			<table class="mainlist" style="width:100%;">
				<thead style="">
					<tr>
						...
						<th><spring:message code="ezSystem.ls09"></spring:message></th>
						<th><spring:message code="ezSystem.x0026"></spring:message></th>
						<th><spring:message code="ezSystem.x0027"></spring:message></th>
						<th><spring:message code="ezSystem.ls08"></spring:message></th>
					</tr>
				</thead>
				<tbody id="accessHistListBody" style="overflow: auto;"></tbody> 
			</table>
		</div>
