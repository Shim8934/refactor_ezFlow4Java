...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			window.onload = function(){
				...
				getTime();
				getUserChangeHist(1, searchStartTime, searchEndTime);
				makePageSelPage();
			}
			...
			function goToPage(page) {
				getUserChangeHist(page, searchStartTime, searchEndTime);
			}

			function getUserChangeHist(pageNum, searchStartTime, searchEndTime) {
				...
				if (pageNum == "-1") {
					...
					var pURL = "/admin/ezSystem/userChageHistExcelExport.do" + "?" + params;
					saveExcel.location.href = pURL;
				} else {
					var pURL = "/admin/ezSystem/userChangeHistList.do"; 
							...
							success : function(res) {
								...
								if (res.itemCnt < 1) {
									...
									if (res.lang == "primary") {
										...
										res.userChangeHistList.forEach(function(i, v) {
											...
											if (i.executorId == 'ez_sync') {
												...
												html += i.executorNm + "(" + i.executorId		+ ")" + "</td>";							
										...
										res.userChangeHistList.forEach(function(i, v) {
											...
											if (i.executorId == 'ez_sync') {
												...
												html += i.executorNm2 + "(" + i.executorId		+ ")" + "</td>";							
												html += "	<td>"	+ i.executorIp + " ( " + i.countryName	+ " ) " + "</td>";
											} 
											html += "</tr>";
											j++;
								...
								$('#userChangeHistListBody').empty().append(html);
			...
			function excelExport() {
				var pageNum = "-1";
				getUserChangeHist(pageNum, searchStartTime, searchEndTime);
			}
	...
	<body class="mainbody">
		<h1><spring:message code="ezSystem.jhy01"></spring:message><span id="listInfo"></span></h1>
					...
					<span id="topmenu" style="width: 500px">
						...
						<select id="searchKeycodeForType"> 
							<option value=""><spring:message code="ezEmail.t588"></spring:message></option>			
								...
								<option value="clearAddJob"><spring:message code="ezSystem.jhy08"></spring:message></option>
						</select>	&nbsp;
						...
						<select id="searchKeycode"> 
							...
							<option value="2"><spring:message code="ezOrgan.t218"></spring:message></option>
							<option value="3"><spring:message code="ezSystem.x0023"></spring:message></option>
			...
			<table class="mainlist" style="width:100%;">
				<thead style="">
					<tr>
						...
						<th><spring:message code="ezApprovalG.chaebun07"></spring:message></th>
						<th><spring:message code="ezSystem.jhy02"></spring:message></th>
						<th><spring:message code="ezOrgan.ls04"></spring:message></th>
						<th><spring:message code="ezOrgan.ls05"></spring:message></th>
					</tr>
				</thead>
				<tbody id="userChangeHistListBody" style="overflow: auto;"></tbody> 
			</table>
		</div>
