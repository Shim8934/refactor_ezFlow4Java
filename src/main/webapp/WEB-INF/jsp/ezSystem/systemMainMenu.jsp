...
<h1><spring:message code='main.kms1'/></h1>
    <table class="content">
        <tbody>
            ...
            <tr><th><spring:message code="ezSystem.x0038"/></th><td><input id="MaxAllowedCountOfLoginFail" maxlength="4" type="text" value="${configMap.MaxAllowedCountOfLoginFail}"> (<spring:message code="ezSystem.x0014"/>)</td></tr>            
            ...
            <tr><th><spring:message code="ezSystem.pjg01"/></th><td><select id="useEditApprDoc"><option <c:if test="${configMap.useEditApprDoc == 'YES'}">selected="selected"</c:if> value="YES"><spring:message code="ezQuestion.t103"/></option><option <c:if test="${configMap.useEditApprDoc == 'NO'}">selected="selected"</c:if> value="NO"><spring:message code="ezQuestion.t104"/></option></select></td></tr>
        </tbody>
    </table> 
