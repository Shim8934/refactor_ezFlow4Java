	...
	<body class="mainbody">
	    ...
	    <table class="content">
	        <tbody>
	            ...
	            <tr><th><spring:message code="ezEmail.hdp01"/></th><td><input id="MailBigSizeAttachLimitCount" maxlength="2" type="text" value="<c:out value='${configMap.MailBigSizeAttachLimitCount}'/>"> (<spring:message code="ezSystem.x0014"/>, <spring:message code="ezEmail.hdp07"/>)</td></tr>
