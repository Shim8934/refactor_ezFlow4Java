...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			window.onload = function(){
				...
				getTime();
				getConnectorHist(1, searchStartTime, searchEndTime);
				makePageSelPage();
			}
			...
			function goToPage(page) {
				getConnectorHist(page, searchStartTime, searchEndTime);
			}

			function getConnectorHist(pageNum, searchStartTime, searchEndTime) {
				...
				if (pageNum == "-1") {
					...
					var pURL = "/admin/ezSystem/systemConnHistExcelExport.do" + "?" + params;
					saveExcel.location.href = pURL;
				} else {
					var pURL = "/admin/ezSystem/systemConnectorList.do";
					...
					$.ajax({
							...
							success : function(res) {
								...
								if (res.itemCnt < 1) {
									html += "<tr><td colspan=\"4\" style=\"text-align:center;\">" + strLang155 + "</td></tr>";
								} else {
								...
								$('#connectorHistListBody').empty().append(html);
			...
			function excelExport() {
				var pageNum = "-1";
				getConnectorHist(pageNum, searchStartTime, searchEndTime);
			}
	...
	<body class="mainbody">
		<h1><spring:message code="ezSystem.jhy17"></spring:message><span id="listInfo"></span></h1>
		<%-- <div id=""> <!-- mainmenu -->
				...
				<td width="93%" style="margin-bottom: 10px; padding: 5px 5px;">
					...
					<span id="topmenu" style="width: 500px">
						...
						<select id="searchKeycode"> 
							...
							<option value="3"><spring:message code="ezOrgan.t218"></spring:message></option>
						</select>
		...
		<div id="contentlist" style="width:100%; overflow: auto;">	
			<table class="mainlist" style="width:100%;">
				...
				<tbody id="connectorHistListBody" style="overflow: auto;"></tbody> 
			</table>
		</div>
