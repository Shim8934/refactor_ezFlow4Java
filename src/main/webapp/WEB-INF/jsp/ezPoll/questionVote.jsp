	...
	<head>
		...
		<script type="text/javascript">	
		    ...
		    function displayVotedUser(pQstID, pOptId) {		    		    
		    	...
		    	window_open3 = window.open("/ezPoll/showVotedUsersInfo.do?qstId=" + pQstID + "&optId=" + pOptId, "", "height=455px,width=390px, status = no, toolbar=no, menubar=no,location=no, resizable=1" + feature);
		    }
