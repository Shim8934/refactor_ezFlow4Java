	...
	<head>
		...
		<script type="text/javascript">
		    ...
		    function sendMailAll(pQstID) {
		        ...
		        var pTop = (pheight - conHeight) / 2;
		        var pLeft = (pwidth - 1200) / 2;
		        window.open("/ezEmail/mailWrite.do?cmd=POLL&type=group&state=notjoin&qstId=" + pQstID, "", "top=" + pTop.toString() + ", left=" + pLeft.toString() + ", height = " + conHeight + "px, width = 1200px, status = no, toolbar=no, menubar=no,location=no,resizable=1" + feature);
		    }
		</script>
	</head>
