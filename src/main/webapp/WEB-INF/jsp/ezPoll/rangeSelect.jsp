	...
	<head>
		...
		<script type="text/javascript">
    		...
    		function check_length(chkstr, maxlength, fieldname) {
        		...
        		if (length > maxlength) {
            		alert(fieldname + "<spring:message code='ezPoll.t211' />" + maxlength + "<spring:message code='ezPoll.t212' />");
            		return false
        		}
        		return true;
    		}
    	...
    	function cnsearch_click() {
        	if (cnkeyword.value == "") {
            	alert("<spring:message code='ezPoll.t215' />");
            	cnkeyword.focus();
            	return;
        	}
        	var count;
        	...
        	if (adCount == 0) {
	            alert("<spring:message code='ezPoll.t216' />");
    	        return;
	        } else if (adCount == 1) {
        	    bSearch = true;
    	...
    	function HandleStateChange() {
    	    ...
    	    if (getXmlString(xmlHttp.responseXML) != "") {
            	...
            	if (SelectSingleNodeValueNew(xmlRtn, "RESULT/DATA") != "-1") {
                	...
                	alert("<spring:message code='ezPoll.t218' />");
                	return false;
            	}
        	} else {
            	alert("<spring:message code='ezPoll.t218' />");
	...
	<body class="popup"> 
		<xml id="listviewheader" style="display:none">
    		<LISTVIEWDATA>
        		<HEADERS>
            		<HEADER>
                		<NAME><spring:message code='ezPoll.t219' /></NAME>
                		<WIDTH>50</WIDTH>
            		</HEADER>
            		<HEADER>
                		<NAME><spring:message code='ezPoll.t220' /></NAME>
                		<WIDTH>50</WIDTH>
            		</HEADER>
        		</HEADERS>
    		</LISTVIEWDATA>
		...
		<xml id="listviewheader2" style="display:none">
  		<LISTVIEWDATA>
    		<HEADERS>
      		...
      		<HEADER>
        		<NAME><spring:message code='ezPoll.t221' /></NAME>
        		<WIDTH>60</WIDTH>
      		</HEADER>
    		</HEADERS>
  		</LISTVIEWDATA>
		...
		<table> 
			...
			<tr>
        		<td>
            		<input id="cnkeyword" onkeypress="cnsearch_press(event)" />
