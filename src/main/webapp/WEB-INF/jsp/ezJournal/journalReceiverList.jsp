					...
					<div class="pagenavi">   
						<c:choose>
								<c:when test="${paging.currentPage gt 1}">   
									<span onclick="parent.journalReceiverList(1)" class="btnimg first"></span>            
								</c:when>
								<c:otherwise>
						...
						<c:choose>
							<c:when test="${paging.startPage gt 1}">
								<span onclick="parent.journalReceiverList(${paging.startPage-1})" class="btnimg prev"></span>
							</c:when>
							<c:otherwise>
						...
						<c:choose>
							<c:when test="${paging.totalPage gt paging.endPage }">
								<span class="btnimg next" onclick="parent.journalReceiverList(${paging.endpage+1})"></span>
							</c:when>
							<c:otherwise>
						...
						<c:choose>
							<c:when test="${paging.totalPage gt paging.currentPage }">
								<span class="btnimg last" onclick="parent.journalReceiverList(${paging.totalPage})"></span>
							</c:when>
							<c:otherwise>
