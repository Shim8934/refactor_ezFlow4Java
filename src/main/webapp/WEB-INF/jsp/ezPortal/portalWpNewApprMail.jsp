		            ...
		            xmldom = xml;
		                ...
		                if (xmldom.getElementsByTagName("CELL").length > 0) {
		                    ...
		                    for (var i = 0; i < xmldom.getElementsByTagName("CELL").length; i++) {
		                        ...
		                        if (URGENTAPPROVAL == 'Y') {
		                        	listHTML += "<li onclick=\"opendocview('" + DOCID + "','" + HREF + "','" + APRMEMBERID + "','" + APRMEMBERNAME + "','" + APRMEMBERDEPTID + "','" + DOCSTATE + "','" + FUNCTIONTYPE + "','" + orgCompanyID + "')\"><span class='txt' style='color:red'>" + DOCTITLE + "</span> <span class='date' style='color:red'>" + STARTDATE.substring(0, STARTDATE.length - 3) + "</span> <span class='name' style='color:red'>" + WRITERNAME + "</span></li>";
		                        } else {
			                        listHTML += "<li onclick=\"opendocview('" + DOCID + "','" + HREF + "','" + APRMEMBERID + "','" + APRMEMBERNAME + "','" + APRMEMBERDEPTID + "','" + DOCSTATE + "','" + FUNCTIONTYPE + "','" + orgCompanyID + "')\"><span class='txt'>" + DOCTITLE + "</span> <span class='date'>" + STARTDATE.substring(0, STARTDATE.length - 3) + "</span> <span class='name'>" + WRITERNAME + "</span></li>";
		                        }
		                     }                                 
