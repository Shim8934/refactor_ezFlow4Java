		...
		<script type="text/javascript">
	        ...
	        function ItemReadNewBoard_onclick(obj) {
	            ...
	            if (obj.getAttribute("DATA10") == "3" || obj.getAttribute("DATA10") == "4") {
	            	pLeft = (pwidth - 790) / 2;
	                window.open("/ezBoard/boardItemViewPhoto.do?showAdjacent=&itemID=" + encodeURIComponent(obj.getAttribute("DATA2")) + "&boardID=" + encodeURIComponent(obj.getAttribute("DATA1")), "", "toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=0,resizable=1,height=770,width=790,top=" + pTop + ",left=" + pLeft, "");
	            } else if (obj.getAttribute("DATA10") == "7") {
					window.open("/ezBoard/boardItemViewMovie.do?showAdjacent=&itemID=" + encodeURIComponent(obj.getAttribute("DATA2")) + "&boardID=" + encodeURIComponent(obj.getAttribute("DATA1")), "",  "toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=0,resizable=1,height=679,width=765,top=" + pTop + ",left=" + pLeft, "");
	            }
	            else {
	            	pLeft = (pwidth - 790) / 2;
					window.open("/ezBoard/boardItemViewPhoto.do?showAdjacent=&itemID=" + encodeURIComponent(obj.getAttribute("DATA2")) + "&boardID=" + encodeURIComponent(obj.getAttribute("DATA1")), "", "toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=0,resizable=1,height=720,width=790,top=" + pTop + ",left=" + pLeft, "");
	            }
	            getNewBoardList();
	        }
