		    ...
		    function getTabList() {
		        ...
		        function openDoc_section4_Type(pItemID, pType, oBoardID) {
		            ...
		            if (pType == "3" || pType == "4") {
		                ...
		                window.open("/ezBoard/boardItemViewPhoto.do?showAdjacent=&itemID=" + pItemID + "&boardID=" + oBoardID, "", "toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=1,height=" + height + ",width=790,top=" + pTop + ",left=" + pLeft, "");
		            } else if (pType == "7") {
	            		pTop = (pheight - 679) / 2;
						pLeft = (pwidth - 764) / 2;
		        ...
		        function openDoc(pItemID) {
		            ...
		            if (pBoardType_NewBoardSTD == "3" || pBoardType_NewBoardSTD == "4") {
		                ...
		                window.open("/ezBoard/boardItemViewPhoto.do?showAdjacent=&itemID=" + pItemID + "&boardID=" + pBoardID_NewBoardSTD, "", "toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=1,height=770,width=790,top=" + pTop + ",left=" + pLeft, "");
