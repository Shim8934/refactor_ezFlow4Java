...
<html>
	<head>
		...
		<style>
			...
			.individual-memo { width:200px; height:200px; background:white; text-align:center; border:1px solid black; cursor: pointer; float: left; margin: 10px;}
		...
		<script type="text/javascript">
		    ...
		    function save() {
		    	...
		    	$("#memoList").prepend("<div class='individual-memo'><img src='/images/close_xBtn.png'  style='display: none; float:right;'><div class='memo-text'>" + text + "</div></div>");
		    	$("#textarea").val('');
		    	$("#maskDiv").css("display", "none");
		    	$("#selected-memo").css("display", "none");
