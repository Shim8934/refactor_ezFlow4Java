		...
		<script type="text/javascript">
			...
			function openDoc(pItemID) {
				...
				if (boardType == "3" || boardType == "4") {
	                ...
	                window.open("/ezBoard/boardItemViewMovie.do?showAdjacent=&itemID=" + encodeURIComponent(pItemID) + "&boardID=" + encodeURIComponent(pBoardID_NewBoard), "", "toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=1,height=679,width=764,top=" + pTop + ",left=" + pLeft, "");
            	}
				else {
	                if (CrossYN())
