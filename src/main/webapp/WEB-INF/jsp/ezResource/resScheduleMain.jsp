...
// 	        }
	...
	<body class="mainbody" style="overflow: auto; margin-bottom:0px;padding-right: 6px; ovverflow-x: scroll; min-width: 850px;" id="BodyTop">
		...
		<div class="calendar_pagenav" style='left: max(50%, 400px);'>
