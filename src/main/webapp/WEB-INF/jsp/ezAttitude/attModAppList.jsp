...
//     			$(Radio1).prop("checked", true);
				...
				if ($("#appr_search").val() == "" && $("#usepostdate").prop("checked") == false ) {
	...
	<body id="theBody" class="mainbody" onkeydown="event_listOnkeyDown(event);" onkeyup="event_listOnkeyUp(event);">
        ...
        <ul id="tb_Parent">
			...
			<li id="right" style="margin-right:5px">
				<span style="float:right;font-weight:normal;color:black;border: none;box-shadow:none;">
					<div class="custom_radio"><input name="searchCheck" id="Radio1" type="radio" value="all" checked style="margin:0px;padding:0px;width:13px;height:13px;vertical-align:middle;" onchange="type_change()"/><label for="Radio1">&nbsp;<spring:message code='ezAttitude.t124'/></label></div>
					<div class="custom_radio"><input name="searchCheck" id="Radio2" type="radio" value="0" style="margin:0px;padding:0px;width:13px;height:13px;vertical-align:middle;" onchange="type_change()"/><label for="Radio2">&nbsp;<spring:message code='ezAttitude.t209'/></label></div>
            ...
            <div class="popupJQLayer">
				...
				<table style="display: block; margin: 10px 0px 0px 1px;" class="popuplist">
					...
					<tr>
						...
						<td>
							<div class="custom_checkbox"><input type="checkbox" value="1" id="usepostdate" onclick="DateSearch_Click()" style="vertical-align:middle;">
							<label for="usepostdate"><spring:message code='ezAttitude.t105' /></label>&nbsp;</div>
		...
		<table class="mainlist" style="width:100%;" id="AttList" listpageCount="${mailGeneral.listCount}" curPage="1">
			<tr>
				...
				<th width="40px" colname="NO">NO.</th>
				<th style="overflow: hidden;white-space: nowrap;text-overflow: ellipsis;cursor:pointer; width:10%;" colname="START_DATE"><spring:message code='ezAttitude.t107'/></th>
				<th style="overflow: hidden;white-space: nowrap;text-overflow: ellipsis;cursor:pointer; width:13%;" colname="ORIGIN_TIME"><spring:message code='ezAttitude.t206'/></th>
				<th style="overflow: hidden;white-space: nowrap;text-overflow: ellipsis;cursor:pointer; width:13%;" colname="NO"><spring:message code='ezAttitude.t207'/></th>
				<th style="overflow: hidden;white-space: nowrap;text-overflow: ellipsis;cursor:pointer; width:13%;" colname="APPR_STATUS" ><spring:message code='ezAttitude.kje01'/></th>
				<th style="overflow: hidden;white-space: nowrap;text-overflow: ellipsis;cursor:pointer; width:13%;" colname="APPR_USER_NAME"><spring:message code='ezAttitude.t104'/></th>
				<th style="overflow: hidden;white-space: nowrap;text-overflow: ellipsis;cursor:pointer; width:13%;" colname="APPL_DATE"><spring:message code='ezAttitude.t108'/></th>
				<th width="100px" style="cursor:pointer;" colname="NO"><spring:message code='ezAttitude.t97'/></th>
			</tr>
		    
		    <c:if test="${list.size() == 0}"> 
		        <tr>
					<td colspan="9" align="center"  bgcolor="#FFFFFF"><spring:message code='ezAttitude.t96'/></td>
	       		</tr>
	        </c:if>
		</table>
		</div>
