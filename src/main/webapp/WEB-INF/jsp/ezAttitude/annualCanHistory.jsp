	...
	<head>
		...
		<script type="text/javascript">
			...
			function history() {				
	 			$.ajax({
					type : 'get',
					url : '/ezAttitude/getAnnCanHistory.do',
				    data : {
				    	attModId : attModId,
				    	companyId : companyId
				    },
					...
					success : function(json){
				    	...
				    	for(var i = 0; i < json.length; i++) {
							if (json.length == 1 && json[i].apprStatus == 0) {
				    			...
				    			//"\u00a0"
					    		var objTr = $("<tr></tr>").append($("<td style='width:46%'></td>").append($("<div style='text-align:center; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;'></div>").text(json[i].originDate.substring(0,11) + " ~ " + json[i].changeDate.substring(0,11))));
