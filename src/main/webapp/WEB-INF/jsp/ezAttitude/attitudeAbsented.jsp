...
// 	    		getAttitudeAbsentedList();
			...
			function sendMail() {
				...
				var szUrl = "/ezEmail/mailWrite.do?cmd=attitudeAbsented&companyId=" + pCompanyId + "&userName=" + searchUserName + "&deptName=&title=" + searchTitle + "&deptId=" + pDeptId + "&startDate=" + searchStartDate + "&endDate=" + searchEndDate + "&pageNum=&listSize=&orderCell=&orderOption=";
