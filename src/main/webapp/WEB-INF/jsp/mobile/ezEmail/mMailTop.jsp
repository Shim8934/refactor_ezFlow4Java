				...
				<li style="border-bottom:1px solid #f2f2f2;">					
					...
					<div style="margin-left:16px;float:left;padding-top:12px;height:32px">
						<c:if test="${type != 'mailRead'}">
							...
							<i class="fa fa-arrows" aria-hidden="true" style= "position:absolute; right:10px; cursor:pointer;"></i>
						</c:if>
						<c:if test="${type == 'mailRead'}">
	    	...
	    	<div>	    	
		        ...
		        <ul data-role="listview" style="margin-top:30px">
	                ...
	                <c:forEach items="${folderList}" var="folder">
				       <li data-icon="carat-r"><a href="javascript:getMail('${folder.fullName}');"><i class="fa fa-envelope-o" style="font-size:15px"></i>&nbsp;&nbsp;${folder.name}</a></li>
<!-- 				       <tr> -->
