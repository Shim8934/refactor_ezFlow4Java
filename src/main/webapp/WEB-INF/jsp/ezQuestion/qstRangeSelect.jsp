...
<html>
	<head>
		...
		<script type="text/javascript" src="${util.addVer('/js/ezQuestion/TreeView.js')}"></script>
		...
		<script type="text/javascript">
    		...
    		function add_member() {
        		...
        		for (count1 = 0; count1 < length; count1++) {
            		...
            		pparsingXML = "";
            		pparsingXML2 = "<LISTVIEWDATA><ROWS>";
            		pparsingXML = pparsingXML + "<ROW><CELL><DATA2>" + MakeXMLString(selRow.getAttribute("DATA2")) + "</DATA2>";
            		pparsingXML = pparsingXML + "<DATA4>" + MakeXMLString(selRow.getAttribute("DATA4")) + "</DATA4>";
            		pparsingXML = pparsingXML + "<DATA5>" + MakeXMLString(selRow.getAttribute("DATA5")) + "</DATA5>";
            		pparsingXML = pparsingXML + "<VALUE>" + MakeXMLString(selRow.cells[0].innerText) + "</VALUE></CELL></ROW>";
            		pparsingXML2 = pparsingXML2 + pparsingXML + "</ROWS></LISTVIEWDATA>";
            		Resultxml = loadXMLString(pparsingXML2);
