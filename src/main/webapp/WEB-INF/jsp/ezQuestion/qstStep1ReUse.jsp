	...
	<script type="text/javascript">
		...
		function Datepicker_DateInit() {
			if (document.getElementById("hidStartDate").value != "") {
		        idDatepicker.startFullYear(parseInt(document.getElementById("hidStartDate").value.substring(0, 4)));
		        idDatepicker.startMonth(parseInt(document.getElementById("hidStartDate").value.substring(5, 7)) - 1);
		        idDatepicker.startDate(parseInt(document.getElementById("hidStartDate").value.substring(8, 10)));
		        idDatepicker.endFullYear(parseInt(document.getElementById("hidEndDate").value.substring(0, 4)));
		        idDatepicker.endMonth(parseInt(document.getElementById("hidEndDate").value.substring(5, 7)) - 1);
		        idDatepicker.endDate(parseInt(document.getElementById("hidEndDate").value.substring(8, 10)));
		    }
		}
            ...
            <tr> <!-------------각종 설문 옵션 -----------------> 
                ...
                <td style="border-right:medium none; white-space:nowrap">
                    ...
                    <div style="display:none">
                        ...
                        <input type="text" name="hidAnonymity" id="hidanonymity" value="${qstUserPermissionVO.publicFlg}" style="display:none"> 
...
>>>>>>> branch 'master' of jmocha@10.0.102.8:git/ezFlow4Java.git
</html>