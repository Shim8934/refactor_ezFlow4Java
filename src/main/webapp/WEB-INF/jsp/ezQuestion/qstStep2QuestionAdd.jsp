    ...
    function fun_QuesSave() 
    {
        ...
        if(Ques_Answer.selType[0].checked){
            if (viewcnt > 0)
            {
                ...
                createNodeAndAppandNodeText(xmlDoc, DeptNode, objNode, "TITLE", "");
            }
        }
        else{
            ...
            for(var i =1; i<table.childNodes.length;i++){
                DeptNode = createNodeAndAppandNode(xmlDoc, RootNode, objNode, "ANSWER");
                createNodeAndAppandNodeText(xmlDoc, DeptNode, objNode, "TITLE", table.childNodes[i].childNodes[0].getElementsByTagName("input")[0].value); // i+1
                DeptNode = null;
            }
