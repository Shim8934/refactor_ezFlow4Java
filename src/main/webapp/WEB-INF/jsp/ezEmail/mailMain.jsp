		    ...
		    <frameset cols="220,*" frameborder="0" border="0">
	            ...
	            <c:choose>
	            	<c:when test="${funCode eq '2'}">
			    		<frame src="/ezEmail/mailLeft.do?funCode=2" name="left" marginwidth="0" marginheight="0" scrolling="auto" frameborder="0" noresize>
			        	<frame name="right" marginwidth="0" marginheight="0" scrolling="auto" frameborder="0">
	            	</c:when>
	            	<c:otherwise>
			    		<frame src="/ezEmail/mailLeft.do?funCode=1" name="left" marginwidth="0" marginheight="0" scrolling="auto" frameborder="0" noresize>
