...
<body style="overflow: hidden;" class="popup">
			...
			<td colspan="2" align="center">
				<div class="lmtitle lmLetterBoxTitle">
					<input type="text" name="" id="lmSearchInput" class="searchInput"
						placeholder="검색어를 입력해주세요"> <a id="lmSearch" class="imgbtn"
						onclick="letterSearch()"><span>편지지 검색</span></a> <a
						id="lmSearchReset" class="imgbtn" onclick="inputReset()"><span>초기화</span></a>
				</div>
			</td>
		</tr>
		<tr>
			<td style="width: 50%; vertical-align: top;">
				<div id="divTree"
					style="height: 350px; width: 273px; overflow: auto;"></div>
			</td>
			<td style="width: 50%; vertical-align: top;">
				<div class="lmtitle lmLetterTitle">편지지 목록</div>
				<div class="lmLetterList boxNo" data-boxNo=""
					style="height: 320px; width: 273px; overflow: auto;">
	...
	<div class="btnposition btnpositionNew">
		...
		<a class="imgbtn" onclick="letterSelect()"><span>선택</span></a> <a
			class="imgbtn" onclick="cancel()"><span>닫기</span></a>
	</div>
