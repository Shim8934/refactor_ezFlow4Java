	...
	<head>
	    ...
	    function Rebody() {
	    	if (gg_cmd == "RESEND" && document.getElementById("bodyValue").innerHTML != "") { //재전송 시
	            ...
	            switch (mailsel) {
	                case "0": message.SetEditorContent("<P " + defaultFontAndSize + "><BR></P><DIV id='MailSign'></DIV>" + bodyInnerHTML);
	                    break;
	                case "1": message.SetEditorContent("<P " + defaultFontAndSize + "><BR></P><DIV id='MailSign'>" + document.getElementById("xmpMailSign1").innerHTML + "</DIV>" + bodyInnerHTML);
	                    tempvalue = "1";
	                    break;
	                case "2": message.SetEditorContent("<P " + defaultFontAndSize + "><BR></P><DIV id='MailSign'>" + document.getElementById("xmpMailSign2").innerHTML + "</DIV>" + bodyInnerHTML);
	                    tempvalue = "1";
	                    break;
	                case "3": message.SetEditorContent("<P " + defaultFontAndSize + "><BR></P><DIV id='MailSign'>" + document.getElementById("xmpMailSign3").innerHTML + "</DIV>" + bodyInnerHTML);
	                    tempvalue = "1";
	                    break;
	            }
	        }
	            ...
	            if (indexSignValue == -1) {
	            	switch (mailsel) {
			            case "0": message.SetEditorContent(document.getElementById("tempbody").innerHTML + "<P " + defaultFontAndSize + "><BR></P><DIV id='MailSign'></DIV>");
			                break;
			            case "1": message.SetEditorContent(document.getElementById("tempbody").innerHTML + "<P " + defaultFontAndSize + "><BR></P><DIV id='MailSign'>" + document.getElementById("xmpMailSign1").innerHTML + "</DIV>");
			                tempvalue = "1";
			                break;
			            case "2": message.SetEditorContent(document.getElementById("tempbody").innerHTML + "<P " + defaultFontAndSize + "><BR></P><DIV id='MailSign'>" + document.getElementById("xmpMailSign2").innerHTML + "</DIV>");
			                tempvalue = "1";
			                break;
			            case "3": message.SetEditorContent(document.getElementById("tempbody").innerHTML + "<P " + defaultFontAndSize + "><BR></P><DIV id='MailSign'>" + document.getElementById("xmpMailSign3").innerHTML + "</DIV>");
			                tempvalue = "1";
			                break;
		            }
	            } else {
	            ...
	            switch (mailsel) {
	                case "0": message.SetEditorContent("<P " + defaultFontAndSize + "><BR></P><DIV id='MailSign'></DIV>");
	                    break;
	                case "1": message.SetEditorContent("<P " + defaultFontAndSize + "><BR></P><DIV id='MailSign'>" + document.getElementById("xmpMailSign1").innerHTML + "</DIV>" + document.getElementById("bodyValue").innerHTML);
	                	tempvalue = "1";
		                break;
		            case "2": message.SetEditorContent("<P " + defaultFontAndSize + "><BR></P><DIV id='MailSign'>" + document.getElementById("xmpMailSign2").innerHTML + "</DIV>" + document.getElementById("bodyValue").innerHTML);
		                tempvalue = "1";
		                break;
		            case "3": message.SetEditorContent("<P " + defaultFontAndSize + "><BR></P><DIV id='MailSign'>" + document.getElementById("xmpMailSign3").innerHTML + "</DIV>" + document.getElementById("bodyValue").innerHTML);
		                tempvalue = "1";
		                break;
	            }
