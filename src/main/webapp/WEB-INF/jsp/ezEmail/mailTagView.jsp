...
<html>
	<head>
		...
		<script type="text/javascript">
			var tagName = "<c:out value='${tag.name}' />";
			var g_bdraft = false;
			...
			var p_HeaderViewXML = "/js/ezEmail/Controls_cross/" + g_userLang + "/viewXMLFileTagTable.xml";
			var p_Listoption = "1";
			...
			window.onload = function () {
				...
				if (listWidth <= 470 && !useReceivingChk) {
				...
				usepostDate = false;
				start_search(); // searchRecurMail2("ALL")
		...
		<style>
			#ContextMenuDiv td { background-color: #ffffff; cursor:pointer; }
			#ContextMenuDiv td:hover { background-color: #f4f5f5; }
			#ContextMenuDiv td > span { font-size:12px; width:100%; display:inline-block; }
			#tag_subtitle { display: inline-block; max-width: 700px; text-overflow: ellipsis; overflow: hidden; word-break: keep-all; vertical-align: middle; }
	...
	<body style="overflow:hidden;margin-bottom:0px;" id="theBody" class="mainbody" onkeydown="event_listOnkeyDown(event);" onkeyup="event_listOnkeyUp(event);"onmousemove="MailPreviewResize(event);" onmouseup="MailPreviewEnd(event);">
		<c:set var="tagNameSpan" ><span id='tag_subtitle' title='<c:out value="${tag.name}"/>'><c:out value="${tag.name}"/></span></c:set>
		<h1><spring:message code="ezEmail.tag.title" arguments="${tagNameSpan}" argumentSeparator="|"/><span id="mailBoxInfo"></span><span id ="resultCount" style="display:none;"></span>
			<span class="searchForm" style="margin-right:0px;">
				...
				<input name="keyword" id="keywordSearch" class="searchinputBox" style="ime-mode: active;height: 27px;border: 1px solid #cbcbcb; border-right:0px;" onKeyPress="onkeydown_start_search(event);"onmousedown="keyword_Clear();"
				placeholder="";/> 
		...
		<div id="mainmenu">
			...
			<li id="btnReject"><span onclick="reject_onclick()"><spring:message code="ezEmail.t270" /></span></li>
		...
		<span id="MailListRayer" style="border:0px solid blue;width:500px;height:100%;vertical-align:top;overflow:hidden;" > 
			<div id="dragDropArea">
				<div id="MailHeaderDiv" style="overflow-x: hidden; ">
					<table style="width:100%;border:1px solid #ddd; min-width:400px;" id="MailHeader" class="mainlist"></table>
				</div>
				<div id="contentlistDiv" style="overflow-y: auto;" onscroll="mailListScroll(this);ContextMenuHidden()" onclick="event_secondRightClick();">
					<div id="contentlist" name="contentlist" style="border:0px solid blue;height:350px;width:100%;min-width:400px;" onbluronscroll="ContextMenuHidden()">
		...
		<div id="ContextMenuDiv" style="position:absolute;top:180px;z-index:6000;display:none;">
			...
			<tr id="replyAllMenu">
				<td><span onclick="all_reply_mail_onclick();HiddenContextMenu();"><img src="/images/i_reall.gif" alt=""align="absmiddle" hspace="5"><spring:message code="ezEmail.t512" /></span></td>
			</tr>
			<tr id="relayMenu">
				<td><span onclick="transmission_mail_onclick();HiddenContextMenu();"><img src="/images/i_fw.gif" alt="" align="absmiddle" border="0" hspace="5"><spring:message code="ezEmail.t513" /></span></td>
			</tr>
			<tr id="replyMenu">
				<td><span onclick="reply_mail_onclick();HiddenContextMenu();"><img src="/images/i_mailreply.gif" alt="" align="absmiddle"border="0" hspace="5"><spring:message code="ezEmail.t511" /></span></td>
			</tr>
			<tr>
				<td><span onclick="Read_StatusChange('R');HiddenContextMenu();"><img src="/images/ImgIcon/icon-msg-read.gif" align="absmiddle" hspace="5"/><spring:message code="ezEmail.t99000006" /></span></td>
			</tr>
			<tr>
				<td><span onclick="ㅏㅏusChange('U');HiddenContextMenu();"><img src="/images/ImgIcon/view-document.gif" align="absmiddle" hspace="5"/><spring:message code="ezEmail.t99000007" /></span></td>
			</tr>
			<tr id="moveMenu">
				<td><span onclick="move_mail_onclick();HiddenContextMenu();"><img src="/images/ImgIcon/move.gif" align="absmiddle" hspace="5"/><spring:message code="ezEmail.t482" /></span></td>
			</tr>
			<tr>
				<td><span onclick="MailListRefresh();HiddenContextMenu();"><img src="/images/ImgIcon/recur.gif" align="absmiddle" hspace="5"/><spring:message code="ezEmail.t515" /></span></td>
			</tr>
			<tr>
				<td><span onclick="toggle_flag();HiddenContextMenu();"><img src="/images/ImgIcon/icon-flag.gif" align="absmiddle" hspace="5"/><spring:message code="ezEmail.t550" /></span></td>
			</tr>
			<c:if test="${useMailConfirm == 'YES'}">
			<tr id="mailConfirm">
				<td><span onclick="mailConfirm_flag_btn();HiddenContextMenu();"><img src="/images/ImgIcon/view-document-confirm.gif" align="absmiddle" hspace="5"/><spring:message code="ezEmail.ksa13" /></span></td>
			</tr>
			</c:if>
			<tr id="searchName">
				<td><span><img src="/images/ImgIcon/i_nsearch.gif" align="absmiddle" hspace="5"/><spring:message code="ezEmail.kr.lsd03" /></span></td>
			</tr>
			<tr id="searchInThisBoxByName">
				<td><span onclick="searchInThisBoxByName();HiddenContextMenu();">&nbsp;&nbsp; - <spring:message code="ezEmail.kr.lsd06" /></span></td>
			</tr>
			<tr id="searchAllBoxByName">
				<td><span onclick="searchAllBoxByName();HiddenContextMenu();">&nbsp;&nbsp; - <spring:message code="ezEmail.kr.lsd07" /></span></td>
			</tr>
			</table>
		</div>
