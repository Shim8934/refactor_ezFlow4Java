...
<html>
	<head>
	    <title>mail_outofoffice_main</title>
	...
	<body class="mainbody">
		<div class="portlet_tabpart01_top" id="tab1">
			...
			<p id="Mail_sub1">
				<span id="1tab1"><spring:message code='ezEmail.ksaOutOfOffice01' /></span>
			</p>
		</div>
		...
		function ChangeTab(obj) {
	        ...
	        switch (pSelectTab) {
	            case "1tab0":
	                ...
	                break;
	            case "1tab1":
	                    document.getElementById("MailEnv_ifrm").src = "/ezEmail/mailOutOfOfficeTemplate.do";
	                break;
	        }
	    }
	</script>
