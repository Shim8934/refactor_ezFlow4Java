			...
			<table class="content" style="width:500px;margin-top:5px">
				<tr>
			    	...
			    	<td style="height:32px">
			        	<input type="text" id="ForwardAddress" value="${forwardAddress}" class="textarea" style="WIDTH:75%;margin-left:2px" NAME="ForwardAddress" onkeyup="onkeydown_SaveKeyEvent(event);">
			        	<a id="ReceiverSelect" class="imgbtn" style="text-align: center; width: 19%; float: right; margin-right: 1px;" onClick="SelectReceiver_onClick()"><span><spring:message code='ezEmail.t488' /></span></a>
			        </td>
			  	</tr>
			</table>
