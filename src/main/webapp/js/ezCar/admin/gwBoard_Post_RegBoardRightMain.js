...
function cmdOk_onclick() {    
	...
	if (cnt <= 0 ) {
		...
		xmlhttp.open("POST", "/admin/ezCar/callBrdMng.do", false);
		xmlhttp.send(xmldom);
...
function cmdAdd_onclick() {
    if (CrossYN()) {
        ...
        var OpenWin = window.open("/admin/ezCar/popup/gwBoardPostRegBoardRight.do", "gwBoardPostRegBoardRight", GetOpenWindowfeature(970, 665));
        
        try { OpenWin.focus(); } catch (e) { }
    } else {
        var Url = "/admin/ezCar/popup/gwBoardPostRegBoardRight.do";
