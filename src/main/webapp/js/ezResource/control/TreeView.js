...
function TreeNode() {
    ...
    function CreateTreeNode(pNodeData, pEndNode, pParentNode, pUseAgency, pNodeClick, pNodeDblClick, pRequestHandler) {
        ...
        if (pNodeClick != "") {
            ...
            spnNode.setAttribute("onClick", "node_select(\"" + this.NodeID + "\", \"" + this.NodeName.replace(/\n/gi, "") + "\", \"" + strTreeID + "\", " + pNodeClick + ");");
        }
        ...
        if (strIsLeaf == "FALSE") {
            ...
            if (pNodeDblClick != "")
                spnNode.setAttribute("ondblclick", "pNodeDblClick(\"" + this.NodeID + "\", \"" + this.NodeName.replace(/\n/gi, "") + "\"); treeicon_toggle(\"" + this.NodeID + "\", \"" + strTreeID + "\", " + pRequestHandler + ", \"" + imgNode.id + "\");");
            else
