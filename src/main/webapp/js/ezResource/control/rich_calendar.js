...
RichCalendar.prototype.show_date = function() {
    ...
    for (i = 0; i < 7; i++) {
        ...
        if (typeof (weekend_days[wd]) != "undefined") {
            if (wd == 0) td.className = "rc_weekend_head1";
            else td.className = "rc_weekend_head2";
        } else {
            td.className = "";
        }
    ...
    this.head_td.innerHTML = cur_year + '. ' + month_names[cur_month];
        ...
        for (day = 0; day < 7; day++) {
            ...
            if (row == 0 && day + 1 < week_day || days == month_days) {
                ...
                if (typeof (weekend_days[wd]) != "undefined") {
                    ...
                    if (wd == 0) RichCalendar.add_class(cell, "rc_weekend_day1");
                    else RichCalendar.add_class(cell, "rc_weekend_day2");
                } else {
                    RichCalendar.remove_class(cell, "rc_weekend_day1");
                    RichCalendar.remove_class(cell, "rc_weekend_day2");
                }
...
var en_month_names = this.text('monthNames', 'kr');
var en_short_month_names = this.text('monthNamesShort', 'kr');
