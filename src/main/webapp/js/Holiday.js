...
function select_memorialDays(val01){
	if (val01 != "3") {
		...
		var memorialDays_japan = Array(
	        ...
	        new memorialDay("春分の日", "春分の日", 3, 20, 1, true),
	        new memorialDay("昭和の日", "昭和の日", 4, 29, 1, true),
	        new memorialDay("憲法記念日", "憲法記念日", 5, 3, 1, true),
	        new memorialDay("みどりの日", "みどりの日", 5, 4, 1, true),        
	        new memorialDay("こどもの日", "こどもの日", 5, 5, 1, true),        
	        new memorialDay("山の日", "山の日", 8, 11, 1, true),
	        new memorialDay("秋分の日", "秋分の日", 9, 23, 1, true),
	        new memorialDay("文化の日", "文化の日", 11, 3, 1, true),
	        new memorialDay("勤労感謝の日", "勤労感謝の日", 11, 23, 1, true),
	        new memorialDay("天皇誕生日", "天皇誕生日", 12, 23, 1, true)
		);
