                        ...
                        case "subject":
                            ...
                            if (useMailNewWindow == "YES") {
                                ...
                                if (usePreviewMail === "true"){
                                    if (g_bdraft == true) {
                                        p_Subject = "<span style='color: #999;'>" + p_mailBoxName + "</span>" + p_Subject + "<img class='mailpopupicon' id='previewMailIcon' src='/images/bsearch_new2.svg' width='12px' style='padding: 0 8px; height 18px;' onclick = 'previewMail(this, event)' onmouseover = 'this.src = \"/images/bsearch_new2_hover.svg\"'  onmouseout = 'this.src = \"/images/bsearch_new2.svg\"'/>";
                                    } else {
                                        p_Subject = "<div id = \"subject\"style=\" cursor:pointer; max-width:85%; display:inline-block;overflow:hidden; text-overflow: ellipsis;\">" + "<span style='color: #999;'>" + p_mailBoxName + "</span>" + p_Subject + "</div>&nbsp;&nbsp;<img class='mailpopupicon' src=\"/images/email/popup_icon.gif\" width=\"12px\"  onclick = \"mailOpenPopup(this, event)\" /> <img class='mailpopupicon' id='previewMailIcon' src='/images/bsearch_new2.svg' width='12px' style='padding: 0 8px; height 18px;' onclick = 'previewMail(this, event)' onmouseover = 'this.src = \"/images/bsearch_new2_hover.svg\"'  onmouseout = 'this.src = \"/images/bsearch_new2.svg\"'/>" ;
                                    }
                                } else {
                                    if (g_bdraft == true) {
