...
var strLang92 = "제목란이 비어있어 임시저장되지 않습니다.";
var strLang93 = "수신인이 한 명도 지정되어 있지 않습니다.";
var strLang95 = "제목은 150 글자 이내이어야 합니다.";
...
var strLang337 = "일반게시판, Q&A게시판에만 게시가 가능합니다.";
...
var strLangKSA01 = "이미 동일한 이메일 주소가 저장되어있습니다 : %s";
...
var strLangNJK01 = "편지함 이름에 사용할 수 없는 문자(";
var strLangNJK02 = "가 포함되어 있습니다.";

//승인메일
var strLangAppr01 = "전체관리자가 없어 전사메일 승인신청이 불가합니다.";
var strLangAppr02 = "승인자가 존재하지 않습니다.";
var strLangAppr03 = "승인메일 오류발생";
var strLangAppr04 = "승인메일은 예약발송할 수 없습니다."
var strLangAppr05 = "회사 전체에게 보내는 메일은 관리자의 승인을 거쳐야 실제로 발송이 이루어집니다. 발송하시겠습니까?"
...
const strLangPlzCheckSearchInput = "검색어를 입력해주세요.";
const strLangSearchFetchError = "검색결과를 가져오는 중 오류가 발생했습니다. -";
const strLangNoSuchDept = "검색된 부서가 없습니다.";
const strLangDistributionFetchError = "공용배포그룹목록을 가져오는중 오류가 발생했습니다. -";
const strLangAddJobSimplyMark = "(겸) ";
const strLangCompany = "회사";
const strLangDistributionAdd = "배포목록추가";// ezEmail.t60 = 배포목록추가
const strLangAddressFetchError = "주소목록을 읽는중에 오류발생";// ezEmail.t585 = 주소목록을 읽는중에 오류발생
const strLangPlzSelectGroupMail = "그룹메일을 선택해주세요.";// ezEmail.t581 = 그룹메일을 선택해주세요.
const strLangPlzSelectDistribution = "공용배포그룹을 선택해주세요.";// ezEmail.t580 = 공용배포그룹을 선택해주세요.
const strLangNotAllowedSpecialChar = "이름에 해당 특수문자는 입력할 수 없습니다.";

const strLangSelectDept = "부서선택";
const strLangSelectTitle = "직위선택";
const strLangSelectRole = "직책선택";
const strLangPlzCheckSearchNameInput = "검색할 이름을 입력해주세요.";
const strLangOrgFetchError = "조직도를 검색하는 도중 오류가 발생했습니다. -";
const strLangSelectProxyApproverWarning = "대리결재자로 지정할 사람을 한명만 선택해주세요.";

const strLangTempSaveAttachmentsWarning = "저장 시 첨부된 파일은 삭제됩니다. 저장하시겠습니까?";
