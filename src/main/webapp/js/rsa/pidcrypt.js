...
function initKey() {
    ...
    RSAkey = pidCryptUtil.decodeBase64(RSAparams.b64);
    RSArsa = new pidCrypt.RSA();
    RSAasn = pidCrypt.ASN1.decode(pidCryptUtil.toByteArray(RSAkey));
    RSAtree = RSAasn.toHexTree();
    RSArsa.setPublicKeyFromASN(RSAtree);
    RSAt = new Date();
}
