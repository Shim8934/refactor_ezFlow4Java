...
function makePageSelPageAtti() {
	...
	$("#mailBoxInfo").html(" - [<spring:message code='ezAttitude.t76'/><span style='color:#017BEC;'> " + totalCount + " </span><spring:message code='ezAttitude.t78'/>]");
	...
	if (totalPage > blockSize && pageNum / (blockSize + 1) >= 1) {
		...
		pagingHtml += "<span class='btnimg' onclick='goToPageByNum(" + beforeBlock + ")'><img src='/images/sub/btn_prev.gif' width='16' height='16'/></span><span class='ptxt' onclick='goToPageByNum(" + (pageNum - 1) + ")'><spring:message code='ezAttitude.t94'/></span>";
	} else {
		pagingHtml += "<span class='btnimg'><img src='/images/sub/btn_prev01.gif' width='16' height='16'/></span><span class='ptxt' onclick='goToPageByNum(" + (pageNum - 1) + ")'><spring:message code='ezAttitude.t94'/></span>";
	}
	...
	if (totalPage > blockSize && totalPage > (parseInt((pageNum - 1) / blockSize) + 1) * blockSize) {
		...
		pagingHtml += "<span class='ptxt' onclick='goToPageByNum(" + (pageNum + 1) + ")'>" + "<spring:message code='ezAttitude.t95'/>" + "</span><span class='btnimg' onclick='goToPageByNum(" + afterBlock + ")'><img src='/images/sub/btn_next.gif' width='16' height='16'></span>";
	} else {
		pagingHtml += "<span class='ptxt' onclick='goToPageByNum(" + (pageNum + 1) + ")'>" + "<spring:message code='ezAttitude.t95'/>" + "</span><span class='btnimg'><img src='/images/sub/btn_next01.gif' width='16' height='16'></span>";
	}
	// >| 버튼 셋팅 ==> 맨 마지막 블록으로 이동
