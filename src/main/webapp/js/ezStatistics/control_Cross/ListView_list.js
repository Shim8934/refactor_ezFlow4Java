       ...
       if(_rowCount == 0)
        ...
        for (var i = 0; i < oRows.length; i++) {
            ...
            if (GetElementsByTagName(oRows[i], "MESSAGE")[0] != undefined) {
                ...
                var strValue = "";
                if (GetElementsByTagName(oRows[i], "MESSAGE")[0].firstChild != null && GetElementsByTagName(oRows[i], "MESSAGE")[0].firstChild.nodeValue != null)
                    strValue = GetElementsByTagName(oRows[i], "MESSAGE")[0].firstChild.nodeValue;

                objTr.setAttribute(strData, strValue);
            }

            if (GetElementsByTagName(oRows[i], "LOGID")[0] != undefined) {
                var strData = GetElementsByTagName(oRows[i], "LOGID")[0].tagName;
                var strValue = "";
                if (GetElementsByTagName(oRows[i], "LOGID")[0].firstChild != null && GetElementsByTagName(oRows[i], "LOGID")[0].firstChild.nodeValue != null)
                    strValue = GetElementsByTagName(oRows[i], "LOGID")[0].firstChild.nodeValue;

                objTr.setAttribute(strData, strValue);
            }

            if (GetElementsByTagName(oRows[i], "PAGENAME")[0] != undefined) {
                var strData = GetElementsByTagName(oRows[i], "PAGENAME")[0].tagName;
                var strValue = "";
                if (GetElementsByTagName(oRows[i], "PAGENAME")[0].firstChild != null && GetElementsByTagName(oRows[i], "PAGENAME")[0].firstChild.nodeValue != null)
                    strValue = GetElementsByTagName(oRows[i], "PAGENAME")[0].firstChild.nodeValue;

                objTr.setAttribute(strData, strValue);
            }

            if (GetElementsByTagName(oRows[i], "QUERYVALUE")[0] != undefined) {
                var strData = GetElementsByTagName(oRows[i], "QUERYVALUE")[0].tagName;
                var strValue = "";
                if (GetElementsByTagName(oRows[i], "QUERYVALUE")[0].firstChild != null && GetElementsByTagName(oRows[i], "QUERYVALUE")[0].firstChild.nodeValue != null)
                    strValue = GetElementsByTagName(oRows[i], "QUERYVALUE")[0].firstChild.nodeValue;

                objTr.setAttribute(strData, strValue);
            }

            if (GetElementsByTagName(oRows[i], "FORMVALUE")[0] != undefined) {
                var strData = GetElementsByTagName(oRows[i], "FORMVALUE")[0].tagName;
                var strValue = "";
                if (GetElementsByTagName(oRows[i], "FORMVALUE")[0].firstChild != null && GetElementsByTagName(oRows[i], "FORMVALUE")[0].firstChild.nodeValue != null)
                    strValue = GetElementsByTagName(oRows[i], "FORMVALUE")[0].firstChild.nodeValue;
