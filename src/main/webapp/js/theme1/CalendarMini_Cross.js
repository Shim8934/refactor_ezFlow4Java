...
function CalendarMiniView(pTagetID) {
    ...
    if (objElm) {
        ...
        mImg.setAttribute("src", "/images/kr/theme01/main/btn_calendar_prev.gif");
        ...
        mSpan.style.cursor = "pointer";
        var mImg = document.createElement("IMG");
        mImg.setAttribute("src", "/images/kr/theme01/main/btn_calendar_next.gif");
        mImg.setAttribute("border", "0");
    ...
    try {
        ...
        for (var i = 0; i < nlength; i++) {
            ...
            if (_Dtstart.substring(0, 10) != _Dtend.substring(0, 10)) { // 반복일정
                ...
                var betweenDay = DataEDT - DataSDT;
                var day = 1000 * 60 * 60 * 24;
                betweenDay = parseInt(betweenDay / day);
...
function MiniDataBind(oAppointment) {
    ...
    if (objElm) {
        objElm.parentElement.className = "calendarDay";
