...
function datepicker(thisobjid, elobjid) {
    ...
    var element = document.getElementById(elobjid); // �߰�
    ...
    var m_szOOOText = "#C94545"; // �Ͽ����ؽ�Ʈ��..
    var m_szHalfText = "#4545c9"; // ����� �ؽ�Ʈ ��
    ...
    function onClickDatePicker(event) {
        ...
        (function (event) {
            ...
            if (null != thisCell.prvyear) {
                ...
                //####################################################################
                // ���õ� Į���� ������� Į�� �ƴѰ�� ����/�������� ����Ѵ�.
                //if( (String(thisCell.style.backgroundColor).toUpperCase() != "#FFFFE8" && String(thisCell.style.backgroundColor).toUpperCase() != "#F3F3B7") &&  iDate != pDate.getDate() ) //[���¾���]
        ...
        (function (ePicker, event) {
            ...
            switch (szPoplocation) {
                ...
                case "topright":
                    ...
                    ePicker.style.left = String(event.clientX - event.layerX + eSrc.offsetWidth + m_winDocBody.scrollLeft + 210) + 'px';
                    //20070604
                    //ePicker.style.top = event.clientY - event.offsetY - eSrc.offsetHeight + m_winDocBody.scrollTop - 30; //��ġ ��ǥ
                    ePicker.style.top = String(event.clientY - event.layerY - eSrc.offsetHeight + m_winDocBody.scrollTop + 120) + 'px'; //��ġ ��ǥ
        ...
        (function (ePicker, event) {
            ...
            switch (szPoplocation) {
                ...
                case "topright":
                    ...
                    //20070604
                    //ePicker.style.top = event.clientY - event.offsetY - eSrc.offsetHeight + m_winDocBody.scrollTop - 30; //��ġ ��ǥ
                    ePicker.style.top = event.clientY - event.offsetY - eSrc.offsetHeight + m_winDocBody.scrollTop - 60 + 'px'; //��ġ ��ǥ
        ...
        (function (ePicker, event) {
            ...
            switch (szPoplocation) {
                ...
                case "topright":
                    ...
                    //20070604
                    //ePicker.style.top = event.clientY - event.offsetY - eSrc.offsetHeight + m_winDocBody.scrollTop - 30; //��ġ ��ǥ
                    ePicker.style.top = event.clientY - event.offsetY - eSrc.offsetHeight + m_winDocBody.scrollTop - 80 + 'px'; //��ġ ��ǥ
