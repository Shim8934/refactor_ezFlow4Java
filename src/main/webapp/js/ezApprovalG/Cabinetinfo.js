...
function GetTaskXml(TaskXml) {
    ...
    for (var i = 0; i < GetElementsByTagName(TaskXml, "ROW").length; i++) {
        strXml = strXml + "<ROW>";      
        strXml = strXml + "<CELL>";
        strXml = strXml + "<VALUE><![CDATA[" + getNodeText(GetElementsByTagName(TaskXml, "TITLE").item(i)) + "]]></VALUE>"; // TBCABINETCLASS.TITLE
        strXml = strXml + "<DATA1><![CDATA[" + getNodeText(GetElementsByTagName(TaskXml, "CABINETID").item(i)) + "]]></DATA1>"; // TBCABINET.CABINETID
        strXml = strXml + "<DATA2><![CDATA[" + getNodeText(GetElementsByTagName(TaskXml, "TASKCODE").item(i)) + "]]></DATA2>"; // TBCABINETCLASS.TASKCODE
        strXml = strXml + "<DATA3><![CDATA[" + getNodeText(GetElementsByTagName(TaskXml, "CABINETCLASSNO").item(i)) + "]]></DATA3>"; // TBCABINET.CABINETCLASSNO
        strXml = strXml + "<DATA4><![CDATA[" + getNodeText(GetElementsByTagName(TaskXml, "OWNERID").item(i)) + "]]></DATA4>"; // TBCABINETCLASS.OWNERID
        strXml = strXml + "<DATA5><![CDATA[" + getNodeText(GetElementsByTagName(TaskXml, "TITLE").item(i)) + "]]></DATA5>"; // TBCABINETCLASS.TITLE
        strXml = strXml + "<DATA6><![CDATA[" + getNodeText(GetElementsByTagName(TaskXml, "TITLE2").item(i)) + "]]></DATA6>"; // TBCABINETCLASS.TITLE2
        //}
        //첫번째 Cell값에 단위분류 DATA값을 넣는다 
        strXml = strXml + "<DATA7><![CDATA[" + getNodeText(GetElementsByTagName(TaskXml, "TASKCODE").item(i)) + "]]></DATA7>"; // VTASKCLASS.TASKCODE
        ...
        strXml = strXml + "<DATA12><![CDATA[" + getNodeText(GetElementsByTagName(TaskXml, "SC1").item(i)) + "]]></DATA12>"; // VTASKCLASS.SC1
        strXml = strXml + "<DATA13><![CDATA[" + getNodeText(GetElementsByTagName(TaskXml, "SC2").item(i)) + "]]></DATA13>"; // VTASKCLASS.SC2
        strXml = strXml + "<DATA14><![CDATA[" + getNodeText(GetElementsByTagName(TaskXml, "SC3").item(i)) + "]]></DATA14>"; // VTASKCLASS.SC3
        ...
        strXml = strXml + "<DATA17><![CDATA[" + getNodeText(GetElementsByTagName(TaskXml, "TASKNAME").item(i)) + "]]></DATA17>"; // VTASKCLASS.TASKNAME
