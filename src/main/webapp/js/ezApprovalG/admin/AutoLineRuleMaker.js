    ...
    for (var i = 0; i < GetElementsByTagName(AprRuleXML, "ROW").length; i++) {
        if (getNodeText(GetElementsByTagName(AprRuleXML, "DOCTYPE")[i]) == pDocType) {
            ...
            switch (getNodeText(GetElementsByTagName(AprRuleXML, "OPERATORTYPE")[i])) {
                case "TXT":
                    pListXml = pListXml + " <VALUE><![CDATA[" + strLangyjS2 + "]]></VALUE>";
                    break;
                case "NUM":
                    pListXml = pListXml + " <VALUE><![CDATA[" + strLangyjS3 + "]]></VALUE>";
                    break;
            }
            pListXml = pListXml + "</CELL>";
            pListXml = pListXml + "<CELL>";
            switch (getNodeText(GetElementsByTagName(AprRuleXML, "OPERATOR")[i])) {
                case "NUM_GE":
                    pListXml = pListXml + " <VALUE><![CDATA[>= (" + strLangyjS4 + ")]]></VALUE>";
                    break;
                case "NUM_LE":
                    pListXml = pListXml + " <VALUE><![CDATA[<= (" + strLangyjS5 + ")]]></VALUE>";
                    break;
                case "NUM_GT":
                    pListXml = pListXml + " <VALUE><![CDATA[> (" + strLangyjS7 + ")]]></VALUE>";
                    break;
                case "NUM_LT":
                    pListXml = pListXml + " <VALUE><![CDATA[< (" + strLangyjS6 + ")]]></VALUE>";
                    break;
                case "NUM_EQ":
                    pListXml = pListXml + " <VALUE><![CDATA[= (" + strLangyjS8 + ")]]></VALUE>";
                    break;
                case "TXT_EQ":
                    pListXml = pListXml + " <VALUE><![CDATA[" + strLangyjS8 + "]]></VALUE>";
                    break;
                case "TXT_INC":
                    pListXml = pListXml + " <VALUE><![CDATA[" + strLangyjS9 + "]]></VALUE>";
                    break;
                case "TXT_NOTINC":
                    pListXml = pListXml + " <VALUE><![CDATA[" + strLangyjS10 + "]]></VALUE>";
                    break;
            }
            pListXml = pListXml + "</CELL>";
            pListXml = pListXml + "<CELL>";
