    ...
    function onClickDatePicker(event) {
        ...
        (function() {
            ...
            if (null != thisCell.prvyear) {
                ...
                //if( (String(thisCell.style.backgroundColor).toUpperCase() != "#FFFFE8" && String(thisCell.style.backgroundColor).toUpperCase() != "#F3F3B7") &&  iDate != pDate.getDate() ) //[가온아이]
                if ((thisCell.style.backgroundColor.toUpperCase() != "#FFFFE8" && thisCell.style.backgroundColor.toUpperCase() != "RGB(255, 255, 232)")
                && (thisCell.style.backgroundColor.toUpperCase() != "#F3F3B7" && thisCell.style.backgroundColor.toUpperCase() != "RGB(243, 243, 183)")) //[가온아이] //[가온아이]
                //####################################################################
                {
                    if (iDate < 15)	//prev month
                    {
        ...
        (function(ePicker, event) {
            ...
            switch (szPoplocation) {
                ...
                case "topleft": //***
                    ...
                    if (typeof (eSrc.forceMarginLeft) != "undefined" && eSrc.forceMarginLeft != null) {
                        ePicker.style.left = ePicker.style.left + parseInt(eSrc.forceMarginLeft);
                    }
                    //20070604 
                    if (typeof (eSrc.forceMarginTop) != "undefined" && eSrc.forceMarginTop != null) {
                        ePicker.style.top = ePicker.style.top + parseInt(eSrc.forceMarginTop);
                ...
                case "bottomleft": //bottomleft
                    ePicker.style.display = "";
                    ePicker.style.left = event.clientX - event.offsetX - ePicker.offsetWidth + m_winDocBody.scrollLeft;
                    ePicker.style.top = event.clientY - event.offsetY + eSrc.offsetHeight + m_winDocBody.scrollTop;
                    if (!fIsRoom(iX, iY, 'bottom')) iY -= m_iCalHeight + m_iBtnHeight;
                    if (iX < m_winDocBody.scrollLeft) iX += m_iCalWidth + m_iBtnWidth;
                    break
                case "topcenter":
                    ePicker.style.display = "";
                    ePicker.style.left = event.clientX - event.offsetX - (ePicker.offsetWidth / 2) + m_winDocBody.scrollLeft;
                    ePicker.style.top = event.clientY - event.offsetY - ePicker.offsetHeight + m_winDocBody.scrollTop;
                    if (iY < m_winDocBody.scrollTop) iY += m_iCalHeight + m_iBtnHeight;
                    if (iX < m_winDocBody.scrollLeft) iX += m_iCalWidth + m_iBtnWidth;
                    break;
                case "bottomcenter":
            ...
            switch (szPoplocation) {
                ...
                case "topleft": //***
                    ...
                    if (typeof (eSrc.forceMarginLeft) != "undefined" && eSrc.forceMarginLeft != null) {
                        ePicker.style.left = ePicker.style.posLeft + parseInt(eSrc.forceMarginLeft) + "px";
                    }
                    //20070604
                    if (typeof (eSrc.forceMarginTop) != "undefined" && eSrc.forceMarginTop != null) {
                        ePicker.style.top = ePicker.style.posTop + parseInt(eSrc.forceMarginTop) + "px";
                    }
