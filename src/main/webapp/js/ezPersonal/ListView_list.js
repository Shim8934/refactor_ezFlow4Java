       ...
       /* if(_rowCount == 0)
        ...
        for (var i = 0; i < oRows.length; i++) {
            ...
            for (var j = 0; j < colcnt; j++) {
                ...
                if (SelectSingleNodeValue(oCells[j], "TYPE") == "BTN") {
                    ...
                    _atag.className = "imgbtn";
                    var _spantag = document.createElement("span");

                    var oDatas = GetDataElements(oCells[j]);
                    var _thisArgu = "";
                    for (var z = 0; z < oDatas.length; z++) {
                        if (SelectSingleNodeValue(oCells[j], "DATA" + z) != "") {
                            if (_thisArgu != "")
                                _thisArgu += "," + "\"" + SelectSingleNodeValue(oCells[j], "DATA" + z) + "\"";
                            else
                                _thisArgu += "\"" + SelectSingleNodeValue(oCells[j], "DATA" + z) + "\"";
                        }
                    }
                    _spantag.onclick = new Function(SelectSingleNodeValue(oCells[j], "FUNC") + "(" + _thisArgu + ");");
                    var oText2 = document.createTextNode(strValue);
                    _spantag.appendChild(oText2);
                    _atag.appendChild(_spantag);
                    objTd.appendChild(_atag);
                    objTr.appendChild(objTd);
                    ...
                    if (oHeaders[j] != undefined && SelectSingleNodeValue(oHeaders[j], "COLNAME") == "ISUSE") {
                        var _TDCheckBox_Sub = document.createElement("INPUT");
                        _TDCheckBox_Sub.type = "checkbox";

                        if (strValue == "1")
                            _TDCheckBox_Sub.checked = true;
                        else
                            _TDCheckBox_Sub.checked = false;
                        ...
                        _TDCheckBox_Sub.onclick = new Function("event_statuschange(this)");
