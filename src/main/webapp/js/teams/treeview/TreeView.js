...
function TreeNode() {
    ...
    function CreateTreeNode(pNodeData, pEndNode, pParentNode, pUseAgency, pNodeClick, pNodeDblClick, pRequestHandler) {
        ...
        */
        if (strIsLeaf.toUpperCase() == "FALSE") {
            imgNode.style.cursor = "pointer";
            imgNode.setAttribute("onClick", "treeicon_toggle(\"" + this.NodeID + "\", \"" + strTreeID + "\", " + null + ", \"" + imgNode.id + "\");");
        }
        ...
        subImgNode.border = "0";
        subImgNode.style.width = "16px";
        subImgNode.style.height = "16px";
