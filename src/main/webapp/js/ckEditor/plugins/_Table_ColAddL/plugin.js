...
//			alert(tag_id);
	...
	var pluginName = '_Table_ColAddL';

	// Register a plugin named "_Table_ColAddL".
	CKEDITOR.plugins.add( pluginName,
	{
		init : function( editor )
		{
			...
			editor.addCommand( pluginName, _Table_ColAddLCmd );
			editor.ui.addButton( '_Table_ColAddL',
				{
					label : lang._Table_ColAddL,
					command: pluginName,
					icon: this.path + "insertcolumnleft.gif"
				});
		}
	});
})();
