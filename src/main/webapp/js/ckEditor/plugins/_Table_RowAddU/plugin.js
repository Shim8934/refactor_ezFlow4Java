...
(function()
{
	...
	var pluginName = '_Table_RowAddU';

	// Register a plugin named "_Table_RowAddU".
	CKEDITOR.plugins.add( pluginName,
	{
		init : function( editor )
		{
			...
			editor.addCommand( pluginName, _Table_RowAddUCmd );
			editor.ui.addButton( '_Table_RowAddU',
				{
					label : lang._Table_RowAddU,
					command: pluginName,
					icon: this.path + "insertrowabove.gif"
				});
		}
	});
})();
