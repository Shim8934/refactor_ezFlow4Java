...
(function () {
    var r = function (c, j) {
        ...
        z = n("previewImage"); return {
            title: c.lang.image["image" == j ? "title" : "titleButton"], minWidth: 420, minHeight: 180, onShow: function () {
            ...
            onLoad: function () { "image" != j && this.hidePage("Link"); var a = this._.element.getDocument(); this.getContentElement("info", "ratioLock") && (this.addFocusable(a.getById(u), 5), this.addFocusable(a.getById(p), 5)); this.commitContent = r }, onHide: function () {
                ...
                id: "info", label: c.lang.image.infoTab, accessKey: "I", elements: [{
                    type: "vbox", padding: 0, children: [{
                        type: "hbox", widths: ["280px", "1px"], align: "right", children: [{
                            id: "txtUrl", type: "text", label: c.lang.common.url, required: !0, onChange: function () {
                                var a = this.getDialog(), b = this.getValue(); this.disable(); if (0 < b.length) {
                ...
                //{
                //    id: "txtAlt",style:"display:none", type: "text", label: c.lang.image.alt, accessKey: "T", "default": "", onChange: function () { g(this.getDialog()) }, setup: function (a, b) { a == f && this.setValue(b.getAttribute("alt")) }, commit: function (a,
                ...
                //},
                {
                    type: "hbox", children: [{
                        id: "basic", type: "vbox", children: [{
                            type: "hbox", requiredContent: "img{width,height}", widths: ["50%", "50%"], children: [{
                                type: "vbox", padding: 1, children: [{
                                    type: "text", width: "45px", id: "txtWidth", label: c.lang.common.width, onChange: function () { i.call(this, "advanced:txtdlgGenStyle") }, validate: function () {
                                    ...
                                    width: "45px", label: c.lang.common.height, onChange: function () { i.call(this, "advanced:txtdlgGenStyle") }, validate: function () { var a = this.getValue().match(v); (a = !!(a && 0 !== parseInt(a[1], 10))) || alert(c.lang.common.invalidHeight); return a }, setup: y, commit: function (a, b, d) {
                            ...
                            //{
                            //    id: "ratioLock", type: "html", style: "margin-top:30px;width:40px;height:40px;display:none", onLoad: function () {
                        ...
                        //{
                        //    type: "vbox", padding: 1, children: [{
                        //        type: "text", id: "txtBorder", style: "display:none", requiredContent: "img{border-width}", width: "60px", label: c.lang.image.border, "default": "", onKeyUp: function () { g(this.getDialog()) },
                        ...
                        //        }
                        //    }, {
                        //        type: "text", style: "display:none", id: "txtHSpace", requiredContent: "img{margin-left,margin-right}", width: "60px", label: c.lang.image.hSpace, "default": "", onKeyUp: function () { g(this.getDialog()) }, onChange: function () { i.call(this, "advanced:txtdlgGenStyle") }, validate: CKEDITOR.dialog.validate.integer(c.lang.image.validateHSpace),
                        ...
                        //        }
                        //    }, {
                        //        type: "text", style: "display:none", id: "txtVSpace", requiredContent: "img{margin-top,margin-bottom}", width: "60px", label: c.lang.image.vSpace, "default": "", onKeyUp: function () { g(this.getDialog()) }, onChange: function () { i.call(this, "advanced:txtdlgGenStyle") }, validate: CKEDITOR.dialog.validate.integer(c.lang.image.validateVSpace), setup: function (a, b) {
                        //            if (a == f) {
                        ...
                        //        }
                        //    }, {
                        //        id: "cmbAlign", requiredContent: "img{float}", type: "select", widths: ["35%", "65%"], style: "width:90px;display:none", label: c.lang.common.align, "default": "", items: [[c.lang.common.notSet, ""], [c.lang.common.alignLeft, "left"], [c.lang.common.alignRight, "right"]], onChange: function () { g(this.getDialog()); i.call(this, "advanced:txtdlgGenStyle") }, setup: function (a, b) {
                        //            if (a == f) {
                    ...
                    {
                        type: "vbox", style: "display:none", height: "250px", children: [{
