...
CKEDITOR.editorConfig = function( config ) {
	...
	config.extraPlugins = "_Insert_Image,lineheight,pastefromexcel,justify,colorbutton,colordialog";
	...
	config.removeButtons = 'Image,Underline,Subscript,Superscript,Styles';
