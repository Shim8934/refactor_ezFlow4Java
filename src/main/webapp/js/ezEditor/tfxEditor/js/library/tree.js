	...
	*/
	...
	function renderNode(node){
		...
		if(this.xfe) {
			...
			leafIconPath = this.xfe.xfeStackObject.getIconPath("small/templatefile.png");
			parentIconPath = this.xfe.xfeStackObject.getIconPath("small/templatefolder.png");

		} else {

			basePath = this.basePath;
			leafIconPath = basePath + "/images/icon/v50/small/templatefile.png";
			parentIconPath = basePath + "/images/icon/v50/small/templatefolder.png";
		}

		var leaf_icon = "<span class='tj_fileIcon'><img src='" + leafIconPath + "' alt='템플릿 파일'></span>";
		var parent_icon = "<span class='tj_folderIcon'><img src='" + parentIconPath + "' alt='템플릿 폴더'></span>";
		...
		if(node.isLeaf() && !TreeUtil.getProperty(node.getOptions(), "forceParent", false)){
			...
			if(icon != ""){
				...
				ret += '<span class="tj_icon">' + leaf_icon + '</span>';
			}
			...
			if(icon != ""){
				...
				ret += '<span class="tj_icon">' + parent_icon + '</span>';
			}
...
const TreeUtil = {
	...
	default_leaf_icon: "<span class='tj_fileIcon'><img src='../images/icon/v40/small/asdg.png' alt='템플릿 파일'>",
	//default_parent_icon: "<span>&#128449;</span>",
	default_parent_icon: "<span class='tj_folderIcon'><img src='../images/icon/v40/small/sd.png' alt='템플릿 폴더'></span>",
