...
<%
	...
	if(checkWhiteList(sExtension)) {
		...
		String sTime = new java.text.SimpleDateFormat("HHmmssSSS").format(new java.util.Date());
		String sNewFName = concatenate3(sFileNameHead, sTime, sExtension);

		if(sNewFName != null && !sNewFName.equals("")) {
		
			sNewFName = cleanXSS(sNewFName);
			
			sNewFName = concatenate2(".", sNewFName);
		}
