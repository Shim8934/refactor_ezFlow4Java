    ...
    e(document).mouseup(function() {
        ...
        function() {
                ...
                e.position = {
                    ...
                    try{
                        ...
                        if(n.of && n.of.nodeName ==='IFRAME') {
                            var tempNode = getOwnerWindow(targetNode);
                            var scroll_top = 0;
                            while (tempNode) {
                                var rect = tempNode.getBoundingClientRect();
                                addFrameOffset.x += parseInt(rect.left)||0;
                                addFrameOffset.y += parseInt(rect.top )||0;
                                addFrameOffset.y -= e(tempNode).contents().find('body').scrollTop()
                                addFrameOffset.x -= e(tempNode).contents().find('body').scrollLeft()
                                scroll_top = tempNode.ownerDocument.body.scrollTop;
                                tempNode = getOwnerWindow(tempNode);
                            }
                            addFrameOffset.y += scroll_top;
                        }
                    } catch(e) {
                        if((e.code && e.code == 18) || (e.number && (e.number>>16 & 0x1FFF) == 7) || (e == "errCors")) {
            ...
            _create: function() {
                ...
                }).addClass("ce-ui-helper-hidden-accessible").appendTo(this.document[0].body), this._on(this.window, {
            ...
            _appendTo: function() {
                ...
                return t && (t = t.jquery || t.nodeType ? e(t) : this.document.find(t).eq(0)), t && t[0] || (t = this.element.closest(".ce-ui-front")), t.length || (t = this.document[0].body), t
            },
    ...
    e.effects = {
        ...
        function() {
            ...
            var s = e(this),
                ...
                d = s.offset(),
                c = e("<div class='ce-ui-effects-transfer'></div>").appendTo(document.body).addClass(t.className).css({
                    top: d.top - r,
                    left: d.left - h,
            ...
            _create: function() {
                this._on({
                    ...
                    "aria-live": "assertive",
                    "aria-relevant": "additions"
                }).addClass("ce-ui-helper-hidden-accessible").appendTo(this.document[0].body)
            },
            _setOption: function(t, i) {
                var s = this;
            ...
            _tooltip: function(t) {
                ...
                return e("<div>").addClass("ce-ui-tooltip-content").appendTo(i), i.appendTo(this.document[0].body), this.tooltips[s] = {
                    element: t,
                    tooltip: i
                }
            },
