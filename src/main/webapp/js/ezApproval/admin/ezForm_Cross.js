...
function fnValueClick() {
    if (BottonTDValue.length) {
        ...
        if (BeforeClickID == "")
            document.getElementById(GetAttribute(parentTR.cells[0], "ID")).style.backgroundColor = "rgb(225, 238, 252)";
        else {
...
var BottomValue = new Array("ClassName", "ID", strLang342, strLang370);
