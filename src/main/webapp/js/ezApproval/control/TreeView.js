...
function TreeNode() {
    ...
    function LoadFromID(pNodeID) {
        ...
        if (_nodeDIV) {
            this.NodeID = pNodeID;
            this.NodeName = GetAttribute(_nodeDIV, "NODENAME") != null ? GetAttribute(_nodeDIV, "NODENAME") : "";
            this.NodeLevel = GetAttribute(_nodeDIV, "NODELEVEL") != null ? GetAttribute(_nodeDIV, "NODELEVEL") : "";
            this.EndNode = GetAttribute(_nodeDIV, "ENDNODE") != null ? GetAttribute(_nodeDIV, "ENDNODE") : "";
            return true;
        }
        else {
            return false;
    ...
    function GetNodeData(pDataName) {
        return GetAttribute(_nodeDIV, pDataName) != null ? GetAttribute(_nodeDIV, pDataName) : "";
    }
    ...
    function CreateTreeNode(pNodeData, pEndNode, pParentNode, pUseAgency, pNodeClick, pNodeDblClick, pRequestHandler) {
        ...
        var strIsLeaf = GetAttribute(treeDiv, "ISLEAF") != null ? GetAttribute(treeDiv, "ISLEAF") : "";
        if (pUseAgency) {
...
function TreeView() {
    ...
    function LoadFromID(pTreeID) {
        ...
        _nodeClick = GetAttribute(oTree, "NODECLICK") != null ? GetAttribute(oTree, "NODECLICK") : "";
        _nodeDblClick = GetAttribute(oTree, "NODEDBLCLICK") != null ? GetAttribute(oTree, "NODEDBLCLICK") : "";
        _requestDataHandler = GetAttribute(oTree, "REQUESTDATA") != null ? GetAttribute(oTree, "REQUESTDATA") : "";
    }
    ...
    function AppendChildNodes(pSubData, pNodeID) {
        ...
        var strLevel = GetAttribute(oNode, "NODELEVEL") != null ? GetAttribute(oNode, "NODELEVEL") : "";
    ...
    function GetSelectNodeID() {
        ...
        return GetAttribute(treeDiv, "SELECTNODEID") != null ? GetAttribute(treeDiv, "SELECTNODEID") : "";
    }
    ...
    function DisplaySelectNode() {
        ...
        var iWidth = parseInt(GetAttribute(selectNode, "NODELEVEL") != null ? GetAttribute(selectNode, "NODELEVEL") : "") - 1;
...
function node_select(pNodeID, pNodeNM, pTreeID, callbackFunc) {
    ...
    var preSelectID = GetAttribute(treeDiv, "SELECTNODEID") != null ? GetAttribute(treeDiv, "SELECTNODEID") : "";
