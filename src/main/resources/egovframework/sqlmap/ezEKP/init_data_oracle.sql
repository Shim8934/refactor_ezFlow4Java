...
INSERT INTO TBL_TENANT_CONFIG (TENANT_ID, PROPERTY_NAME, CONFIG_NAME, PROPERTY_VALUE, DESCRIPTION, REGDATE, CONFIG_TYPE) VALUES (0, 'workspaceAppPath', '협업의 웹응용프로그램 경로', '/', 'workspaceHostUrl 테넌트 컨피그 뒤에 붙는 추가 경로 값으로, /, /ezWork, /ezWorkspace 등으로 설정 가능 (default: /)', TO_DATE('2025-03-13 00:00:00','yyyy-mm-dd hh24:mi:ss'), '협업');
