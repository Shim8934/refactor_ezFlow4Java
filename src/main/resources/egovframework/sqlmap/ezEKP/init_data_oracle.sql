...
INSERT INTO TBL_TENANT_CONFIG (TENANT_ID, PROPERTY_NAME, CONFIG_NAME, PROPERTY_VALUE, DESCRIPTION, REGDATE, CONFIG_TYPE) VALUES (0, 'mobileRedirection', '모바일 리다이렉션 주소', '*', '모바일 리다이렉션 주소. 단, *면 사용 안함', TO_DATE('2019-01-08 00:00:00','yyyy-mm-dd hh24:mi:ss'), '일반');
