...
INSERT INTO TBL_TENANT_CONFIG (TENANT_ID, PROPERTY_NAME, CONFIG_NAME, PROPERTY_VALUE, DESCRIPTION, REGDATE, CONFIG_TYPE) VALUES (0, 'useSurvey', 'YES', 'YES: 사용NO: 사용안함 (default: YES)', '전자설문 리뉴얼 모듈 사용여부', TO_DATE('2019-06-26 00:00:00','yyyy-mm-dd hh24:mi:ss'), '기타모듈');
