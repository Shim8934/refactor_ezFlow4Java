...
INSERT INTO TBL_TENANT_CONFIG (TENANT_ID, PROPERTY_NAME, CONFIG_NAME, PROPERTY_VALUE, DESCRIPTION, REGDATE, CONFIG_TYPE) VALUES (0, 'useOTP', 'OTP 사용여부', 'NO', 'TFA 2단계 인증 OTP 사용여부 (default:NO)', TO_DATE('2023-03-30 00:00:00','yyyy-mm-dd hh24:mi:ss'), '포탈');
...
INSERT INTO TBL_TENANT_CONFIG (TENANT_ID, PROPERTY_NAME, CONFIG_NAME, PROPERTY_VALUE, DESCRIPTION, REGDATE, CONFIG_TYPE) VALUES (0, 'teamsTenant', 'M365 테넌트 도메인 이름', '', 'M365 테넌트 도메인 이름', TO_DATE('2025-07-29 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), 'TEAMS');
INSERT INTO TBL_TENANT_CONFIG (TENANT_ID, PROPERTY_NAME, CONFIG_NAME, PROPERTY_VALUE, DESCRIPTION, REGDATE, CONFIG_TYPE) VALUES (0, 'teamsTenantId', 'M365 테넌트 ID', '', 'Azure AD 테넌트 식별자(GUID)', TO_DATE('2025-07-29 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), 'TEAMS');
INSERT INTO TBL_TENANT_CONFIG (TENANT_ID, PROPERTY_NAME, CONFIG_NAME, PROPERTY_VALUE, DESCRIPTION, REGDATE, CONFIG_TYPE) VALUES (0, 'teamsClientId', 'M365 클라이언트 ID', '', 'Microsoft Graph API 인증용으로 Azure에 등록된 앱의 Client ID', TO_DATE('2025-07-29 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), 'TEAMS');
INSERT INTO TBL_TENANT_CONFIG (TENANT_ID, PROPERTY_NAME, CONFIG_NAME, PROPERTY_VALUE, DESCRIPTION, REGDATE, CONFIG_TYPE) VALUES (0, 'teamsClientSecret', 'M365 클라이언트 시크릿', '', 'Microsoft Graph API 토큰 발급을 위한 Client Secret', TO_DATE('2025-07-29 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), 'TEAMS');
INSERT INTO TBL_TENANT_CONFIG (TENANT_ID, PROPERTY_NAME, CONFIG_NAME, PROPERTY_VALUE, DESCRIPTION, REGDATE, CONFIG_TYPE) VALUES (0, 'useTeams', 'Teams 연동 사용 여부', 'NO', 'Microsoft Teams 연동 여부 (NO: 연동안함, YES: 연동함, Default=NO)', TO_DATE('2025-07-29 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), 'TEAMS');
...
INSERT INTO TBL_TENANT_CONFIG (TENANT_ID, PROPERTY_NAME, CONFIG_NAME, PROPERTY_VALUE, DESCRIPTION, REGDATE, CONFIG_TYPE) VALUES (0, 'm365AdminAccount', 'M365 관리자 계정', '', 'Graph API 호출용 Microsoft 365 관리자 계정', TO_DATE('2025-07-31 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), 'TEAMS');
INSERT INTO TBL_TENANT_CONFIG (TENANT_ID, PROPERTY_NAME, CONFIG_NAME, PROPERTY_VALUE, DESCRIPTION, REGDATE, CONFIG_TYPE) VALUES (0, 'm365AdminAccountPw', 'M365 관리자 계정 비밀번호', '', 'Graph API 호출용 Microsoft 365 관리자 계정의 비밀번호', TO_DATE('2025-07-31 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), 'TEAMS');
