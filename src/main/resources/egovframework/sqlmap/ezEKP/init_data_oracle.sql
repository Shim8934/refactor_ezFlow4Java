...
INSERT INTO TBL_TENANT_CONFIG (TENANT_ID, PROPERTY_NAME, CONFIG_NAME, PROPERTY_VALUE, DESCRIPTION, REGDATE, CONFIG_TYPE) VALUES (0, 'useMailDeletedId', 'james_mail_deleted_id 테이블 사용여부', 'YES', 'james_mail_deleted_id 테이블 사용여부 (default: NO)', TO_DATE('2019-12-29 00:00:00','yyyy-mm-dd hh24:mi:ss'), '메일');
...
INSERT INTO TBL_TENANT_CONFIG (TENANT_ID, PROPERTY_NAME, CONFIG_NAME, PROPERTY_VALUE, DESCRIPTION, REGDATE, CONFIG_TYPE) VALUES (0, 'USE_CIRCULAR', '회람판 모듈 사용여부', 'YES', 'YES: 사용 NO: 사용안함 (default: YES)', TO_DATE('2017-01-06 00:00:00','yyyy-mm-dd hh24:mi:ss'), '회람판');
...
INSERT INTO TBL_TENANT_CONFIG (TENANT_ID, PROPERTY_NAME, CONFIG_NAME, PROPERTY_VALUE, DESCRIPTION, REGDATE, CONFIG_TYPE) VALUES (0, 'SATimageConvertServerURL', 'SAT 변환 솔루션 URL ', 'http://jmocha.kaoni.com:8080/uFOCS3.0/viewer/document/docviewer.do', 'IP 또는 PORT는 사이트에 맞게 변경', TO_DATE('2020-03-12 14:00:00','yyyy-mm-dd hh24:mi:ss'), '메일');
