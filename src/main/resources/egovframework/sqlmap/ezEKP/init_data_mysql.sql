...
INSERT INTO `jmocha_tenant` (`TENANT_ID`,`TENANT_NAME`,`TENANT_NAME2`) VALUES (0,'両備グループ','OrganizationChart');
...
INSERT INTO `tbl_tenant` (`TENANT_ID`,`TENANT_NAME`,`TENANT_NAME2`) VALUES (0,'両備グループ','OrganizationChart');
...
INSERT INTO `tbl_usermaster` (`TENANT_ID`,`CN`,`DISPLAYNAME`,`DISPLAYNAME2`,`MAIL`,`MAILNICKNAME`,`UPNNAME`,`DEPARTMENT`,`DESCRIPTION`,`DESCRIPTION2`,`DESCRIPTION3`,`PHYSICALDELIVERYOFFICENAME`,`COMPANY`,`COMPANY2`,`TITLE`,`TITLE2`,`TELEPHONENUMBER`,`HOMEPHONE`,`FACSIMILETELEPHONENUMBER`,`MOBILE`,`POSTALCODE`,`STREETADDRESS`,`INFO`,`EXTENSIONATTRIBUTE1`,`EXTENSIONATTRIBUTE2`,`EXTENSIONATTRIBUTE3`,`EXTENSIONATTRIBUTE4`,`EXTENSIONATTRIBUTE5`,`EXTENSIONATTRIBUTE6`,`EXTENSIONATTRIBUTE7`,`EXTENSIONATTRIBUTE8`,`EXTENSIONATTRIBUTE9`,`EXTENSIONATTRIBUTE10`,`EXTENSIONATTRIBUTE102`,`EXTENSIONATTRIBUTE11`,`EXTENSIONATTRIBUTE12`,`EXTENSIONATTRIBUTE13`,`EXTENSIONATTRIBUTE14`,`EXTENSIONATTRIBUTE15`,`ADSPATH`,`SIPURI`,`UPDATEDT`,`MOBILE_ENABLE`,`MOBILE_NOTUSE`,`MOBILE_PIN`,`POSITIONCD`,`BIRTH`,`BIRTHTYPE`,`PASSWORD`,`IPADDRESS`,`LASTLOGIN`,`LOGINCNT`,`LISTTYPE`) VALUES (0,'masteradmin','Master','MasterAdmin','masteradmin@jtest.kaoni.com','masteradmin',NULL,'Top','両備グループ','OrganizationChart',NULL,'Top','両備グループ','OrganizationChart','MasterAdmin','MasterAdmin',NULL,NULL,NULL,NULL,NULL,NULL,' ','c=1;a=1;k=1;i=1;g=1;l=1;n=0;m=0;w=0;t=0;',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'MasterAdmin','MasterAdmin',NULL,NULL,NULL,NULL,'1','CN=masteradmin,OU=사용자,OU=両備グループ,OU=TopGroup,DC=jtest,DC=kaoni,DC=com',NULL,'2017-01-06 00:00:00',NULL,'N',NULL,NULL,NULL,'Y','m7jsQtm1Uqm+n51H00wciQOeQm9rlarZxD0wuM9QVCU=','0:0:0:0:0:0:0:1','2017-01-06 00:00:00',0,'TXT');
...
INSERT INTO   TBL_ContainerType  (ContainerTypeID,  ContainerTypeName,  ContainerTypeName2, COMPANYID, TENANT_ID) VALUES (N'100', N'稟議', N'Draft','Top',0);
INSERT INTO   TBL_ContainerType  (ContainerTypeID,  ContainerTypeName,  ContainerTypeName2, COMPANYID, TENANT_ID) VALUES (N'200', N'協力', N'Support','Top',0);
INSERT INTO   TBL_ContainerType  (ContainerTypeID,  ContainerTypeName,  ContainerTypeName2, COMPANYID, TENANT_ID) VALUES (N'300', N'監査', N'Audit','Top',0);
INSERT INTO   TBL_ContainerType  (ContainerTypeID,  ContainerTypeName,  ContainerTypeName2, COMPANYID, TENANT_ID) VALUES (N'500', N'受信', N'Receive','Top',0);
INSERT INTO   TBL_ContainerType  (ContainerTypeID,  ContainerTypeName,  ContainerTypeName2, COMPANYID, TENANT_ID) VALUES (N'600', N'合意', N'Agree','Top',0);
INSERT INTO   TBL_ContainerType  (ContainerTypeID,  ContainerTypeName,  ContainerTypeName2, COMPANYID, TENANT_ID) VALUES (N'610', N'発信', N'Send','Top',0);
INSERT INTO   TBL_ContainerType  (ContainerTypeID,  ContainerTypeName,  ContainerTypeName2, COMPANYID, TENANT_ID) VALUES (N'700', N'差し戻し', N'Reject','Top',0);
INSERT INTO   TBL_ContainerType  (ContainerTypeID,  ContainerTypeName,  ContainerTypeName2, COMPANYID, TENANT_ID) VALUES (N'999', N'廃棄', N'Obsolete','Top',0);
...
Insert into TBL_RS_BRD (BRD_ID,BRD_COMPANY,BRD_NM,BRD_NM2,BRD_GROUP,BRD_GB,BRD_REF,BRD_LEVEL,BRD_STEP,BRD_POSTTERM,BRD_EXPLAIN,BRD_ACCESS,BRD_UPPER,BRD_COUNT,BRD_URL,ATTACH_SIZE,REPLY_MAIL_FG,OWNDEPTID,OWNDEPTNM,OWNDEPTNM2,OWNERID,OWNERNM,OWNERNM2,OWNERPOSITION,OWNERPOSITION2,OWNERCALL,MAKEDATE,RESLOCATION,BRD_UPPER2,APPROVEFLAG,TENANT_ID) values (1,'Top','両備グループ','OrganizationChart','A00','1',0,0,1,365,'',null,0,0,' ',20,null,null,null,null,null,null,null,null,null,null,null,null,null,'0',0);

-- portal insert

Insert into TBL_BUILTIN_PARAMETERS (PARAMTYPE,PARAMINFO,DESCRIPTION,SHORTNAME,TENANT_ID) values (0,'HardCoding','指定された値を引き渡す。','t4086',0);
Insert into TBL_BUILTIN_PARAMETERS (PARAMTYPE,PARAMINFO,DESCRIPTION,SHORTNAME,TENANT_ID) values (1,'USERID','自動でユーザIDの値を引き渡す。','t4087',0);
Insert into TBL_BUILTIN_PARAMETERS (PARAMTYPE,PARAMINFO,DESCRIPTION,SHORTNAME,TENANT_ID) values (2,'BASICAUTH','暗号化された基本認証ヘッダー値を引き渡す。','t4088',0);
Insert into TBL_BUILTIN_PARAMETERS (PARAMTYPE,PARAMINFO,DESCRIPTION,SHORTNAME,TENANT_ID) values (3,'DEPTID','自動でユーザの部署コード値を引き渡す。','t4089',0);
Insert into TBL_BUILTIN_PARAMETERS (PARAMTYPE,PARAMINFO,DESCRIPTION,SHORTNAME,TENANT_ID) values (4,'COMPANYID','自動でユーザの会社コード値を引き渡す。','t4090',0);
Insert into TBL_BUILTIN_PARAMETERS (PARAMTYPE,PARAMINFO,DESCRIPTION,SHORTNAME,TENANT_ID) values (5,'TITLE','自動でユーザの役職値を引き渡す。','t4091',0);
Insert into TBL_BUILTIN_PARAMETERS (PARAMTYPE,PARAMINFO,DESCRIPTION,SHORTNAME,TENANT_ID) values (6,'ROLLINFO','自動でユーザの権限情報値を引き渡す。','t4092',0);
...
Insert into TBL_MENUITEM_ITEMS_MENUITEMS (UID_,PARENTUID,PARENTMENUID,OWNERPAGEID,DISPLAYNAME,DISPLAYNAME2,SUBFLAG,COLUMNPOS,IMAGEUID,LINKURL,LINKLOCATION,LEFTMARGIN,WINDOWOPTION,TENANT_ID) values ('f17d98c7-6331-428d-9d4e-421312eec8ee','203',null,'d4dcceee-01f5-42da-9093-a243d3056204','設備管理','Resource',null,8,'d351b126-4e3a-486c-ab85-ef78738abead','/ezResource/resMain.do',null,null,null,0);
...
Insert into TBL_MENUITEM_ITEMS_MENUITEMS (UID_,PARENTUID,PARENTMENUID,OWNERPAGEID,DISPLAYNAME,DISPLAYNAME2,SUBFLAG,COLUMNPOS,IMAGEUID,LINKURL,LINKLOCATION,LEFTMARGIN,WINDOWOPTION,TENANT_ID) values ('34c08c4a-48a2-4cf1-8093-44aec5a783cf','203',null,'d4dcceee-01f5-42da-9093-a243d3056204','回覧板','Circular',null,9,'','/ezCircular/circularIndex.do',null,null,null,0);
...
Insert into TBL_PORTALPAGE_GENERAL (UID_,PARENTUID,DEPTH,DISPLAYNAME,DISPLAYNAME2,CREATORID,CREATORNAME,CREATEDATE,MODIFYDATE,WIDTH,HEIGHT,ROWLENGTH,COLUMNLENGTH,ROWSPLIT,COLUMNSPLIT,GUBUNFLAG,USEFLAG,COMPANYID,BASETYPE,THEMEUID,DEFAULTPAGE,TABLEVIEWOPTION,TENANT_ID) values ('d6e9c786-3af3-4c46-809d-267c2fd96976','top',1,'d6e9c786-3af3-4c46-809d-267c2fd96976',null,'gisa1','기사원','14/06/27',null,-1,110,0,1,null,'9999;','1',null,'Top',null,'f2de22b9-9a3f-49a9-884b-2e179e564cbf',null,'D',0);
...
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('0260dc48-e5b6-477b-9a15-3ad6a9b31dd0','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('04bc1910-6e80-4904-9da2-e6c86eccc366','everyone','RyobiGroup',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('04fccf89-e849-4c87-b364-ce5768c67031','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('07350485-7e46-4dc6-a8ec-1d6ca89ac7ed','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('08eb7695-3b27-4003-b5c4-eea1a99bbd05','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('09e1d12c-5ffd-4240-8791-020431a5c47b','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('0b4d7088-ea3c-4afb-ac2e-862cfa69bbb3','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('0d99fc50-55f4-4243-b47b-bf36c7ae58aa','everyone','両備グループ',2,2,0);
...
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('101d7cc4-555d-4c8a-a108-b776fabdad47','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('14c7302b-063e-4ba7-8233-8e8f257a0551','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('64f2e977-8759-43a4-b746-555378d22274','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('69b6d233-c50d-4b38-bb50-5bf51c02c35b','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('69f68282-5617-45ca-9118-27b6170df5c3','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('6cdb78b7-ae72-48ce-990f-5c0f6838fbbc','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('6db81dc5-e8ba-49c8-b625-df4fd375a43a','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('70fd0c61-af80-4f22-bf6e-d17d3f666bf9','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('73fc6012-c812-4a54-bdc1-0bc580f837a4','everyone','RyobiGroup',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('7851b606-aa1c-4f96-ba9b-562432b922a6','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('7acbc603-5383-4da4-ae14-523112a5c167','everyone','RyobiGroup',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('1db3cf2c-742e-4958-8f9f-557bb08aec75','everyone','両備グループ',2,1,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('1dc7d4e1-303f-4d13-a8b6-d5ebf8f3f32d','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('1f613cb1-a2f6-4f73-8b89-f0511cd2f911','everyone','RyobiGroup',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('22adf8b9-b12d-449b-9b91-ece274f32eb5','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('2341220c-33d9-430e-9a30-0cce35335552','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('26aa5ca6-986a-410c-8522-9b020580ee65','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('28e8af74-de0c-4e3e-a392-0e63ff623981','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('2e1803bc-9df3-412a-98ae-045fa345ed98','everyone','RyobiGroup',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('2f9e65ff-b89b-4089-819c-8a1dd13561ae','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('32c593d8-6d84-457c-bce3-28d66c15453b','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('356bae53-0b8f-42af-b0e2-16cdd9a42a95','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('37e4a9c1-a923-4ba6-9f08-2757cf4d4693','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('39f98e56-8eaa-49e0-95cf-b64fa2697f04','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('3a666e56-b5c5-4dc3-b455-2a4b607ce332','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('4046c701-2829-4dc9-8814-02bff616d2c4','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('4330099a-4889-497b-ac76-912fc6e10994','everyone','RyobiGroup',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('43bd6bc5-808b-4a2f-b0a9-da4abf1bb7b2','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('449adeff-b4db-4840-8fb6-9436fcaaf9df','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('451ef007-5316-472d-9a22-eeafbe8367e9','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('4e9e1389-9e52-4896-8f40-1dd5a6bf59e9','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('53e846f4-3946-4614-a146-2866c14940dc','everyone','RyobiGroup',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('53fbc413-b279-4bc8-9a0b-e490660a6495','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('55eaf17c-55e9-485a-9b82-a5096d47a19c','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('45eaf17c-55e9-326j-12hf-b6096d47789g','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('63ad15a0-524c-4c30-b9d4-04cb6beae971','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('57773384-f434-4450-92eb-1bdfe7e8a725','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('5f930a90-0a15-4a5a-a48e-2111e86bd503','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('c06b1862-ce83-4472-91d7-fd92cee3a7ac','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('c1479aa0-824d-43ff-a7f6-999ad660378a','everyone','両備グループ',2,2,0);
...
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('c443c133-3172-4e22-b681-5edb5318628a','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('c422d596-4890-8h34-g556-6sgj4236289t','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('c4736cf0-6cf0-42f1-979d-20678b68d171','everyone','RyobiGroup',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('c54e8173-ad8f-43dd-a220-05e4cc979788','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('c76e9210-b9df-21gh-b110-34t2sg147345','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('c93e6f29-ac0a-46a4-84c2-ae809e9c7c9e','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('c9cd4fa8-4806-47e7-92c2-3daccb0bd6bb','everyone','両備グループ',2,1,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('cc9b12f3-85b5-40c2-8f90-5db1b543d9a1','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('ce4f389f-47bf-4cb8-ab86-76e049eb9dc8','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('cf34747c-d809-461d-93d9-e50486ae3b68','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('8755e9ee-b116-4fa0-90c9-4ba174e33944','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('cffefdb6-e3d5-4336-a1e9-1e1a973981eb','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('d00d04fb-3d8f-466c-9f0f-7fc974954c1c','everyone','RyobiGroup',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('ea075496-9065-4f2a-b9f0-f8181ca1928d','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('edabe052-f573-4377-ad95-7743f9093151','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('f17d98c7-6331-428d-9d4e-421312eec8ee','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('f4fa93e8-e87d-4a21-ae9a-36099e8b3d56','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('f5c278f0-b62d-4437-8b08-1a81c2410497','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('f90b6413-c94c-4c6f-abe5-39480da308f1','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('fff4584e-3c0c-4b2f-98e5-4834138de988','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('8fd70c9a-83b2-4294-a57b-9a59abe3850d','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('c08c6efa-7494-4185-b1dc-09ecc908f683','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('94dfe6d0-043a-4284-bde5-8275aba64d6e','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('a37406b2-7a0a-48b0-a2a9-aacf811e9bd4','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('b39f97e9-4272-45d2-bcda-2ceb6d6e46d0','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('8593cc87-7630-420b-a6d5-f7a8577c5a31','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('e254ef6f-d602-4d40-8e39-b44177a8737c','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('d3dfdede-b4c7-48d6-a6e6-0b14f54d3ed9','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('d48b3355-defd-4a62-b373-3369f7f46bb3','everyone','両備グループ',2,1,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('d95e558c-e454-4e26-9ddf-688aba9aa89b','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('e3d09096-0258-4528-98d0-d2313a512897','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('7d237704-4123-4c60-95cc-16b6b0a06642','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('7fde32ad-5e48-4357-b24c-5f2594919b88','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('856c0213-ae8a-40be-ade0-63ab865fa1fd','everyone','両備グループ',2,1,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('8af6e9a5-0970-45a9-9495-ba0c7a9163fd','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('8d13543c-7747-4828-a141-1e28045ff722','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('8e35e3f1-ec52-4ee4-8638-af25a8737da7','everyone','RyobiGroup',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('94ef77fe-04fd-434a-8508-7fba98631bb8','everyone','RyobiGroup',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('9b157fdc-057d-4c5c-b036-f2107adf7f0b','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('9d853064-592b-4d07-a731-bd71b2832325','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('9eb0fd34-725e-47ed-93e4-06e06a66dd92','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('9f3651b2-fb17-429b-88db-b9d91cadfdbe','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('a52e3c9c-171e-44aa-b540-b4311f357b55','everyone','RyobiGroup',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('a56082ad-9136-43a7-9749-c867f1f5529e','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('a8ec0f1d-e9f5-4689-a953-5338ce70f75c','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('ad35d4e0-d885-43dc-899a-9c0ec92add53','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('bd7d2263-939b-481e-ae95-7aa70e67c5c3','Top','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('55b6ee75-bdbd-4690-821e-9e41ee14603c','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('a2149765-4c0b-466c-9e61-310925139d3c','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('a463482f-2e87-4ab1-be9f-e0ed5e054f76','everyone','両備グループ',2,2,0);
Insert into TBL_PORTAL_ACL (UID_,ACCESSID,ACCESSNAME,VIEW_RIGHT,EDIT_RIGHT,TENANT_ID) values ('9c7cfadb-4f21-4cbf-94b9-60669936a9f8','everyone','両備グループ',2,2,0);
...
Insert into TBL_PORTLET_GENERAL (UID_,DISPLAYNAME,DISPLAYNAME2,PORTLET_TYPE,URL,MAXURL,SHOWTITLEBAR,USERTYPE,HEIGHT,GUBUNFLAG,COMPANYID,BASETYPE,USEPOTALGUBUN,WIDTH,FRAMETYPE,TENANT_ID) values ('c06b1862-ce83-4472-91d7-fd92cee3a7ac','PhotoBoard_Portlet','PhotoBoard_Portlet',1,'/ezPortal/urlPortlet.do?uID=c06b1862-ce83-4472-91d7-fd92cee3a7ac',null,'0         ','1         ',225,'0','Top',null,null,548,'iFrame    ',0);
Insert into TBL_PORTLET_GENERAL (UID_,DISPLAYNAME,DISPLAYNAME2,PORTLET_TYPE,URL,MAXURL,SHOWTITLEBAR,USERTYPE,HEIGHT,GUBUNFLAG,COMPANYID,BASETYPE,USEPOTALGUBUN,WIDTH,FRAMETYPE,TENANT_ID) values ('c08c6efa-7494-4185-b1dc-09ecc908f683','Notice_portlet','Notice_portlet',1,'/ezPortal/urlPortlet.do?uID=c08c6efa-7494-4185-b1dc-09ecc908f683',' ','0         ','1         ',225,'0','Top',null,null,280,null,0);
Insert into TBL_PORTLET_GENERAL (UID_,DISPLAYNAME,DISPLAYNAME2,PORTLET_TYPE,URL,MAXURL,SHOWTITLEBAR,USERTYPE,HEIGHT,GUBUNFLAG,COMPANYID,BASETYPE,USEPOTALGUBUN,WIDTH,FRAMETYPE,TENANT_ID) values ('c1479aa0-824d-43ff-a7f6-999ad660378a','Banner_TopUser_Portlet','Banner_TopUser_Portlet',1,'/ezPortal/urlPortlet.do?uID=c1479aa0-824d-43ff-a7f6-999ad660378a',' ','0         ','1         ',225,'0','Top',null,null,330,null,0);
Insert into TBL_PORTLET_GENERAL (UID_,DISPLAYNAME,DISPLAYNAME2,PORTLET_TYPE,URL,MAXURL,SHOWTITLEBAR,USERTYPE,HEIGHT,GUBUNFLAG,COMPANYID,BASETYPE,USEPOTALGUBUN,WIDTH,FRAMETYPE,TENANT_ID) values ('f90b6413-c94c-4c6f-abe5-39480da308f1','Community_Portlet','Community_Portlet',1,'/ezPortal/urlPortlet.do?uID=f90b6413-c94c-4c6f-abe5-39480da308f1',' ','0         ','1         ',235,'0','Top',null,null,330,null,0);
Insert into TBL_PORTLET_GENERAL (UID_,DISPLAYNAME,DISPLAYNAME2,PORTLET_TYPE,URL,MAXURL,SHOWTITLEBAR,USERTYPE,HEIGHT,GUBUNFLAG,COMPANYID,BASETYPE,USEPOTALGUBUN,WIDTH,FRAMETYPE,TENANT_ID) values ('0b4d7088-ea3c-4afb-ac2e-862cfa69bbb3','SlideImage_Portlet','SlideImage_Portlet',1,'/ezPortal/urlPortlet.do?uID=0b4d7088-ea3c-4afb-ac2e-862cfa69bbb3',' ','0         ','1         ',225,'0','Top',null,null,517,null,0);
Insert into TBL_PORTLET_GENERAL (UID_,DISPLAYNAME,DISPLAYNAME2,PORTLET_TYPE,URL,MAXURL,SHOWTITLEBAR,USERTYPE,HEIGHT,GUBUNFLAG,COMPANYID,BASETYPE,USEPOTALGUBUN,WIDTH,FRAMETYPE,TENANT_ID) values ('69f68282-5617-45ca-9118-27b6170df5c3','Photo_Birthday_Total_Portlet','Photo_Birthday_Total_Portlet',1,'/ezPortal/urlPortlet.do?uID=69f68282-5617-45ca-9118-27b6170df5c3',' ','0         ','1         ',240,'0','Top',null,null,1150,null,0);
Insert into TBL_PORTLET_GENERAL (UID_,DISPLAYNAME,DISPLAYNAME2,PORTLET_TYPE,URL,MAXURL,SHOWTITLEBAR,USERTYPE,HEIGHT,GUBUNFLAG,COMPANYID,BASETYPE,USEPOTALGUBUN,WIDTH,FRAMETYPE,TENANT_ID) values ('73c0940e-5d44-4edc-bfa3-822fd6fd17b5','Notice_Slide_Total_Portlet','Notice_Slide_Total_Portlet',1,'/ezPortal/urlPortlet.do?uID=73c0940e-5d44-4edc-bfa3-822fd6fd17b5',' ','0         ','1         ',240,'0','Top',null,null,1150,null,0);
Insert into TBL_PORTLET_GENERAL (UID_,DISPLAYNAME,DISPLAYNAME2,PORTLET_TYPE,URL,MAXURL,SHOWTITLEBAR,USERTYPE,HEIGHT,GUBUNFLAG,COMPANYID,BASETYPE,USEPOTALGUBUN,WIDTH,FRAMETYPE,TENANT_ID) values ('7851b606-aa1c-4f96-ba9b-562432b922a6','ApprovalUse_Portlet','ApprovalUse_Portlet',1,'/ezPortal/urlPortlet.do?uID=7851b606-aa1c-4f96-ba9b-562432b922a6',' ','0         ','1         ',225,'0','Top',null,null,348,null,0);
Insert into TBL_PORTLET_GENERAL (UID_,DISPLAYNAME,DISPLAYNAME2,PORTLET_TYPE,URL,MAXURL,SHOWTITLEBAR,USERTYPE,HEIGHT,GUBUNFLAG,COMPANYID,BASETYPE,USEPOTALGUBUN,WIDTH,FRAMETYPE,TENANT_ID) values ('8af6e9a5-0970-45a9-9495-ba0c7a9163fd','Approval_Mail_Total_Portlet','Approval_Mail_Total_Portlet',1,'/ezPortal/urlPortlet.do?uID=8af6e9a5-0970-45a9-9495-ba0c7a9163fd',' ','0         ','1         ',235,'0','Top',null,null,797,null,0);
Insert into TBL_PORTLET_GENERAL (UID_,DISPLAYNAME,DISPLAYNAME2,PORTLET_TYPE,URL,MAXURL,SHOWTITLEBAR,USERTYPE,HEIGHT,GUBUNFLAG,COMPANYID,BASETYPE,USEPOTALGUBUN,WIDTH,FRAMETYPE,TENANT_ID) values ('8fd70c9a-83b2-4294-a57b-9a59abe3850d','QuestionStatistic_Portlet','QuestionStatistic_Portlet',1,'/ezPortal/urlPortlet.do?uID=8fd70c9a-83b2-4294-a57b-9a59abe3850d',' ','0         ','1         ',225,'0','Top',null,null,265,null,0);
Insert into TBL_PORTLET_GENERAL (UID_,DISPLAYNAME,DISPLAYNAME2,PORTLET_TYPE,URL,MAXURL,SHOWTITLEBAR,USERTYPE,HEIGHT,GUBUNFLAG,COMPANYID,BASETYPE,USEPOTALGUBUN,WIDTH,FRAMETYPE,TENANT_ID) values ('94dfe6d0-043a-4284-bde5-8275aba64d6e','MyBoard_Portlet','MyBoard_Portlet',1,'/ezPortal/urlPortlet.do?uID=94dfe6d0-043a-4284-bde5-8275aba64d6e',' ','0         ','1         ',225,'0','Top',null,null,512,null,0);
Insert into TBL_PORTLET_GENERAL (UID_,DISPLAYNAME,DISPLAYNAME2,PORTLET_TYPE,URL,MAXURL,SHOWTITLEBAR,USERTYPE,HEIGHT,GUBUNFLAG,COMPANYID,BASETYPE,USEPOTALGUBUN,WIDTH,FRAMETYPE,TENANT_ID) values ('9b157fdc-057d-4c5c-b036-f2107adf7f0b','Using_Portlet','Using_Portlet',1,'/ezPortal/urlPortlet.do?uID=9b157fdc-057d-4c5c-b036-f2107adf7f0b','2345235','0         ','1         ',225,'0','Top',null,null,240,'DIV       ',0);
Insert into TBL_PORTLET_GENERAL (UID_,DISPLAYNAME,DISPLAYNAME2,PORTLET_TYPE,URL,MAXURL,SHOWTITLEBAR,USERTYPE,HEIGHT,GUBUNFLAG,COMPANYID,BASETYPE,USEPOTALGUBUN,WIDTH,FRAMETYPE,TENANT_ID) values ('a37406b2-7a0a-48b0-a2a9-aacf811e9bd4','Birthday_Portlet','Birthday_Portlet',1,'/ezPortal/urlPortlet.do?uID=a37406b2-7a0a-48b0-a2a9-aacf811e9bd4',null,'0         ','1         ',225,'0','Top',null,null,338,'DIV       ',0);
Insert into TBL_PORTLET_GENERAL (UID_,DISPLAYNAME,DISPLAYNAME2,PORTLET_TYPE,URL,MAXURL,SHOWTITLEBAR,USERTYPE,HEIGHT,GUBUNFLAG,COMPANYID,BASETYPE,USEPOTALGUBUN,WIDTH,FRAMETYPE,TENANT_ID) values ('a2149765-4c0b-466c-9e61-310925139d3c','UserInfo_Portlet','UserInfo_Portlet',1,'/ezPortal/urlPortlet.do?uID=a2149765-4c0b-466c-9e61-310925139d3c',' ','0         ','1         ',220,'0','Top',null,null,1150,null,0);
...
Insert into TBL_THEME_GENERAL (UID_,DISPLAYNAME,DISPLAYNAME2,DISPLAYNAME3,DISPLAYNAME4,IMAGEURL,TOPURL,MAINURL,COMPANAYID,CREATORID,CREATORNM,CREATEDATE,MODIFYDATE,TOPHEIGHT,TENANT_ID) values ('f2de22b9-9a3f-49a9-884b-2e179e564cbf','スタンダード　A　テーマ ','スタンダード　A　テーマ','スタンダード　A　テーマ','スタンダード　A　テーマ','/files/upload_portal/S907000/Theme/08c5179c-1c9d-46e8-bea3-9c4495fa3704.jpg','/ezPortal/topMenu.do','/ezPortal/portalPage.do','Top','gisa1','기사원','14/03/17','16/10/05',100,0);

Insert into TBL_TOPMENU_GENERAL (UID_,PARENTUID,DEPTH,DISPLAYNAME,DISPLAYNAME2,CREATORID,CREATORNAME,CREATEDATE,MODIFYDATE,WIDTH,HEIGHT,ROWLENGTH,COLUMNLENGTH,ROWSPLIT,COLUMNSPLIT,USEFLAG,COMPANYID,LANG,TOPMNID,BASETYPE,THEMEUID,TENANT_ID) values ('d4dcceee-01f5-42da-9093-a243d3056204','top',1,'Standard Menu_ja','Standard Menu_ja','gisa1','기사원','13/06/20',null,-1,200,0,1,' ',';','Y','Top','3',null,null,'f2de22b9-9a3f-49a9-884b-2e179e564cbf',0);
Insert into TBL_TOPMENU_GENERAL (UID_,PARENTUID,DEPTH,DISPLAYNAME,DISPLAYNAME2,CREATORID,CREATORNAME,CREATEDATE,MODIFYDATE,WIDTH,HEIGHT,ROWLENGTH,COLUMNLENGTH,ROWSPLIT,COLUMNSPLIT,USEFLAG,COMPANYID,LANG,TOPMNID,BASETYPE,THEMEUID,TENANT_ID) values ('F3633607-8E8B-42A1-B777-6E2969072E58','top',1,'Standard Menu_Ko','Standard Menu_Ko','gisa1','김사원','07/10/23',null,-1,57,0,1,null,';','Y','Top','1',null,null,'f2de22b9-9a3f-49a9-884b-2e179e564cbf',0);
Insert into TBL_TOPMENU_GENERAL (UID_,PARENTUID,DEPTH,DISPLAYNAME,DISPLAYNAME2,CREATORID,CREATORNAME,CREATEDATE,MODIFYDATE,WIDTH,HEIGHT,ROWLENGTH,COLUMNLENGTH,ROWSPLIT,COLUMNSPLIT,USEFLAG,COMPANYID,LANG,TOPMNID,BASETYPE,THEMEUID,TENANT_ID) values ('174da7a0-e379-44bb-937d-a91216a7b459','top',1,'174da7a0-e379-44bb-937d-a91216a7b459','174da7a0-e379-44bb-937d-a91216a7b459','gisa1','기사원','13/06/20',null,-1,110,0,4,' ','100;280;500;;',null,'Top',null,null,null,'f2de22b9-9a3f-49a9-884b-2e179e564cbf',0);
Insert into TBL_TOPMENU_GENERAL (UID_,PARENTUID,DEPTH,DISPLAYNAME,DISPLAYNAME2,CREATORID,CREATORNAME,CREATEDATE,MODIFYDATE,WIDTH,HEIGHT,ROWLENGTH,COLUMNLENGTH,ROWSPLIT,COLUMNSPLIT,USEFLAG,COMPANYID,LANG,TOPMNID,BASETYPE,THEMEUID,TENANT_ID) values ('29e70a07-904b-41c6-a683-4d06a0b15d85','top',1,'29e70a07-904b-41c6-a683-4d06a0b15d85','29e70a07-904b-41c6-a683-4d06a0b15d85','gisa1','기사원','13/06/20',null,-1,110,0,1,null,';',null,'Top',null,null,null,'f2de22b9-9a3f-49a9-884b-2e179e564cbf',0);
Insert into TBL_TOPMENU_GENERAL (UID_,PARENTUID,DEPTH,DISPLAYNAME,DISPLAYNAME2,CREATORID,CREATORNAME,CREATEDATE,MODIFYDATE,WIDTH,HEIGHT,ROWLENGTH,COLUMNLENGTH,ROWSPLIT,COLUMNSPLIT,USEFLAG,COMPANYID,LANG,TOPMNID,BASETYPE,THEMEUID,TENANT_ID) values ('306fedec-66da-4070-8b54-8d1517a4545b','top',1,'306fedec-66da-4070-8b54-8d1517a4545b','306fedec-66da-4070-8b54-8d1517a4545b','gisa1','기사원','13/06/20',null,-1,110,0,4,' ','100;280;500;;',null,'Top',null,null,null,'f2de22b9-9a3f-49a9-884b-2e179e564cbf',0);
Insert into TBL_TOPMENU_GENERAL (UID_,PARENTUID,DEPTH,DISPLAYNAME,DISPLAYNAME2,CREATORID,CREATORNAME,CREATEDATE,MODIFYDATE,WIDTH,HEIGHT,ROWLENGTH,COLUMNLENGTH,ROWSPLIT,COLUMNSPLIT,USEFLAG,COMPANYID,LANG,TOPMNID,BASETYPE,THEMEUID,TENANT_ID) values ('64aa1712-8a96-4b25-aa9c-51e74282d54f','top',1,'64aa1712-8a96-4b25-aa9c-51e74282d54f','64aa1712-8a96-4b25-aa9c-51e74282d54f','gisa1','기사원','13/06/20',null,-1,110,0,1,' ',';',null,'Top',null,null,null,'f2de22b9-9a3f-49a9-884b-2e179e564cbf',0);
Insert into TBL_TOPMENU_GENERAL (UID_,PARENTUID,DEPTH,DISPLAYNAME,DISPLAYNAME2,CREATORID,CREATORNAME,CREATEDATE,MODIFYDATE,WIDTH,HEIGHT,ROWLENGTH,COLUMNLENGTH,ROWSPLIT,COLUMNSPLIT,USEFLAG,COMPANYID,LANG,TOPMNID,BASETYPE,THEMEUID,TENANT_ID) values ('b0a4e923-d270-4353-9e81-e86c14424262','top',1,'Standard Menu_En','Standard Menu_En','gisa1','기사원','13/06/20',null,-1,200,0,1,' ',';','Y','Top','2',null,null,'f2de22b9-9a3f-49a9-884b-2e179e564cbf',0);
Insert into TBL_TOPMENU_GENERAL (UID_,PARENTUID,DEPTH,DISPLAYNAME,DISPLAYNAME2,CREATORID,CREATORNAME,CREATEDATE,MODIFYDATE,WIDTH,HEIGHT,ROWLENGTH,COLUMNLENGTH,ROWSPLIT,COLUMNSPLIT,USEFLAG,COMPANYID,LANG,TOPMNID,BASETYPE,THEMEUID,TENANT_ID) values ('cc6758b3-1f3f-483a-9d7a-861caca82f92','top',1,'cc6758b3-1f3f-483a-9d7a-861caca82f92','cc6758b3-1f3f-483a-9d7a-861caca82f92','gisa1','기사원','13/06/20',null,-1,110,0,3,null,'100;280;;',null,'Top',null,null,null,'f2de22b9-9a3f-49a9-884b-2e179e564cbf',0);
Insert into TBL_TOPMENU_GENERAL (UID_,PARENTUID,DEPTH,DISPLAYNAME,DISPLAYNAME2,CREATORID,CREATORNAME,CREATEDATE,MODIFYDATE,WIDTH,HEIGHT,ROWLENGTH,COLUMNLENGTH,ROWSPLIT,COLUMNSPLIT,USEFLAG,COMPANYID,LANG,TOPMNID,BASETYPE,THEMEUID,TENANT_ID) values ('cd941931-9343-4186-b920-22106c63bfc1','top',1,'cd941931-9343-4186-b920-22106c63bfc1','cd941931-9343-4186-b920-22106c63bfc1','gisa1','기사원','13/06/20',null,-1,110,0,1,' ',';',null,'Top',null,null,null,'f2de22b9-9a3f-49a9-884b-2e179e564cbf',0);
