...
INSERT INTO TBL_LISTOPTION (ListType, SN, NAME, Name2, Name3, Name4, Width, TableName, ColName, ColAlias, DType, TypeDesc, FieldDesc, COMPANYID, TENANT_ID) VALUES ('083', 1, '문서번호', 'Public', '公開設定', '是否共享', 150, NULL, 'DocNo', NULL, NULL, NULL, NULL, 'Top', 0);
INSERT INTO TBL_LISTOPTION (ListType, SN, NAME, Name2, Name3, Name4, Width, TableName, ColName, ColAlias, DType, TypeDesc, FieldDesc, COMPANYID, TENANT_ID) VALUES ('083', 2, '제목', 'Public', '公開設定', '是否共享', 400, NULL, 'DocTitle', NULL, NULL, NULL, NULL, 'Top', 0);
INSERT INTO TBL_LISTOPTION (ListType, SN, NAME, Name2, Name3, Name4, Width, TableName, ColName, ColAlias, DType, TypeDesc, FieldDesc, COMPANYID, TENANT_ID) VALUES ('083', 3, '공개여부', 'Public', '公開設定', '是否共享', 50, NULL, 'OpenFlag', NULL, NULL, NULL, NULL, 'Top', 0);
INSERT INTO TBL_LISTOPTION (ListType, SN, NAME, Name2, Name3, Name4, Width, TableName, ColName, ColAlias, DType, TypeDesc, FieldDesc, COMPANYID, TENANT_ID) VALUES ('083', 4, '목록공개', 'Public', '公開設定', '是否共享', 50, NULL, 'ListOptionFlag', NULL, NULL, NULL, NULL, 'Top', 0);
INSERT INTO TBL_LISTOPTION (ListType, SN, NAME, Name2, Name3, Name4, Width, TableName, ColName, ColAlias, DType, TypeDesc, FieldDesc, COMPANYID, TENANT_ID) VALUES ('083', 5, '열람제한일자', 'Public', '公開設定', '是否共享', 100, NULL, 'OpenLimitDate', NULL, NULL, NULL, NULL, 'Top', 0);
INSERT INTO TBL_LISTOPTION (ListType, SN, NAME, Name2, Name3, Name4, Width, TableName, ColName, ColAlias, DType, TypeDesc, FieldDesc, COMPANYID, TENANT_ID) VALUES ('083', 6, '수정일자', 'Public', '公開設定', '是否共享', 140, NULL, 'UpdateDate', NULL, NULL, NULL, NULL, 'Top', 0);
INSERT INTO TBL_LISTOPTION (ListType, SN, NAME, Name2, Name3, Name4, Width, TableName, ColName, ColAlias, DType, TypeDesc, FieldDesc, COMPANYID, TENANT_ID) VALUES ('083', 7, '생성일자', 'Public', '公開設定', '是否共享', 140, NULL, 'CreateDate', NULL, NULL, NULL, NULL, 'Top', 0);
INSERT INTO TBL_LISTOPTION (ListType, SN, NAME, Name2, Name3, Name4, Width, TableName, ColName, ColAlias, DType, TypeDesc, FieldDesc, COMPANYID, TENANT_ID) VALUES ('083', 8, '작성자', 'Public', '公開設定', '是否共享', 100, NULL, 'WriterName', NULL, NULL, NULL, NULL, 'Top', 0);
