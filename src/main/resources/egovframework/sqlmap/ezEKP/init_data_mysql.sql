...
INSERT INTO TBL_TENANT_CONFIG (TENANT_ID, PROPERTY_NAME, CONFIG_NAME, PROPERTY_VALUE, DESCRIPTION, REGDATE, CONFIG_TYPE) VALUES (0, 'useCloud', '클라우드 사용 여부', 'NO', '클라우드 서비스를 통해서 ezEKP를 사용하고 있는지에 대한 여부이다. YES: 사용 NO: 사용안함 (default: NO)', '2017-01-06 00:00:00', '일반');
