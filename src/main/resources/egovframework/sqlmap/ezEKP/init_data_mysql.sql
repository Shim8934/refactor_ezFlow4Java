...
INSERT INTO TBL_TENANT_CONFIG (TENANT_ID, PROPERTY_NAME, CONFIG_NAME, PROPERTY_VALUE, DESCRIPTION, REGDATE, CONFIG_TYPE) VALUES (@tenant_id_value, 'Use_MultiData', '멀티언어 사용여부     * 2024-05-22(해당 컨피그를 확인한 시점) 기준으로 게시판 모듈에서만 사용중인 것으로 확인됨', 'YES', 'YES: 사용NO: 사용안함 (default: YES)', '2017-01-06 00:00:00', '게시판');
