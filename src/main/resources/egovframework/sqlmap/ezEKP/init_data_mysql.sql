...
INSERT INTO TBL_TENANT_CONFIG (TENANT_ID, PROPERTY_NAME, CONFIG_NAME, PROPERTY_VALUE, DESCRIPTION, REGDATE, CONFIG_TYPE) VALUES (@tenant_id_value, 'teamsTenant', 'M365 테넌트 도메인 이름', 'kaonicloud.com', 'M365 테넌트 도메인 이름', '2025-07-29 00:00:00', 'TEAMS');
INSERT INTO TBL_TENANT_CONFIG (TENANT_ID, PROPERTY_NAME, CONFIG_NAME, PROPERTY_VALUE, DESCRIPTION, REGDATE, CONFIG_TYPE) VALUES (@tenant_id_value, 'teamsTenantId', 'M365 테넌트 ID', '6f082f98-7252-4265-b8b8-4329dc830d47', 'Azure AD 테넌트 식별자(GUID)', '2025-07-29 00:00:00', 'TEAMS');
INSERT INTO TBL_TENANT_CONFIG (TENANT_ID, PROPERTY_NAME, CONFIG_NAME, PROPERTY_VALUE, DESCRIPTION, REGDATE, CONFIG_TYPE) VALUES (@tenant_id_value, 'teamsClientId', 'M365 클라이언트 ID', '5f1e15d7-3eab-47c9-a3f4-5a5256efb114', 'Microsoft Graph API 인증용으로 Azure에 등록된 앱의 Client ID', '2025-07-29 00:00:00', 'TEAMS');
INSERT INTO TBL_TENANT_CONFIG (TENANT_ID, PROPERTY_NAME, CONFIG_NAME, PROPERTY_VALUE, DESCRIPTION, REGDATE, CONFIG_TYPE) VALUES (@tenant_id_value, 'teamsClientSecret', 'M365 클라이언트 시크릿', 'aA08Q~MqORluSDRVZ-Wmf7_wN3sytfbEWAPrVbIc', 'Microsoft Graph API 토큰 발급을 위한 Client Secret', '2025-07-29 00:00:00', 'TEAMS');
INSERT INTO TBL_TENANT_CONFIG (TENANT_ID, PROPERTY_NAME, CONFIG_NAME, PROPERTY_VALUE, DESCRIPTION, REGDATE, CONFIG_TYPE) VALUES (@tenant_id_value, 'useTeams', 'Teams 연동 사용 여부', 'NO', 'Microsoft Teams 연동 여부', '2025-07-29 00:00:00', 'TEAMS');
...
INSERT INTO TBL_TENANT_CONFIG (TENANT_ID, PROPERTY_NAME, CONFIG_NAME, PROPERTY_VALUE, DESCRIPTION, REGDATE, CONFIG_TYPE) VALUES (@tenant_id_value, 'm365AdminAccount', 'M365 관리자 계정', 'e3gisa1@kaonicloud.com', 'Graph API 호출용 Microsoft 365 관리자 계정', '2025-07-31 00:00:00', 'TEAMS');
INSERT INTO TBL_TENANT_CONFIG (TENANT_ID, PROPERTY_NAME, CONFIG_NAME, PROPERTY_VALUE, DESCRIPTION, REGDATE, CONFIG_TYPE) VALUES (@tenant_id_value, 'm365AdminAccountPw', 'M365 관리자 계정 비밀번호', '111', 'Graph API 호출용 Microsoft 365 관리자 계정의 비밀번호', '2025-07-31 00:00:00', 'TEAMS');
-- INSERT INTO TBL_TENANT_CONFIG (TENANT_ID, PROPERTY_NAME, CONFIG_NAME, PROPERTY_VALUE, DESCRIPTION, REGDATE, CONFIG_TYPE) VALUES (@tenant_id_value, 'useAdminDelegatedToken', 'Graph API 관리자 위임 토큰 사용 여부', 'N', 'Graph API 호출 시 M365 관리자 계정 기반 Delegated 토큰 사용 여부', '2025-08-04 00:00:00', 'TEAMS');
