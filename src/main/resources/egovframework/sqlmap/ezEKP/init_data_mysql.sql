...
INSERT INTO TBL_TENANT_CONFIG (TENANT_ID, PROPERTY_NAME, CONFIG_NAME, PROPERTY_VALUE, DESCRIPTION, REGDATE, CONFIG_TYPE) VALUES (@tenant_id_value, 'useFidoAccessMenu', 'FIDO인증 관리 화면 여부(default: NO)', 'NO', 'FIDO인증 관리 화면', '2024-05-28 00:00:00', '일반');
