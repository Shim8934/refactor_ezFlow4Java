...
CREATE TABLE `tbl_attitude_modappl_history` (
  ...
  `APPR_STATUS` char(1) DEFAULT '0',
  `CONTENT` varchar(3000) DEFAULT NULL,
  PRIMARY KEY (`ATTITUDE_ID`,`MOD_CNT`,`COMPANY_ID`,`TENANT_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tbl_pms_item_list` (
  ...
  `write_date` date NOT NULL COMMENT '게시 일',
  `write_update_date` date DEFAULT NULL COMMENT '게시 수정 일',
...
CREATE TABLE `tbl_pms_item_read` (
  ...
  `project_id` bigint(20) NOT NULL COMMENT '프로젝트 아이디',
  `item_id` int(11) NOT NULL COMMENT '게시물 아이디',
  `read_date` date NOT NULL COMMENT '조회 일',
  `user_id` varchar(100) NOT NULL COMMENT '사용자 아이디',
  `user_name` varchar(100) NOT NULL COMMENT '사용자 명',
  `user_name2` varchar(100) NOT NULL COMMENT '사용자 명다국어',
...
CREATE TABLE `tbl_pms_log` (
  ...
  `group_id` bigint(20) DEFAULT NULL COMMENT '그룹 아이디',
  `task_id` bigint(20) DEFAULT NULL COMMENT '업무 아이디',
  `log_date` date NOT NULL COMMENT '이력 일',
...
CREATE TABLE `tbl_webfolder_share` (
  `SEQ_ID` varchar(100) NOT NULL COMMENT '생성 순번',
  `USER_ID` varchar(80) NOT NULL COMMENT '사용자 아이디',
  `USER_TYPE` varchar(50) NOT NULL COMMENT '사용자 타입 부서:D, 사원:U',
  `FOLDERFILE_ID` varchar(100) NOT NULL COMMENT '공유폴더 아이디',
  `FOLDERFILE_TYPE` varchar(100) NOT NULL COMMENT '폴더: D, 파일: F',
  `SHARER_ID` varchar(80) NOT NULL COMMENT '공유자 아이디',
  `SUB_STATUS` varchar(5) NOT NULL DEFAULT 'Y' COMMENT '하위폴더공유 여부 (Y/N)',
  `SHARE_DATE` datetime NOT NULL COMMENT '공유 시작일',
  `TENANT_ID` mediumint(5) NOT NULL COMMENT '테넌트 아이디',
  PRIMARY KEY (`SEQ_ID`,`TENANT_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='웹폴더 폴더 공유';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `tbl_webfolder_share2`
--

DROP TABLE IF EXISTS `tbl_webfolder_share2`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tbl_webfolder_share2` (
...
CREATE TABLE `tbl_webfolder_share_hide` (
  ...
  `TENANT_ID` mediumint(5) NOT NULL,
  PRIMARY KEY (`SEQ_ID`,`TENANT_ID`),
  KEY `tbl_webfolder_share_del_fk_idx` (`SHARE_ID`),
  CONSTRAINT `fk_webfolder_share_hide` FOREIGN KEY (`SHARE_ID`) REFERENCES `tbl_webfolder_share2` (`SHARE_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tbl_webfolder_share_sub` (
  ...
  `SUB_STATUS` varchar(5) NOT NULL DEFAULT 'Y',
  `TENANT_ID` mediumint(5) NOT NULL,
  PRIMARY KEY (`SEQ_ID`,`TENANT_ID`),
  KEY `tbl_webfolder_share_fk_idx` (`SHARE_ID`),
  CONSTRAINT `tbl_webfolder_share_sub_fk` FOREIGN KEY (`SHARE_ID`) REFERENCES `tbl_webfolder_share2` (`SHARE_ID`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
