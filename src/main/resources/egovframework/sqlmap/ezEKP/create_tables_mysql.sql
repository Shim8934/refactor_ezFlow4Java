...
CREATE TABLE `tbl_forminfo` (
  ...
  `TENANT_ID` mediumint(5) NOT NULL,
  `COMPANYID` varchar(20) NOT NULL,
  PRIMARY KEY (`TENANT_ID`,`COMPANYID`,`FORMID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tbl_task` (
  ...
  `IMPORTANCE` mediumint(5) NOT NULL,
  `HASSHARE` varchar(2) NOT NULL DEFAULT 'N',
  `HASATTACH` varchar(2) NOT NULL DEFAULT 'N',
  `HASCOMMENT` varchar(2) NOT NULL DEFAULT 'N',
  ...
  `NEWANSWER` varchar(4) DEFAULT 'N',
  `NEWREFER` varchar(4) DEFAULT 'N',
  ...
  `PERSONATTACH` varchar(2) DEFAULT 'N',
...
CREATE TABLE `tbl_taskshare` (
  ...
  `HASMEMO` varchar(2) DEFAULT 'N',
  `HASATTACH` varchar(2) DEFAULT 'N',
