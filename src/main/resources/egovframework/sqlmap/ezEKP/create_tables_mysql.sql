...
CREATE TABLE `jmocha_stat_mail_log` (
  ...
  `MESSAGESUBJECT` varchar(500) CHARACTER SET utf8mb4 DEFAULT NULL,
  `SENDER_NAME` varchar(255) CHARACTER SET utf8mb4 DEFAULT NULL,
  `RECIPIENT_NAME` varchar(255) CHARACTER SET utf8mb4 DEFAULT NULL,
  `ATTACHED_FILENAME` varchar(255) CHARACTER SET utf8mb4 DEFAULT NULL,
  PRIMARY KEY (`IDX`),
