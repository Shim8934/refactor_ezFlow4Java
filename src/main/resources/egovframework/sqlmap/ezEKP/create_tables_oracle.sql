...
--------------------------------------------------------
  ...
  CREATE TABLE "JAMES_MAIL_SEARCH" 
   (	"MAIL_SEARCH_ID" NUMBER, 
	...
	"MAIL_IP" VARCHAR2(200) DEFAULT NULL,
	"COUNTRY_CODE" VARCHAR2(200) DEFAULT NULL,	
	"SECURE_FLAG" NUMBER DEFAULT 0,
	"EACH_FLAG" NUMBER DEFAULT 0
   ) ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "JMOCHA_MAIL_DELETE" 
   (	"USER_ID" NVARCHAR2(100), 
	...
	"FOLDER_NAME" NVARCHAR2(100),
	"AUTO_DELETION_OPTION" NVARCHAR2(20) DEFAULT 'trash'
   ) ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "JMOCHA_MAIL_GENERAL" 
   (	"USER_ID" NVARCHAR2(100), 
	...
	"MAIL_SEND_RESULT" VARCHAR2(10) DEFAULT 'failure',
	...
	"FORWARD_AS" VARCHAR2(50) DEFAULT 'inline'
   ) ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "TBL_BOARD_BOARDINFO" 
   (	"BOARDID" VARCHAR2(38), 
	...
	"BOARDNAME6" NVARCHAR2(255),
	"TREEVIEWORDER" FLOAT(126),
	"BOARDLEVEL" FLOAT(126), 
	"PARENTBOARDID" VARCHAR2(38), 
	...
	"URLCOPYFLAG" CHAR(1 CHAR) DEFAULT 'N',
	"DISLIKEFLAG" VARCHAR2(2 CHAR) DEFAULT NULL,
	"VERSIONMANAGE" NCHAR(1) DEFAULT 'N',
	"USEKEYWORD" NVARCHAR2(2),
	"LISTSHOWTYPE" VARCHAR2(2) DEFAULT 'U' NOT NULL,
	"USEGROUPFLAG" CHAR(1 CHAR) DEFAULT 'N'
   ) ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "TBL_BOARD_BOARDINFO_ATTRIBUTE" 
   (	"BOARDID" VARCHAR2(38), 
	...
	"COLNAME3" NVARCHAR2(100),
	"COLNAME4" NVARCHAR2(100),
	"COLNAME6" NVARCHAR2(100),
	"VALUE" NVARCHAR2(255), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "TBL_BOARD_CONFIGURATION" 
   (	"USERID" NVARCHAR2(50), 
	...
	"USRLISTSHOWTYPE" VARCHAR2(2) DEFAULT 'G' NOT NULL,
    "TENANT_ID" NUMBER(5,0) DEFAULT NULL
   ) ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "TBL_BOARD_ITEM" 
   (	"ITEMID" VARCHAR2(38), 
    ...
    "UPDATERID" NVARCHAR2(80) DEFAULT NULL
   ) ;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Table TBL_BOARD_LISTHEADER
--------------------------------------------------------
CREATE TABLE "TBL_BOARD_LISTHEADER" (
  "BOARDID" VARCHAR2(38) NOT NULL,
  ...
  "NAME6" NVARCHAR2(200) DEFAULT NULL,
  "COLNAME" NVARCHAR2(200) NOT NULL,
  "WIDTH" NUMBER(10,0) NOT NULL,
  "VIEW_FG" NVARCHAR2(4) NOT NULL,
  "TENANT_ID" NUMBER(5,0) NOT NULL,
  CONSTRAINT PK_TBL_BOARD_LISTHEADER PRIMARY KEY ("BOARDID", "SN", "TENANT_ID")
);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "TBL_BOARD_MYTREE" 
   (	"TREEID" VARCHAR2(38), 
	...
	"TREENAME6" NVARCHAR2(255),
	"TREELEVEL" NUMBER(10,0),
	"TREESTEP" NUMBER(10,0), 
	"TREEUPPER" VARCHAR2(38), 
	"TREEBOARDID" VARCHAR2(38), 
	"TENANT_ID" NUMBER(5,0) DEFAULT NULL, 
	"COMPANYID" VARCHAR2(80 BYTE) DEFAULT NULL
   ) ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "TBL_CABINETCLASS" 
   (	"CABINETCLASSNO" VARCHAR2(100 CHAR), 
	...
	"PROCESSDEPTCODE" VARCHAR2(28), 
	"REGSERIALNO" VARCHAR2(24 CHAR), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "TBL_CIRCULAR_LISTOPTION" 
   (	"LISTTYPE" VARCHAR2(4 BYTE), 
	...
	"NAME6" NVARCHAR2(100) DEFAULT NULL,
	"COLNAME" NVARCHAR2(100), 
	"WIDTH" NUMBER(10,0), 
	"TENANTID" NUMBER(5,0)
   ) ;
...
--------------------------------------------------------
  ...
  CREATE TABLE "TBL_C_BOARD" 
   (	"NO" NUMBER(19,0), 
	...
	"TENANT_ID" NUMBER DEFAULT 0,
    "UPPERNO" NUMBER(19, 0),
    "ATTACHMENTS" NVARCHAR2(10) DEFAULT NULL
   ) ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "TBL_C_CLUB" 
   (	"C_CLUBNO" VARCHAR2(20 BYTE), 
	...
	"C_TYPE" NVARCHAR2(10),
    "JOIN_GRADE" NVARCHAR2(10) DEFAULT '4',
    "MEMLIST_READGRADE" NVARCHAR2(10) DEFAULT '4',
    "TENANT_ID" NUMBER DEFAULT 0
   ) ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "TBL_C_CLUBUSER" 
   (	"C_CLUBNO" VARCHAR2(20 BYTE), 
    ...
    "GRADE" NVARCHAR2(10) DEFAULT TO_NCHAR((4)),
    "ADMIN_AUTH"  NVARCHAR2(20),
    "C_WITHDRAWDATE"  NCHAR(30),
    "COMPANYID" NVARCHAR2(20),
	"TENANT_ID" NUMBER DEFAULT 0
   ) ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "TBL_EXPAPRDOCINFO" 
   (	"DOCID" VARCHAR2(20), 
	...
	"SUMMARYPATH" NVARCHAR2(140) DEFAULT NULL
   ) ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "TBL_FORMINFO" 
   (	"FORMCONTID" VARCHAR2(10), 
	...
	"MOBILEDRAFTFLAG" VARCHAR2(4) DEFAULT 'N'
   ) ;
...
--------------------------------------------------------
  ...
  CREATE TABLE "TBL_HISTORYDOCINFO" 
   (	"DOCID" VARCHAR2(20), 
    ...
    "EDITVERSION" VARCHAR2(100)  DEFAULT NULL,
...
--------------------------------------------------------
  ...
  CREATE TABLE "TBL_JOURNAL_FORM" 
   (	"FORM_ID" NUMBER(10,0), 
    ...
    "FORM_LANG" NUMBER(5,0) DEFAULT 1, 
    "FORM_CONTENT2" CLOB,
    "FORM_CONTENT3" CLOB,
    "FORM_CONTENT4" CLOB,
    "FORM_CONTENT5" CLOB,
...
--------------------------------------------------------
  ...
  CREATE TABLE "TBL_PHOTO_IMAGEITEM" 
   (	"IMAGEID" NCHAR(41), 
	...
	"TENANT_ID" NUMBER(5,0) DEFAULT NULL,
	"ADDTHUMBNAIL" NVARCHAR2(10) DEFAULT NULL,
	"THUMBNAILEXT" NVARCHAR2(10) DEFAULT NULL
   ) ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "TBL_PORTAL_MENU_COMP" 
   (	"COMPANY_ID" VARCHAR2(100 BYTE), 
    ...
    "MENU_IPUSED" NUMBER(11,0) DEFAULT 0,
    "ICON_URL" VARCHAR2(200 BYTE),
    "OPENTYPE"	NUMBER(3,0)	DEFAULT	3	NOT NULL
  ) ;
   ...
   COMMENT ON COLUMN "TBL_PORTAL_MENU_COMP"."MENU_IPUSED" IS '활성화(Y), 비활성화(N)';
   COMMENT ON COLUMN "TBL_PORTAL_MENU_COMP"."ICON_URL" IS '회사별 기본 아이콘 변경';
   COMMENT ON COLUMN "TBL_PORTAL_MENU_COMP"."OPENTYPE" IS '메뉴 열기 방식; 1:새 탭, 2:새 창, 3:iframe에서 열기';
...
--------------------------------------------------------
  ...
  CREATE TABLE "TBL_PORTAL_PORTLET_COMP" 
   (	"COMPANY_ID" VARCHAR2(100 BYTE), 
	...
	"CONNECTION_ID" VARCHAR2(200 BYTE)
   ) ;
...
--------------------------------------------------------
  ...
  CREATE TABLE "TBL_PORTAL_THEME" 
   (	"THEME_ID" NUMBER(10,0), 
	"THEME_NAME" VARCHAR2(100 BYTE) DEFAULT NULL, 
    "THEME_NAME2" VARCHAR2(100 BYTE) DEFAULT 'theme2',
	"THEME_NAME3" VARCHAR2(100 BYTE) DEFAULT 'theme3',
	"THEME_NAME4" VARCHAR2(100 BYTE) DEFAULT 'theme4',
	"THEME_NAME5" VARCHAR2(100 BYTE) DEFAULT 'theme5',
	"THEME_NAME6" VARCHAR2(100 BYTE) DEFAULT 'theme6',
   ...
   COMMENT ON COLUMN "TBL_PORTAL_THEME"."THEME_NAME2" IS '다국어 테마 이름(영어)';
   COMMENT ON COLUMN "TBL_PORTAL_THEME"."THEME_NAME3" IS '다국어 테마 이름(일본어)';
   COMMENT ON COLUMN "TBL_PORTAL_THEME"."THEME_NAME4" IS '다국어 테마 이름(중국어)';
   COMMENT ON COLUMN "TBL_PORTAL_THEME"."THEME_NAME5" IS '다국어 테마 이름(베트남어)';
   COMMENT ON COLUMN "TBL_PORTAL_THEME"."THEME_NAME6" IS '다국어 테마 이름(인도네시아어)';
   COMMENT ON COLUMN "TBL_PORTAL_THEME"."THEME_CONTENT" IS '테마 설명(내용)';
   COMMENT ON COLUMN "TBL_PORTAL_THEME"."THEME_CONTENT2" IS '다국어 테마 설명(영어)';
   COMMENT ON COLUMN "TBL_PORTAL_THEME"."THEME_CONTENT3" IS '다국어 테마 설명(일본어)';
   COMMENT ON COLUMN "TBL_PORTAL_THEME"."THEME_CONTENT4" IS '다국어 테마 설명(중국어)';
   COMMENT ON COLUMN "TBL_PORTAL_THEME"."THEME_CONTENT5" IS '다국어 테마 설명(베트남어)';
   COMMENT ON COLUMN "TBL_PORTAL_THEME"."THEME_CONTENT6" IS '다국어 테마 설명(인도네시아어)';
...
--------------------------------------------------------
  ...
  CREATE TABLE "TBL_PORTAL_THEME_USER" 
   (	"USER_ID" VARCHAR2(100 BYTE), 
    ...
    "USEPAGING"	NUMBER(1)	DEFAULT	1	NOT NULL,
   ...
   COMMENT ON COLUMN "TBL_PORTAL_THEME_USER"."USED_FRAME" IS '페이징 사용 여부';
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "TBL_PS_QUICKLINK" 
   (	"QUICKLINKID" NCHAR(38), 
	...
	"COMPANYID" varchar(20) DEFAULT 'Top' NOT NULL
   ) ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "TBL_RS_BRD" 
   (	"BRD_ID" NUMBER(*,0), 
    ...
    "RES_MAX_DATE" VARCHAR2(100),
    "RES_MAX_USER_CNT" VARCHAR2(100) DEFAULT '0' NOT NULL ENABLE
   ) ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "TBL_SCHEDULECONFIG" 
   (	"USERID" NVARCHAR2(50), 
    ...
    "DEFAULTVIEWCHECK" NVARCHAR2(2) DEFAULT 'N' NOT NULL
   ) ;
    COMMENT ON COLUMN TBL_SCHEDULECONFIG.DEFAULTVIEWCHECK IS '일정관리 진입 시 Y: DEFAULTVIEW에 해당하는 화면 / N: 마지막으로 조회한 화면';
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "TBL_SCHEDULEGROUPMEMBER" 
   (	"GROUPID" NVARCHAR2(50), 
	...
	"RESPONSEDATE" DATE, 
	"TENANT_ID" NUMBER(5,0),
	"WRITEPERMISSION" VARCHAR2(10) DEFAULT 'Y' NOT NULL
   ) ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "TBL_SURVEY" 
   (	"SURVEY_ID" NUMBER(20,0), 
	...
	"TOTALNOTI_SENT_FLAG" NUMBER(4,0) DEFAULT 0,
    "CLOSING_TEXT" NCLOB DEFAULT NULL,
    "USER_EXPOSED_FLAG" NUMBER(4,0) DEFAULT 1
   ) ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "TBL_SURVEY_RESPONDENT" 
   (	"RESPONSE_ID" NUMBER(20,0), 
	...
	"COMPANY_ID" VARCHAR2(80 BYTE), 
	"TENANT_ID" NUMBER(5,0),
	"LOTTERY_RESULT" NUMBER(10,0) DEFAULT NULL
   ) ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "TBL_USERMASTER" 
   (	"CN" NVARCHAR2(80), 
    ...
    "USERTREEFLAG" char(1) DEFAULT 'Y',
    "TEAMSID" NVARCHAR2(100) DEFAULT NULL
  ) ;
--------------------------------------------------------
...
--------------------------------------------------------
-------------------------------------------------------- 
--  DDL for Table JMOCHA_MAIL_POP3IMAP
--------------------------------------------------------
CREATE TABLE "JMOCHA_MAIL_POP3IMAP" (
    "USER_NAME" NVARCHAR2(100),
    "POP_ENABLED" NUMBER(1,0) DEFAULT 0,
    "POP_SINCE" DATE,
    "POP_AS_READ" NUMBER(1,0) DEFAULT 0,
    "POP_KEEP_COPY" NUMBER(1,0) DEFAULT 0,
    "POP_EXCLUDE_IMPORTED" NUMBER(1,0) DEFAULT 0,
    "IMAP_ENABLED" NUMBER(1,0) DEFAULT 0,
...
--------------------------------------------------------
  ...
  ALTER TABLE "TBL_C_CLUB" MODIFY ("JOIN_GRADE" NOT NULL ENABLE);
  ALTER TABLE "TBL_C_CLUB" MODIFY ("MEMLIST_READGRADE" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "TBL_C_CLUBUSER" MODIFY ("GRADE" NOT NULL ENABLE);
...
CREATE TABLE "TBL_SENDOUTINFO"
   ("IDEX"  NUMBER(30) NOT NULL ENABLE,
    "DOCID" VARCHAR2(20) NOT NULL ENABLE, 
...
CREATE TABLE "TBL_APRATTACHLIMIT" (
    ...
    "TENANT_ID" NUMBER(5,0) NOT NULL ENABLE,
    "COMPANYID" VARCHAR2(80) NOT NULL ENABLE,
...
(
    ...
    USECOLOR   NUMBER(1)    DEFAULT 0 NOT NULL,
...
COMMENT ON COLUMN TBL_PORTAL_TOP_USER.USECOLOR IS '사용 모드(색상)';
...
CREATE SEQUENCE  "SEQ_REALTIME_NOTIFICATION"  MINVALUE 1 MAXVALUE 999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 100 NOORDER NOCYCLE;
...
(
    ...
    "PARENTDOCID" VARCHAR2(20),
    "ORGDOCID" VARCHAR2(20) NOT NULL,
...
CREATE TABLE TBL_NOTI_EMERGENCY_COMPANY (
    ...
    WRITERID NVARCHAR2(80) NOT NULL,
    WRITEDATE DATE,
...
CREATE TABLE TBL_C_GRADE (
   C_CLUBNO VARCHAR2(40) NOT NULL,
   GRADECODE VARCHAR2(50) NOT NULL,
   GRADENAME VARCHAR2(100) NOT NULL,
   COMPANYID VARCHAR2(40) NOT NULL,
   TENANT_ID NUMBER(5) DEFAULT 0 NOT NULL,
   CONSTRAINT PK_TBL_C_GRADE PRIMARY KEY (C_CLUBNO, GRADECODE, COMPANYID, TENANT_ID)
);

CREATE TABLE TBL_AUTHTOKEN (
                               APITYPE VARCHAR2(20),
                               TOKENTYPE VARCHAR2(20) DEFAULT 'publicapp' NOT NULL,
                               AUTHTOKEN VARCHAR2(4000),
                               UPDATEDATE DATE
);
COMMENT ON TABLE TBL_AUTHTOKEN IS 'Graph API 인증토큰 저장 테이블';

CREATE TABLE TBL_USERPRESENCE (
                                  ID VARCHAR2(50) NOT NULL,
                                  PRESENCE VARCHAR2(50) NOT NULL,
                                  UPDATETIME VARCHAR2(50) NOT NULL,
                                  CONSTRAINT PK_TBL_USERPRESENCE PRIMARY KEY (ID)
);
COMMENT ON TABLE TBL_USERPRESENCE IS 'Graph API Presence 정보 저장 테이블';

CREATE TABLE "TBL_BOARD_DISLIKE" (
    "ITEMID" VARCHAR2(38) NOT NULL ENABLE,
    "USERID" NVARCHAR2(20) NOT NULL ENABLE,
    "DISLIKEDATE" NVARCHAR2(20),
    "TENANT_ID" NUMBER(5,0) NOT NULL ENABLE,
    CONSTRAINT "TBL_BOARD_DISLIKE_PK" PRIMARY KEY ("ITEMID", "USERID", "TENANT_ID")
);

CREATE TABLE TBL_BOARDITEM_SCRAP (
  "USERID" VARCHAR2(100) NOT NULL ENABLE,
  "BOARDID" VARCHAR2(38) NOT NULL ENABLE,
  "ITEMID" VARCHAR2(38) NOT NULL ENABLE,
  "SCRAPDATE" VARCHAR2(40),
  "TENANT_ID" NUMBER(5,0) NOT NULL ENABLE,
  "COMPANYID" VARCHAR2(20) NOT NULL ENABLE,
  CONSTRAINT "TBL_BOARDITEM_SCRAP_PK" PRIMARY KEY ("TENANT_ID", "COMPANYID", "USERID","BOARDID","ITEMID")
);

CREATE TABLE TBL_USERSCRAPCONT (
    "USERSCRAPCONTID" VARCHAR2(20) NOT NULL ENABLE,
    "USERSCRAPCONTNAME" VARCHAR2(255 BYTE),
    "PARENTSCRAPCONTID" VARCHAR2(20),
    "DESCRIPTION" VARCHAR2(255 BYTE),
    "USERID" VARCHAR2(100 BYTE) NOT NULL ENABLE,
    "TENANT_ID" NUMBER(5,0) NOT NULL ENABLE,
    "COMPANYID" VARCHAR2(20 BYTE) NOT NULL ENABLE,
    CONSTRAINT "TBL_USERSCRAPCONT_PK" PRIMARY KEY ("USERSCRAPCONTID", "TENANT_ID", "COMPANYID")
);
...
CREATE TABLE TBL_USERSCRAPCONTLIST (
   ...
   "TENANT_ID" NUMBER(5,0) NOT NULL ENABLE,
   "COMPANYID" VARCHAR2(20) NOT NULL ENABLE,
    CONSTRAINT "TBL_USERSCRAPCONTLIST_PK" PRIMARY KEY ("USERSCRAPCONTID", "TENANT_ID", "COMPANYID", "ITEMID", "BOARDID", "USERID"),
    CONSTRAINT "TBL_USERSCRAPCONTLIST_FK" FOREIGN KEY ("TENANT_ID", "COMPANYID", "USERSCRAPCONTID") REFERENCES "TBL_USERSCRAPCONT" ("TENANT_ID", "COMPANYID", "USERSCRAPCONTID") ON DELETE CASCADE
);

CREATE TABLE "TBL_BOARD_REPLY_REACT" (
    "ITEMID" VARCHAR2(38) NOT NULL ENABLE,
    "REPLYID" VARCHAR2(38) NOT NULL ENABLE,
    "USERID" NVARCHAR2(80) NOT NULL ENABLE,
    "REACTFLAG" VARCHAR2(1),
    "TENANT_ID" NUMBER(5,0) NOT NULL ENABLE,
    "COMPANYID" VARCHAR2(80),
    "REACTDATE" NVARCHAR2(40),
    CONSTRAINT "TBL_BOARD_REPLY_REACT_PK" PRIMARY KEY ("ITEMID", "REPLYID", "USERID", "TENANT_ID")
);

CREATE TABLE "TBL_TOTAL_HISTORY" (
  "DOCID" VARCHAR2(20) NOT NULL,
  "USERID" NVARCHAR2(400) NOT NULL,
  "REGDATE" DATE NOT NULL,
  "GUBUN" varchar(12) DEFAULT NULL,
  "USERJOBTITLE" NVARCHAR2(40) DEFAULT NULL,
  "USERDEPTID" NVARCHAR2(400) DEFAULT NULL,
  "USERDEPTNAME" NVARCHAR2(200) DEFAULT NULL,
  "USERNAME" NVARCHAR2(200) DEFAULT NULL,
  "USERNAME2" NVARCHAR2(200) DEFAULT NULL,
  "USERJOBTITLE2" NVARCHAR2(200) DEFAULT NULL,
  "USERDEPTNAME2" NVARCHAR2(400) DEFAULT NULL,
  "TENANT_ID" NUMBER(5,0) NOT NULL,
  "COMPANYID" VARCHAR2(20) NOT NULL,
  CONSTRAINT "PK_TBL_TOTAL_HISTORY" PRIMARY KEY ("DOCID", "USERID", "REGDATE", "TENANT_ID", "COMPANYID")
);
COMMENT ON TABLE TBL_TOTAL_HISTORY IS '2023-06-30 기준 통합 PC 저장에서만 사용하고 있음. gubun 은 "D"(Download) 로 사용하고 있음.';
        

CREATE TABLE TBL_USER_SCHEDULE_TYPE_CONFIG (
    USERID       NVARCHAR2(80)   NOT NULL,
    SCHEDULETYPE NUMBER(5)      NOT NULL,
    RELATEDID    NVARCHAR2(100)  NOT NULL,
    TAGCOLOR     NVARCHAR2(10),
    ISCHECKED    NVARCHAR2(2)    DEFAULT '1' NOT NULL,
    TENANT_ID    NUMBER(5)      NOT NULL,
    COMPANYID    NVARCHAR2(80)   NOT NULL,
    CONSTRAINT PK_USER_SCH_TYPE_CONFIG PRIMARY KEY (
        USERID, COMPANYID, TENANT_ID, SCHEDULETYPE, RELATEDID
    )
);

COMMENT ON TABLE TBL_USER_SCHEDULE_TYPE_CONFIG IS '사용자의 일정 유형별 설정 테이블';
COMMENT ON COLUMN TBL_USER_SCHEDULE_TYPE_CONFIG.USERID IS '사용자 아이디';
COMMENT ON COLUMN TBL_USER_SCHEDULE_TYPE_CONFIG.SCHEDULETYPE IS '일정 유형';
COMMENT ON COLUMN TBL_USER_SCHEDULE_TYPE_CONFIG.RELATEDID IS '유형에 따라 연결되는 대상 ID; 개인: 사용자 아이디, 부서: 부서 아이디, 회사: 회사 아이디, 협업: collaboration, 일정그룹: 일정그룹아이디';
COMMENT ON COLUMN TBL_USER_SCHEDULE_TYPE_CONFIG.TAGCOLOR IS '일정 태그 색상';
COMMENT ON COLUMN TBL_USER_SCHEDULE_TYPE_CONFIG.ISCHECKED IS '일정 조회 체크 상태; 0:off / 1:on';
COMMENT ON COLUMN TBL_USER_SCHEDULE_TYPE_CONFIG.TENANT_ID IS '테넌트 아이디';
COMMENT ON COLUMN TBL_USER_SCHEDULE_TYPE_CONFIG.COMPANYID IS '회사 아이디';
...
CREATE TABLE TBL_APPROVE_ERROR_INFO (
	...
	ERROR_CASE VARCHAR2(200),
    CREATEDATE DATE NULL ,
    UPDATEDATE DATE NULL ,
	CONSTRAINT PK_TBL_APPROVE_ERROR_INFO PRIMARY KEY (DOCID, TENANT_ID, COMPANYID)
) ;
COMMENT ON TABLE TBL_APPROVE_ERROR_INFO IS '백단에서 결재 시 본문 물리파일을 핸들링하다가 오류가 발생한 doc을 넣는 테이블';
COMMENT ON COLUMN TBL_APPROVE_ERROR_INFO.DOCID IS '문서 아이디';
COMMENT ON COLUMN TBL_APPROVE_ERROR_INFO.TENANT_ID IS '테넌트 아이디';
COMMENT ON COLUMN TBL_APPROVE_ERROR_INFO.COMPANYID IS '회사 아이디';
COMMENT ON COLUMN TBL_APPROVE_ERROR_INFO.ERROR_MESSAGE IS '오류 메시지';
COMMENT ON COLUMN TBL_APPROVE_ERROR_INFO.ERROR_CASE IS '커스텀 오류 케이스';
COMMENT ON COLUMN TBL_APPROVE_ERROR_INFO.CREATEDATE IS '오류 생성일';
COMMENT ON COLUMN TBL_APPROVE_ERROR_INFO.UPDATEDATE IS '업데이트 일자';
