...
--------------------------------------------------------
  ...
  USING INDEX  ENABLE;
  ALTER TABLE "TBL_WEBFOLDER_FILE" MODIFY ("ROOT_ID" NOT NULL ENABLE);
  ALTER TABLE "TBL_WEBFOLDER_FILE" MODIFY ("PARENT_ID" NOT NULL ENABLE);
  ALTER TABLE "TBL_WEBFOLDER_FILE" MODIFY ("HIERARCHICAL_PATH" NOT NULL ENABLE);
--------------------------------------------------------
