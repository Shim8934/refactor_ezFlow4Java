...
-- V_USERMASTER
CREATE OR REPLACE FORCE VIEW "V_USERMASTER" ("USER_ID", "NAME", "NAME2", "EMAIL", "DEPT_ID", "DEPT_NAME", "DEPT_NAME2", "TITLE", "TITLE2", "ROLE", "ROLE2", "POSITION", "POSITION2", "TEL", "MOBILE", "PROFILE_IMAGE", "JOB", "COMP_NAME", "COMP_NAME2", "ORDER_BY", "UPDATE_DATE", "PHOTO_UPDATEDT", "TENANT_ID", "TYPE", "SORT_NUM") AS 
  SELECT
	USER_ID AS USER_ID,
	NAME AS NAME,
	NAME2 AS NAME2,
...
-- V_ADDJOBMASTER
-- 2024.10.08 불필요한 union 주석처리
CREATE OR REPLACE FORCE VIEW "V_ADDJOBMASTER" ("USER_ID", "NAME", "DEPT_ID", "POSITION", "POSITION2", "ROLE", "ROLE2", "ORDER_BY", "UPDATEDT", "TENANT_ID", "TYPE", "SORT_NUM") AS 
  SELECT
	USER_ID AS USER_ID,
	NAME AS NAME,
	DEPT_ID AS DEPT_ID,
