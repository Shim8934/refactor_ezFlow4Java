...
--------------------------------------------------------
  ...
  CREATE TABLE "TBL_CONNDATA" 
   ...
   COMMENT ON COLUMN "TBL_CONNDATA"."FORMID" IS 'FROMID';
   COMMENT ON COLUMN "TBL_CONNDATA"."BODYXML" IS 'HTML 본문 데이터';
...
--------------------------------------------------------
  ...
  ALTER TABLE "JAMES_SUBSCRIPTION" ADD CONSTRAINT "U_JMS_PTN_USER_NAME" UNIQUE ("USER_NAME", "MAILBOX_NAME") DEFERRABLE
  USING INDEX  ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "TBL_CONNDATA" MODIFY ("BODYXML" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "TBL_DAILYDOCCOUNTLOG" ADD CONSTRAINT "PK_TBL_DAILYDOCCOUNTLOG" PRIMARY KEY ("TENANT_ID", "REGDATE", "DEPTID", "USERID")
  USING INDEX  ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "TBL_DAILYFORMCOUNTLOG" ADD CONSTRAINT "PK_TBL_DAILYFORMCOUNTLOG" PRIMARY KEY ("TENANT_ID", "REGDATE", "FORMID", "FORMCONTID")
  USING INDEX  ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "TBL_WEBFOLDER_CONFIG" MODIFY ("USER_TOTAL_LIMIT" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "JAMES_MAIL" ADD FOREIGN KEY ("MAILBOX_ID")
	  REFERENCES "JAMES_MAILBOX" ("MAILBOX_ID") ON DELETE CASCADE DEFERRABLE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table JAMES_MAIL_PROPERTY
--------------------------------------------------------

  ALTER TABLE "JAMES_MAIL_PROPERTY" ADD FOREIGN KEY ("MAILBOX_ID", "MAIL_UID")
	  REFERENCES "JAMES_MAIL" ("MAILBOX_ID", "MAIL_UID") ON DELETE CASCADE DEFERRABLE ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "TBL_LADDER_COMMENT" ADD FOREIGN KEY ("LADDERID", "TENANT_ID")
	  REFERENCES "TBL_LADDER" ("LADDERID", "TENANT_ID") ON DELETE CASCADE DEFERRABLE ENABLE;
--------------------------------------------------------
...
CREATE SEQUENCE  "SEARCH_INDEX_APPROVAL_SEQ"  MINVALUE 0 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 0 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;

--------------------------------------------------------
--  SEARCH_INDEX_BOARD_SEQ
--------------------------------------------------------

CREATE SEQUENCE "SEARCH_INDEX_BOARD_SEQ"  MINVALUE 0 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 0 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "VIEW_EZBOARDSTD" ("ITEMID", "BOARDNAME", "BOARDNAME2", "GUBUN", "TITLE", "WRITERDEPTNAME", "WRITERNAME", "WRITEDATE", "ATTACHMENTS", "BOARDID", "WRITERID", "HERF", "CONTENTLOCATION", "WRITERDEPTID", "TENANT_ID", "COMPANYID") AS 
  SELECT  
        b.ITEMID AS ITEMID, 
